 ...
 *
 */
public class ActorExtItemProvider extends ActorItemProvider implements ITableItemLabelProvider, ICellModifier {

	/**
	 * @param adapterFactory
	 */
	public ActorExtItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<Element> getChildren(Object object) {
		...
		children.addAll(actor.getOwnedComments());
		children.addAll(actor.getOwnedRules());
		children.addAll(actor.getGeneralizations());
		children.addAll(actor.getClientDependencies());

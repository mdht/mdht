...
public class GlobalDerivedStaticModelImpl extends DerivedStaticModelImpl implements GlobalDerivedStaticModel {
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.GLOBAL_DERIVED_STATIC_MODEL__SCHEMA_VERSION, oldSchemaVersion,
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, Mif2Package.GLOBAL_DERIVED_STATIC_MODEL__SCHEMA_VERSION, oldSchemaVersion,

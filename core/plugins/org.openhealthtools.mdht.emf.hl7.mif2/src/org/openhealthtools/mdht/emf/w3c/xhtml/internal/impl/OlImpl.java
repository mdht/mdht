...
public class OlImpl extends EObjectImpl implements Ol {
	...
	public void setClass(MifClassType newClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, XhtmlPackage.OL__CLASS, oldClass, class_, !oldClassESet));
		}
	}
	...
	public void unsetClass() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, XhtmlPackage.OL__CLASS, oldClass, CLASS_EDEFAULT, oldClassESet));
		}
	}
	...
	public void setStyle(StyleSheet newStyle) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, XhtmlPackage.OL__STYLE, oldStyle, style, !oldStyleESet));
		}
	}
	...
	public void unsetStyle() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, XhtmlPackage.OL__STYLE, oldStyle, STYLE_EDEFAULT, oldStyleESet));
		}
	}

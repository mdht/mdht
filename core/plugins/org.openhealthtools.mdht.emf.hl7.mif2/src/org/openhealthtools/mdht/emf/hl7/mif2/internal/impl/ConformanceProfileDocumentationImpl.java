...
public class ConformanceProfileDocumentationImpl extends EObjectImpl implements ConformanceProfileDocumentation {
	...
	public NotificationChain basicSetDescription(CascadableAnnotation newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__DESCRIPTION, oldDescription, newDescription);
	...
	public void setDescription(CascadableAnnotation newDescription) {
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject)description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__DESCRIPTION, null, msgs);
			if (newDescription != null)
				msgs = ((InternalEObject)newDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__DESCRIPTION, null, msgs);
			msgs = basicSetDescription(newDescription, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__DESCRIPTION, newDescription, newDescription));
	}
	...
	public EList<ContextAnnotation> getUsageConstraint() {
		if (usageConstraint == null) {
			usageConstraint = new EObjectContainmentEList<ContextAnnotation>(ContextAnnotation.class, this, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__USAGE_CONSTRAINT);
		}
	...
	public EList<ContextAnnotation> getUsageNotes() {
		if (usageNotes == null) {
			usageNotes = new EObjectContainmentEList<ContextAnnotation>(ContextAnnotation.class, this, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__USAGE_NOTES);
		}
		return usageNotes;
	}
	...
	public NotificationChain basicSetRationale(CascadableAnnotation newRationale, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__RATIONALE, oldRationale, newRationale);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRationale(CascadableAnnotation newRationale) {
		if (newRationale != rationale) {
			NotificationChain msgs = null;
			if (rationale != null)
				msgs = ((InternalEObject)rationale).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__RATIONALE, null, msgs);
			if (newRationale != null)
				msgs = ((InternalEObject)newRationale).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__RATIONALE, null, msgs);
			msgs = basicSetRationale(newRationale, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__RATIONALE, newRationale, newRationale));
	}
	...
	public NotificationChain basicSetRequirements(ContextAnnotation newRequirements, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__REQUIREMENTS, oldRequirements, newRequirements);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRequirements(ContextAnnotation newRequirements) {
		if (newRequirements != requirements) {
			...
			if (requirements != null)
				msgs = ((InternalEObject)requirements).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__REQUIREMENTS, null, msgs);
			if (newRequirements != null)
				msgs = ((InternalEObject)newRequirements).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__REQUIREMENTS, null, msgs);
			msgs = basicSetRequirements(newRequirements, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__REQUIREMENTS, newRequirements, newRequirements));
	}
	...
	public EList<DesignComment> getDesignComments() {
		if (designComments == null) {
			designComments = new EObjectContainmentEList<DesignComment>(DesignComment.class, this, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__DESIGN_COMMENTS);
		}
	...
	public EList<ContextAnnotation> getStabilityRemarks() {
		if (stabilityRemarks == null) {
			stabilityRemarks = new EObjectContainmentEList<ContextAnnotation>(ContextAnnotation.class, this, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__STABILITY_REMARKS);
		}
	...
	public NotificationChain basicSetWalkthrough(ContextAnnotation newWalkthrough, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__WALKTHROUGH, oldWalkthrough, newWalkthrough);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setWalkthrough(ContextAnnotation newWalkthrough) {
		if (newWalkthrough != walkthrough) {
			NotificationChain msgs = null;
			if (walkthrough != null)
				msgs = ((InternalEObject)walkthrough).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__WALKTHROUGH, null, msgs);
			if (newWalkthrough != null)
				msgs = ((InternalEObject)newWalkthrough).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__WALKTHROUGH, null, msgs);
			msgs = basicSetWalkthrough(newWalkthrough, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__WALKTHROUGH, newWalkthrough, newWalkthrough));
	}
	...
	public EList<OpenIssue> getOpenIssue() {
		if (openIssue == null) {
			openIssue = new EObjectContainmentEList<OpenIssue>(OpenIssue.class, this, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__OPEN_ISSUE);
		}
		return openIssue;
	}
	...
	public EList<OtherAnnotation> getOtherAnnotation() {
		if (otherAnnotation == null) {
			otherAnnotation = new EObjectContainmentEList<OtherAnnotation>(OtherAnnotation.class, this, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__OTHER_ANNOTATION);
		}
	...
	public EList<Appendix> getAppendix() {
		if (appendix == null) {
			appendix = new EObjectContainmentEList<Appendix>(Appendix.class, this, Mif2Package.CONFORMANCE_PROFILE_DOCUMENTATION__APPENDIX);
		}
		return appendix;
	}

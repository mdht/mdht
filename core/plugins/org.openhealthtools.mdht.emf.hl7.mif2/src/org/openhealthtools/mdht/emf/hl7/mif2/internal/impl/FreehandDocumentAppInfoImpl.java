...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Freehand Document App Info</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.FreehandDocumentAppInfoImpl#getBallotComment <em>Ballot Comment</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.FreehandDocumentAppInfoImpl#getChangeRequest <em>Change Request</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FreehandDocumentAppInfoImpl extends EObjectImpl implements FreehandDocumentAppInfo {
	/**
	 ...
	 * @generated
	 */
	protected FreehandDocumentAppInfoImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Mif2Package.Literals.FREEHAND_DOCUMENT_APP_INFO;
	}
	...
	public EList<BallotComment> getBallotComment() {
		if (ballotComment == null) {
			ballotComment = new EObjectContainmentEList<BallotComment>(BallotComment.class, this, Mif2Package.FREEHAND_DOCUMENT_APP_INFO__BALLOT_COMMENT);
		}
	...
	public EList<ChangeRequest> getChangeRequest() {
		if (changeRequest == null) {
			changeRequest = new EObjectContainmentEList<ChangeRequest>(ChangeRequest.class, this, Mif2Package.FREEHAND_DOCUMENT_APP_INFO__CHANGE_REQUEST);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Mif2Package.FREEHAND_DOCUMENT_APP_INFO__BALLOT_COMMENT:
				return ((InternalEList<?>)getBallotComment()).basicRemove(otherEnd, msgs);
			case Mif2Package.FREEHAND_DOCUMENT_APP_INFO__CHANGE_REQUEST:

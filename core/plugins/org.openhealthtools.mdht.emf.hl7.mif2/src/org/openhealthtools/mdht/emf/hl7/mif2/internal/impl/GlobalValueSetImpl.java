...
public class GlobalValueSetImpl extends ValueSetImpl implements GlobalValueSet {
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.GLOBAL_VALUE_SET__SCHEMA_VERSION, oldSchemaVersion, schemaVersion,
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, Mif2Package.GLOBAL_VALUE_SET__SCHEMA_VERSION, oldSchemaVersion,

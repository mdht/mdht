...
public class CommonModelElementDefinitionImpl extends ClassifierBaseImpl implements CommonModelElementDefinition {
	...
	public NotificationChain basicSetAnnotations(StaticModelInterfaceAnnotations newAnnotations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__ANNOTATIONS, oldAnnotations, newAnnotations);
	...
	public void setAnnotations(StaticModelInterfaceAnnotations newAnnotations) {
		if (newAnnotations != annotations) {
			...
			if (annotations != null)
				msgs = ((InternalEObject)annotations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__ANNOTATIONS, null, msgs);
			if (newAnnotations != null)
				msgs = ((InternalEObject)newAnnotations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__ANNOTATIONS, null, msgs);
			msgs = basicSetAnnotations(newAnnotations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__ANNOTATIONS, newAnnotations, newAnnotations));
	}
	...
	public NotificationChain basicSetBoundStaticModel(PackageRef newBoundStaticModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__BOUND_STATIC_MODEL, oldBoundStaticModel, newBoundStaticModel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBoundStaticModel(PackageRef newBoundStaticModel) {
		if (newBoundStaticModel != boundStaticModel) {
			...
			if (boundStaticModel != null)
				msgs = ((InternalEObject)boundStaticModel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__BOUND_STATIC_MODEL, null, msgs);
			if (newBoundStaticModel != null)
				msgs = ((InternalEObject)newBoundStaticModel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__BOUND_STATIC_MODEL, null, msgs);
			msgs = basicSetBoundStaticModel(newBoundStaticModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__BOUND_STATIC_MODEL, newBoundStaticModel, newBoundStaticModel));
	}
	...
	public EList<StaticModelClassTemplateParameter> getTemplateParameter() {
		if (templateParameter == null) {
			templateParameter = new EObjectContainmentEList<StaticModelClassTemplateParameter>(StaticModelClassTemplateParameter.class, this, Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__TEMPLATE_PARAMETER);
		}
	...
	public NotificationChain basicSetEntryClass(SpecializationClass newEntryClass, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__ENTRY_CLASS, oldEntryClass, newEntryClass);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEntryClass(SpecializationClass newEntryClass) {
		if (newEntryClass != entryClass) {
			NotificationChain msgs = null;
			if (entryClass != null)
				msgs = ((InternalEObject)entryClass).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__ENTRY_CLASS, null, msgs);
			if (newEntryClass != null)
				msgs = ((InternalEObject)newEntryClass).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__ENTRY_CLASS, null, msgs);
			msgs = basicSetEntryClass(newEntryClass, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__ENTRY_CLASS, newEntryClass, newEntryClass));
	}
	...
	public void setAttributionLevel(Object newAttributionLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__ATTRIBUTION_LEVEL, oldAttributionLevel, attributionLevel));
	}
	...
	public void setEntryKind(CMETEntryKind newEntryKind) {
		...
		entryKindESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__ENTRY_KIND, oldEntryKind, entryKind, !oldEntryKindESet));
	}
	...
	public void unsetEntryKind() {
		...
		entryKindESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__ENTRY_KIND, oldEntryKind, ENTRY_KIND_EDEFAULT, oldEntryKindESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__NAME, oldName, name));
	}
	...
	public void setOtherClassName(String newOtherClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__OTHER_CLASS_NAME, oldOtherClassName, otherClassName));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__ATTRIBUTION_LEVEL:
				return ATTRIBUTION_LEVEL_EDEFAULT == null ? attributionLevel != null : !ATTRIBUTION_LEVEL_EDEFAULT.equals(attributionLevel);
			case Mif2Package.COMMON_MODEL_ELEMENT_DEFINITION__ENTRY_KIND:

...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>xDocument Procedure Mood</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.openhealthtools.mdht.uml.hl7.vocab.VocabPackage#getx_DocumentProcedureMood()
 * @model
 * @generated
 */
public enum x_DocumentProcedureMood implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final int PRMS_VALUE = 5;
	 ...
	 * @ordered
	 */
	public static final int PRP_VALUE = 6;
	 ...
	 * @ordered
	 */
	public static final int RQO_VALUE = 7;

	/**
	 * An array of all the '<em><b>xDocument Procedure Mood</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final x_DocumentProcedureMood[] VALUES_ARRAY = new x_DocumentProcedureMood[] {
			APT, ARQ, DEF, EVN, INT, PRMS, PRP, RQO, };

	/**
	 * A public read-only list of all the '<em><b>xDocument Procedure Mood</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public static x_DocumentProcedureMood get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			x_DocumentProcedureMood result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private x_DocumentProcedureMood(int value, String name, String literal) {
		this.value = value;
		this.name = name;

...
import org.eclipse.mdht.uml.term.ui.internal.Logger;
import org.eclipse.mdht.uml.term.ui.internal.l10n.Messages;
...
public class AddCodeSystemVersionAction implements IObjectActionDelegate {
	...
	public AddCodeSystemVersionAction() {
		super();
	}
	...
	public void run(IAction action) {
		try {
			...
			IUndoableOperation operation = new AbstractEMFOperation(
				editingDomain, Messages.AddCodeSystemVersion_operation_title) {
				@Override

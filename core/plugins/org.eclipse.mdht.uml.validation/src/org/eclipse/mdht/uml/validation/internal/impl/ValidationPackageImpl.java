...
public class ValidationPackageImpl extends EPackageImpl implements ValidationPackage {
	...
	public static ValidationPackage init() {
		...
		ValidationPackageImpl theValidationPackage = (ValidationPackageImpl) (EPackage.Registry.INSTANCE.get(
			eNS_URI) instanceof ValidationPackageImpl
	...
	public void initializePackageContents() {
		...
		initEAttribute(
			getDiagnostic_Code(), theTypesPackage.getInteger(), "code", "-1", 0, 1, Diagnostic.class, !IS_TRANSIENT, //$NON-NLS-1$//$NON-NLS-2$
			!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getDiagnostic_Message(), theTypesPackage.getString(), "message", null, 1, 1, Diagnostic.class, //$NON-NLS-1$
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		op = addEOperation(diagnosticEClass, theTypesPackage.getBoolean(), "targets", 1, 1, IS_UNIQUE, !IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(
			getConstraintProvider_DiagnosticSource(), theTypesPackage.getString(), "diagnosticSource", null, 0, 1, //$NON-NLS-1$
			ConstraintProvider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, !IS_ORDERED);
		initEAttribute(getConstraintProvider_CategoryID(), theTypesPackage.getString(), "categoryID", null, 0, 1, //$NON-NLS-1$
			ConstraintProvider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, !IS_ORDERED);
		initEAttribute(getConstraintProvider_CategoryName(), theTypesPackage.getString(), "categoryName", null, 0, 1, //$NON-NLS-1$
			ConstraintProvider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, !IS_ORDERED);
		initEAttribute(
			getConstraintProvider_ParentCategoryID(), theTypesPackage.getString(), "parentCategoryID", null, 0, 1, //$NON-NLS-1$
			ConstraintProvider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, !IS_ORDERED);
		initEAttribute(getConstraintProvider_BundleName(), theTypesPackage.getString(), "bundleName", null, 0, 1, //$NON-NLS-1$
			ConstraintProvider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, !IS_ORDERED);
		...
		initEDataType(validationContextEDataType, IValidationContext.class, "ValidationContext", IS_SERIALIZABLE, //$NON-NLS-1$
			!IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createUMLAnnotations() {
		...
		addAnnotation(this, source, new String[] { "originalName", "Validation" //$NON-NLS-1$ //$NON-NLS-2$
		});
	}

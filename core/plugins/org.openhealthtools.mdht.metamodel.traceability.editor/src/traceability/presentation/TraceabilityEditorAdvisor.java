...
/**
 * Customized {@link WorkbenchAdvisor} for the RCP application. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public final class TraceabilityEditorAdvisor extends WorkbenchAdvisor {
	...
	private static String getString(String key, Object s1) {
		return traceability.presentation.TraceabilityEditorPlugin.INSTANCE.getString(key, new Object[] { s1 });
	}
	...
	public static class Application implements IApplication {
		...
		public Object start(IApplicationContext context) throws Exception {
			WorkbenchAdvisor workbenchAdvisor = new TraceabilityEditorAdvisor();
		...
		/**
		 * @see org.eclipse.equinox.app.IApplication#stop() <!-- begin-user-doc --> <!-- end-user-doc -->
		 * @generated
		 */
		public void stop() {
			// Do nothing.
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "traceability.presentation.TraceabilityEditorAdvisorPerspective";
	...
	public static class WindowAdvisor extends WorkbenchWindowAdvisor {
		/**
		 * @see WorkbenchWindowAdvisor#WorkbenchWindowAdvisor(org.eclipse.ui.application.IWorkbenchWindowConfigurer) <!-- begin-user-doc --> <!-- end-user-doc -->
		 * @generated
		 */
		...
		/**
		 * @see org.eclipse.ui.application.WorkbenchWindowAdvisor#createActionBarAdvisor(org.eclipse.ui.application.IActionBarConfigurer) <!-- begin-user-doc --> <!-- end-user-doc -->
		 * @generated
		 */
		@Override
	...
	public static class WindowActionBarAdvisor extends ActionBarAdvisor {
		/**
		 * @see ActionBarAdvisor#ActionBarAdvisor(org.eclipse.ui.application.IActionBarConfigurer) <!-- begin-user-doc --> <!-- end-user-doc -->
		 * @generated
		 */
		...
		/**
		 * @see org.eclipse.ui.application.ActionBarAdvisor#fillMenuBar(org.eclipse.jface.action.IMenuManager) <!-- begin-user-doc --> <!-- end-user-doc -->
		 * @generated
		 */
		@Override
		...
		/**
		 * Adds the specified action to the given menu and also registers the action with the action bar configurer, in order to activate its key binding. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
	...
	/**
	 * About action for the RCP application. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public static class AboutAction extends WorkbenchWindowActionDelegate {
		/**
		 * @see org.eclipse.ui.IActionDelegate#run(org.eclipse.jface.action.IAction) <!-- begin-user-doc --> <!-- end-user-doc -->
		 * @generated
		 */
	...
	/**
	 * Open URI action for the objects from the Traceability model. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public static class OpenURIAction extends WorkbenchWindowActionDelegate {
		/**
		 * Opens the editors for the files selected using the LoadResourceDialog. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		public void run(IAction action) {
	...
	/**
	 * @see org.eclipse.ui.application.WorkbenchAdvisor#getInitialWindowPerspectiveId() <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	...
	/**
	 * @see org.eclipse.ui.application.WorkbenchAdvisor#createWorkbenchWindowAdvisor(org.eclipse.ui.application.IWorkbenchWindowConfigurer) <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	@Override

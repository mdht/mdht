...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Publication App Info</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.PublicationAppInfoImpl#getBallotComment <em>Ballot Comment</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.PublicationAppInfoImpl#getChangeRequest <em>Change Request</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PublicationAppInfoImpl extends EObjectImpl implements PublicationAppInfo {
	/**
	 ...
	 * @generated
	 */
	protected PublicationAppInfoImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Mif2Package.Literals.PUBLICATION_APP_INFO;
	}
	...
	public EList<BallotComment> getBallotComment() {
		if (ballotComment == null) {
			ballotComment = new EObjectContainmentEList<BallotComment>(BallotComment.class, this, Mif2Package.PUBLICATION_APP_INFO__BALLOT_COMMENT);
		}
	...
	public EList<ChangeRequest> getChangeRequest() {
		if (changeRequest == null) {
			changeRequest = new EObjectContainmentEList<ChangeRequest>(ChangeRequest.class, this, Mif2Package.PUBLICATION_APP_INFO__CHANGE_REQUEST);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Mif2Package.PUBLICATION_APP_INFO__BALLOT_COMMENT:
				return ((InternalEList<?>)getBallotComment()).basicRemove(otherEnd, msgs);
			case Mif2Package.PUBLICATION_APP_INFO__CHANGE_REQUEST:

...
public class ValueSetSupplementImpl extends VocabularyValueSetRefImpl implements ValueSetSupplement {
	...
	public EList<BusinessName> getBusinessName() {
		if (businessName == null) {
			businessName = new EObjectContainmentEList<BusinessName>(BusinessName.class, this, Mif2Package.VALUE_SET_SUPPLEMENT__BUSINESS_NAME);
		}
		return businessName;
	}
	...
	public NotificationChain basicSetAnnotations(ValueSetAnnotations newAnnotations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.VALUE_SET_SUPPLEMENT__ANNOTATIONS, oldAnnotations, newAnnotations);
	...
	public void setAnnotations(ValueSetAnnotations newAnnotations) {
		if (newAnnotations != annotations) {
			...
			if (annotations != null)
				msgs = ((InternalEObject)annotations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.VALUE_SET_SUPPLEMENT__ANNOTATIONS, null, msgs);
			if (newAnnotations != null)
				msgs = ((InternalEObject)newAnnotations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.VALUE_SET_SUPPLEMENT__ANNOTATIONS, null, msgs);
			msgs = basicSetAnnotations(newAnnotations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.VALUE_SET_SUPPLEMENT__ANNOTATIONS, newAnnotations, newAnnotations));
	}

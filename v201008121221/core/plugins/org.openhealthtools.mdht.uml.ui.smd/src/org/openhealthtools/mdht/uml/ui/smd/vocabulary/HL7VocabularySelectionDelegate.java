...
/*
 *    <valueSets xmi:type="vocab:HL7ValueSet" xmi:id="_z_E8AdW6Ed6UEa6sU6uJ5w" name="AcknowledgementDetailCode" id="2.16.840.1.113883.1.11.19638">
      <content xmi:type="vocab:HL7ContentDefinition" xmi:id="_z_E8AtW6Ed6UEa6sU6uJ5w" codeSystem="_z-j-D9W6Ed6UEa6sU6uJ5w">
        <unionWithContents xmi:type="vocab:HL7ContentDefinition" xmi:id="_z_E8A9W6Ed6UEa6sU6uJ5w" codeSystem="_z-j-D9W6Ed6UEa6sU6uJ5w">
          <codeSets xmi:type="vocab:HL7SimpleCodeSet" xmi:id="_z_E8BNW6Ed6UEa6sU6uJ5w" codes="_z-j-VNW6Ed6UEa6sU6uJ5w _z-j-TtW6Ed6UEa6sU6uJ5w _z-j-UdW6Ed6UEa6sU6uJ5w _z-j-SNW6Ed6UEa6sU6uJ5w _z-j-S9W6Ed6UEa6sU6uJ5w"/>
        </unionWithContents>
 ...
 * 
 * (non-Javadoc)
 * @see org.openhealthtools.hl7.smd.core.model.hl7metamodel.vocabularymetamodel.util.VocabularymetamodelSwitch#caseHL7ValueSet(org.openhealthtools.hl7.smd.core.model.hl7metamodel.vocabularymetamodel.HL7ValueSet)
 */
			@Override
...
//			}
	...
	public IVocabularyConstraint chooseVocabularyConstraint(Shell shell, Property property, Constraint constraint) {
		...
		if (hl7smdVocabularyContentProvider.getHL7VocabularyModel() != null) {
			...
			TreeSelectionDialog treeSelectionDialog = new TreeSelectionDialog(shell, hl7smdVocabularyContentProvider.getHL7VocabularyModel(), hl7smdVocabularyContentProvider, new HL7VocabularyLabelProvider(shell.getDisplay()), "Select Constraint");
...
//					}
					...
					case 1:
						...
						break;
					case 2:
						constraintResult = new CodeSystemConstraint((HL7CodeSystem) results[1],(HL7Concept)results[0]);
						break;
					}
...
//			TreeSelectionDialog treeSelectionDialog = new TreeSelectionDialog(shell, mif2VocabularyContentProvider.getHL7VocabularyModel(), mif2VocabularyContentProvider, new HL7VocabularyLabelProvider(
...
//		} else {
//
//			IPath mif2VocabularyPath = ResourcesPlugin.getWorkspace().getPathVariableManager().getValue(HL7VocabularyContentProvider.HL7_MIF2_VOCABULARY_PATH);
//
...
//			} else {
//				MessageDialog.openInformation(shell, "MIF2 Vocabulary", "You must set path to MIF Vocaubulary using " + HL7VocabularyContentProvider.HL7_MIF2_VOCABULARY_PATH
...
//		}
	...
	public boolean isConfigured() {
		...
		IPath smdVocabularyPath = ResourcesPlugin.getWorkspace().getPathVariableManager().getValue(HL7VocabularyContentProvider.HL7_SMD_VOCABULARY_PATH);

...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>PHR Update</b></em>'.
 * <!-- end-user-doc -->
 *
 *
...
public interface PHRUpdate extends MedicalSummary {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'1.3.6.1.4.1.19376.1.5.3.1.1.6\')'"
	 * @generated
	 */
	boolean validatePHRUpdateTemplateId(DiagnosticChain diagnostics, Map<Object, Object> context);

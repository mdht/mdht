...
public class RIMColorUtil {
	 ...
	 * 
	 * @param view a diagram view that should be colorized
	 * @param rimClass a UML Class or Stereotype used for RIM assignment
	...
	public static boolean assignRIMColor(View view, Classifier rimClass) {
		...
		if (view instanceof Edge)
			return assignRIMColor((Edge)view, allParentNames);
		else
	 ...
	 * 
	 * @param view a diagram view that should be colorized
	 * @param element use keywords on this element for RIM assignment
	 * @return true if color is assigned successfully
	 */

...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>xDocument Act Mood</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.openhealthtools.mdht.uml.hl7.vocab.VocabPackage#getx_DocumentActMood()
 * @model
 * @generated
 */
public enum x_DocumentActMood implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>xDocument Act Mood</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final x_DocumentActMood[] VALUES_ARRAY =
		new x_DocumentActMood[] {
			APT,
			ARQ,
			DEF,
			EVN,
	 ...
	 * @generated
	 */
	public static final List<x_DocumentActMood> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	...
	public static x_DocumentActMood get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			x_DocumentActMood result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private x_DocumentActMood(int value, String name, String literal) {
		this.value = value;
		this.name = name;

...
public class ConformanceProfileImpl extends PackageImpl implements ConformanceProfile {
	...
	public NotificationChain basicSetAnnotations(ConformanceProfileAnnotations newAnnotations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.CONFORMANCE_PROFILE__ANNOTATIONS, oldAnnotations, newAnnotations);
	...
	public void setAnnotations(ConformanceProfileAnnotations newAnnotations) {
		if (newAnnotations != annotations) {
			...
			if (annotations != null)
				msgs = ((InternalEObject)annotations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.CONFORMANCE_PROFILE__ANNOTATIONS, null, msgs);
			if (newAnnotations != null)
				msgs = ((InternalEObject)newAnnotations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.CONFORMANCE_PROFILE__ANNOTATIONS, null, msgs);
			msgs = basicSetAnnotations(newAnnotations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.CONFORMANCE_PROFILE__ANNOTATIONS, newAnnotations, newAnnotations));
	}
	...
	public EList<Storyboard> getStoryboards() {
		if (storyboards == null) {
			storyboards = new EObjectContainmentEList<Storyboard>(Storyboard.class, this, Mif2Package.CONFORMANCE_PROFILE__STORYBOARDS);
		}
		return storyboards;
	}
	...
	public NotificationChain basicSetImplementationConstraints(ImplementationMessageConstraints newImplementationConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.CONFORMANCE_PROFILE__IMPLEMENTATION_CONSTRAINTS, oldImplementationConstraints, newImplementationConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setImplementationConstraints(ImplementationMessageConstraints newImplementationConstraints) {
		if (newImplementationConstraints != implementationConstraints) {
			...
			if (implementationConstraints != null)
				msgs = ((InternalEObject)implementationConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.CONFORMANCE_PROFILE__IMPLEMENTATION_CONSTRAINTS, null, msgs);
			if (newImplementationConstraints != null)
				msgs = ((InternalEObject)newImplementationConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.CONFORMANCE_PROFILE__IMPLEMENTATION_CONSTRAINTS, null, msgs);
			msgs = basicSetImplementationConstraints(newImplementationConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.CONFORMANCE_PROFILE__IMPLEMENTATION_CONSTRAINTS, newImplementationConstraints, newImplementationConstraints));
	}
	...
	public EList<PackageRef> getSupportedApplicationRoles() {
		if (supportedApplicationRoles == null) {
			supportedApplicationRoles = new EObjectContainmentEList<PackageRef>(PackageRef.class, this, Mif2Package.CONFORMANCE_PROFILE__SUPPORTED_APPLICATION_ROLES);
		}
	...
	public EList<ConformanceTriggerEvents> getSupportedTriggerEvents() {
		if (supportedTriggerEvents == null) {
			supportedTriggerEvents = new EObjectContainmentEList<ConformanceTriggerEvents>(ConformanceTriggerEvents.class, this, Mif2Package.CONFORMANCE_PROFILE__SUPPORTED_TRIGGER_EVENTS);
		}
	...
	public EList<InteractionProfile> getSupportedAppRoleInteractions() {
		if (supportedAppRoleInteractions == null) {
			supportedAppRoleInteractions = new EObjectContainmentEList<InteractionProfile>(InteractionProfile.class, this, Mif2Package.CONFORMANCE_PROFILE__SUPPORTED_APP_ROLE_INTERACTIONS);
		}
	...
	public EList<PackageRef> getUnsupportedAppRoleInteractions() {
		if (unsupportedAppRoleInteractions == null) {
			unsupportedAppRoleInteractions = new EObjectContainmentEList<PackageRef>(PackageRef.class, this, Mif2Package.CONFORMANCE_PROFILE__UNSUPPORTED_APP_ROLE_INTERACTIONS);
		}
	...
	public EList<InteractionProfile> getExtraInteractions() {
		if (extraInteractions == null) {
			extraInteractions = new EObjectContainmentEList<InteractionProfile>(InteractionProfile.class, this, Mif2Package.CONFORMANCE_PROFILE__EXTRA_INTERACTIONS);
		}
	...
	public EList<DocumentProfile> getSupportedAppRoleDocuments() {
		if (supportedAppRoleDocuments == null) {
			supportedAppRoleDocuments = new EObjectContainmentEList<DocumentProfile>(DocumentProfile.class, this, Mif2Package.CONFORMANCE_PROFILE__SUPPORTED_APP_ROLE_DOCUMENTS);
		}
	...
	public EList<PackageRef> getUnsupportedAppRoleDocuments() {
		if (unsupportedAppRoleDocuments == null) {
			unsupportedAppRoleDocuments = new EObjectContainmentEList<PackageRef>(PackageRef.class, this, Mif2Package.CONFORMANCE_PROFILE__UNSUPPORTED_APP_ROLE_DOCUMENTS);
		}
	...
	public EList<DocumentProfile> getExtraDocuments() {
		if (extraDocuments == null) {
			extraDocuments = new EObjectContainmentEList<DocumentProfile>(DocumentProfile.class, this, Mif2Package.CONFORMANCE_PROFILE__EXTRA_DOCUMENTS);
		}

...
public class GlobalTriggerEventImpl extends TriggerEventImpl implements GlobalTriggerEvent {
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.GLOBAL_TRIGGER_EVENT__SCHEMA_VERSION, oldSchemaVersion,
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, Mif2Package.GLOBAL_TRIGGER_EVENT__SCHEMA_VERSION, oldSchemaVersion,

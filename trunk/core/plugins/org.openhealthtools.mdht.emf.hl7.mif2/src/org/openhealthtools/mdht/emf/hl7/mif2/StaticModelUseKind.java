...
public enum StaticModelUseKind implements Enumerator {
	 ...
	 * @generated
	 */
	private static final StaticModelUseKind[] VALUES_ARRAY = new StaticModelUseKind[] {
			COMMUNICATION_WRAPPER, CONTROL_ACT_WRAPPER, SEMANTIC_PAYLOAD, PRESENTATION_STRUCTURE, QUERY_DEFINITION,
			CMET, TEMPLATE, };
	...
	public static StaticModelUseKind get(int value) {
		switch (value) {
			case COMMUNICATION_WRAPPER_VALUE:
				return COMMUNICATION_WRAPPER;
			case CONTROL_ACT_WRAPPER_VALUE:
				return CONTROL_ACT_WRAPPER;
			case SEMANTIC_PAYLOAD_VALUE:
				return SEMANTIC_PAYLOAD;
			case PRESENTATION_STRUCTURE_VALUE:
				return PRESENTATION_STRUCTURE;
			case QUERY_DEFINITION_VALUE:

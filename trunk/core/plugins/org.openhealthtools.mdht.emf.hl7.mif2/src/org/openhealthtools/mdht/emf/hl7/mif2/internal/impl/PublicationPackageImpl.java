...
public class PublicationPackageImpl extends PackageImpl implements PublicationPackage {
	...
	public NotificationChain basicSetAnnotations(PublicationAnnotations newAnnotations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.PUBLICATION_PACKAGE__ANNOTATIONS, oldAnnotations, newAnnotations);
	...
	public void setAnnotations(PublicationAnnotations newAnnotations) {
		if (newAnnotations != annotations) {
			...
			if (annotations != null)
				msgs = ((InternalEObject)annotations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.PUBLICATION_PACKAGE__ANNOTATIONS, null, msgs);
			if (newAnnotations != null)
				msgs = ((InternalEObject)newAnnotations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.PUBLICATION_PACKAGE__ANNOTATIONS, null, msgs);
			msgs = basicSetAnnotations(newAnnotations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.PUBLICATION_PACKAGE__ANNOTATIONS, newAnnotations, newAnnotations));
	}

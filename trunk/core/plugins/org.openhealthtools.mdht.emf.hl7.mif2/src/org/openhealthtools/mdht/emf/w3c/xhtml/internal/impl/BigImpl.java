...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Big</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.BigImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.BigImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.BigImpl#getStyle <em>Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BigImpl extends InlineImpl implements Big {
	/**
	...
	protected EClass eStaticClass() {
		return XhtmlPackage.Literals.BIG;
	}
	...
	public void setClass(MifClassType newClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, XhtmlPackage.BIG__CLASS, oldClass, class_, !oldClassESet));
		}
	}
	...
	public void unsetClass() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, XhtmlPackage.BIG__CLASS, oldClass, CLASS_EDEFAULT, oldClassESet));
		}
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BIG__LANG, oldLang, lang));
		}
	}
	...
	public void setStyle(StyleSheet newStyle) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, XhtmlPackage.BIG__STYLE, oldStyle, style, !oldStyleESet));
		}
	}
	...
	public void unsetStyle() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, XhtmlPackage.BIG__STYLE, oldStyle, STYLE_EDEFAULT, oldStyleESet));
		}
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XhtmlPackage.BIG__CLASS:
				return getClass_();
			case XhtmlPackage.BIG__LANG:
				return getLang();
			case XhtmlPackage.BIG__STYLE:
				return getStyle();
		}

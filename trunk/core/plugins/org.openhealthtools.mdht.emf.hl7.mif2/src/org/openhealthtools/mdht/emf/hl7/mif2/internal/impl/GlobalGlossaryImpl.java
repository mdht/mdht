...
public class GlobalGlossaryImpl extends GlossaryImpl implements GlobalGlossary {
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.GLOBAL_GLOSSARY__SCHEMA_VERSION, oldSchemaVersion, schemaVersion,
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, Mif2Package.GLOBAL_GLOSSARY__SCHEMA_VERSION, oldSchemaVersion,

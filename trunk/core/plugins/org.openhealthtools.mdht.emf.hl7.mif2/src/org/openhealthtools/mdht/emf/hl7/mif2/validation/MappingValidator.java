...
/**
 * A sample validator interface for {@link org.openhealthtools.mdht.emf.hl7.mif2.Mapping}.
...
public interface MappingValidator {
	...
	boolean validateSourceArtifact(PackageOrArtifactRef value);

	boolean validateName(String value);

	boolean validateSourceName(Object value);

	boolean validateSourceVersion(String value);

	boolean validateStrength(MapRelationshipKind value);
}

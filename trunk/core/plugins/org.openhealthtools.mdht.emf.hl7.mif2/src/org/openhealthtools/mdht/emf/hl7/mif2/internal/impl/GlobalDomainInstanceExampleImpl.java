...
public class GlobalDomainInstanceExampleImpl extends DomainInstanceExampleImpl implements GlobalDomainInstanceExample {
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.GLOBAL_DOMAIN_INSTANCE_EXAMPLE__SCHEMA_VERSION, oldSchemaVersion,
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, Mif2Package.GLOBAL_DOMAIN_INSTANCE_EXAMPLE__SCHEMA_VERSION, oldSchemaVersion,

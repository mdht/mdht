 ...
 * @generated
 */
public class ParticipationClassEditHelperAdvice extends RIMBaseEditHelperAdvice {
	...
	protected String getLocalizedName(EObject eObject) {
		...
		Stereotype stereotype = element.getAppliedStereotype(RIMElementTypes._PARTICIPATION__CLASS.getStereotypeName());

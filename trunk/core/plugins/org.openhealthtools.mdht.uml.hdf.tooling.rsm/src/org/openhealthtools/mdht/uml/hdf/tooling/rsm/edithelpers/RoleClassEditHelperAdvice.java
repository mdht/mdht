 ...
 * @generated
 */
public class RoleClassEditHelperAdvice extends RIMBaseEditHelperAdvice {
	...
	protected String getLocalizedName(EObject eObject) {
		...
		Stereotype stereotype = element.getAppliedStereotype(RIMElementTypes._ROLE__CLASS.getStereotypeName());

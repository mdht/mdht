...
public class TermProfileUtil {
	...
	public static Profile getTerminologyProfile(ResourceSet resourceSet) {
		...
		Resource profileResource = resourceSet.getResource(URI
				.createURI(TermResource.TERM_PROFILE_URI), true);
	...
	public static Profile getAppliedProfile(Element element) {		
		return org.openhealthtools.mdht.uml.common.util.UMLUtil.getAppliedProfile(TermResource.TERM_PROFILE_URI,element);

 ...
 * <!-- end-user-doc -->
 * 
 * @see org.openhealthtools.mdht.uml.validation.ValidationPackage
 * @generated
 */
public class ValidationSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ValidationPackage.CONSTRAINT_PROVIDER: {
				ConstraintProvider constraintProvider = (ConstraintProvider) theEObject;
				T result = caseConstraintProvider(constraintProvider);
				if (result == null) {
					result = defaultCase(theEObject);
				}
				return result;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Constraint Provider</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 ...
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Constraint Provider</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseConstraintProvider(ConstraintProvider object) {
		return null;
	}

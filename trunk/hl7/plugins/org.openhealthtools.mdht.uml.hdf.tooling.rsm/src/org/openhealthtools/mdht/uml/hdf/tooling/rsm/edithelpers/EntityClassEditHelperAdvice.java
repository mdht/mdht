 ...
 * @generated
 */
public class EntityClassEditHelperAdvice extends RIMBaseEditHelperAdvice {
	...
	protected String getLocalizedName(EObject eObject) {
		...
		Stereotype stereotype = element.getAppliedStereotype(RIMElementTypes._ENTITY__CLASS.getStereotypeName());

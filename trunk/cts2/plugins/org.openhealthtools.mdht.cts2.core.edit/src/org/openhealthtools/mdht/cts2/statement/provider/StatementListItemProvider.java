...
/**
 * This is the item provider adapter for a {@link org.openhealthtools.mdht.cts2.statement.StatementList} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class StatementListItemProvider extends DirectoryItemProvider implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatementPackage.Literals.STATEMENT_LIST__ENTRY);
		}
	...
	public String getText(Object object) {
		CompleteDirectory labelValue = ((StatementList) object).getComplete();
		String label = labelValue == null
				? null
				: labelValue.toString();
		return label == null || label.length() == 0
				? getString("_UI_StatementList_type")
				: getString("_UI_StatementList_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(
			StatementPackage.Literals.STATEMENT_LIST__ENTRY, StatementFactory.eINSTANCE.createStatementListEntry()));
	}

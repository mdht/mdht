...
/**
 * This is the item provider adapter for a {@link org.openhealthtools.mdht.cts2.core.PropertyReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class PropertyReferenceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addReferenceTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getResourceLocator(),
			getString("_UI_PropertyReference_referenceType_feature"),
			getString(
				"_UI_PropertyDescriptor_description", "_UI_PropertyReference_referenceType_feature",
				"_UI_PropertyReference_type"), CorePackage.Literals.PROPERTY_REFERENCE__REFERENCE_TYPE, true, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.PROPERTY_REFERENCE__REFERENCE_TARGET);
		}
	...
	public String getText(Object object) {
		TargetReferenceType labelValue = ((PropertyReference) object).getReferenceType();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.PROPERTY_REFERENCE__REFERENCE_TARGET, CoreFactory.eINSTANCE.createURIAndEntityName()));

		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.PROPERTY_REFERENCE__REFERENCE_TARGET, CoreFactory.eINSTANCE.createEntitySynopsis()));

		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.PROPERTY_REFERENCE__REFERENCE_TARGET, CoreFactory.eINSTANCE.createPredicateReference()));
	}

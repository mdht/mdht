...
/**
 * This is the item provider adapter for a {@link org.openhealthtools.mdht.cts2.core.SourceAndRoleReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class SourceAndRoleReferenceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public SourceAndRoleReferenceItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.SOURCE_AND_ROLE_REFERENCE__MIXED);
		}
	...
	/**
	 * This returns SourceAndRoleReference.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SourceAndRoleReference"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_SourceAndRoleReference_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SourceAndRoleReference.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.SOURCE_AND_ROLE_REFERENCE__MIXED,
		...
		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.SOURCE_AND_ROLE_REFERENCE__MIXED, FeatureMapUtil.createEntry(
		...
		newChildDescriptors.add(createChildParameter(
			...
			FeatureMapUtil.createEntry(
				CorePackage.Literals.SOURCE_AND_ROLE_REFERENCE__SOURCE, CoreFactory.eINSTANCE.createSourceReference())));

		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.SOURCE_AND_ROLE_REFERENCE__MIXED,
			FeatureMapUtil.createEntry(
				CorePackage.Literals.SOURCE_AND_ROLE_REFERENCE__ROLE, CoreFactory.eINSTANCE.createRoleReference())));

		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.SOURCE_AND_ROLE_REFERENCE__MIXED, FeatureMapUtil.createEntry(
				CorePackage.Literals.SOURCE_AND_ROLE_REFERENCE__BIBLIOGRAPHIC_LINK,

...
/**
 * This is the item provider adapter for a {@link org.openhealthtools.mdht.cts2.core.CodeSystemVersionReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class CodeSystemVersionReferenceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public CodeSystemVersionReferenceItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.CODE_SYSTEM_VERSION_REFERENCE__VERSION);
			childrenFeatures.add(CorePackage.Literals.CODE_SYSTEM_VERSION_REFERENCE__CODE_SYSTEM);
		}
	...
	/**
	 * This returns CodeSystemVersionReference.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CodeSystemVersionReference"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_CodeSystemVersionReference_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CodeSystemVersionReference.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.CODE_SYSTEM_VERSION_REFERENCE__VERSION,
		...
		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.CODE_SYSTEM_VERSION_REFERENCE__VERSION, CoreFactory.eINSTANCE.createContextReference()));
		...
		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.CODE_SYSTEM_VERSION_REFERENCE__VERSION, CoreFactory.eINSTANCE.createFormatReference()));
		...
		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.CODE_SYSTEM_VERSION_REFERENCE__VERSION, CoreFactory.eINSTANCE.createMapReference()));
		...
		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.CODE_SYSTEM_VERSION_REFERENCE__VERSION, CoreFactory.eINSTANCE.createRoleReference()));

		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.CODE_SYSTEM_VERSION_REFERENCE__VERSION, CoreFactory.eINSTANCE.createSourceReference()));

		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.CODE_SYSTEM_VERSION_REFERENCE__VERSION, CoreFactory.eINSTANCE.createStatusReference()));
		...
		newChildDescriptors.add(createChildParameter(
			CorePackage.Literals.CODE_SYSTEM_VERSION_REFERENCE__CODE_SYSTEM,
			CoreFactory.eINSTANCE.createCodeSystemReference()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == CorePackage.Literals.CODE_SYSTEM_VERSION_REFERENCE__VERSION ||
				childFeature == CorePackage.Literals.CODE_SYSTEM_VERSION_REFERENCE__CODE_SYSTEM;

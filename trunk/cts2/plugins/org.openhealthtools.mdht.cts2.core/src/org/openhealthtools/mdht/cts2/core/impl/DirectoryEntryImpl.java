 ...
 * <ul>
 * <li>{@link org.openhealthtools.mdht.cts2.core.impl.DirectoryEntryImpl#getHref <em>Href</em>}</li>
 * <li>{@link org.openhealthtools.mdht.cts2.core.impl.DirectoryEntryImpl#getMatchStrength <em>Match Strength</em>}</li>
 * <li>{@link org.openhealthtools.mdht.cts2.core.impl.DirectoryEntryImpl#getResourceName <em>Resource Name</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public abstract class DirectoryEntryImpl extends EObjectImpl implements DirectoryEntry {
	/**
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.DIRECTORY_ENTRY;
	}
	...
	public void setHref(String newHref) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.DIRECTORY_ENTRY__HREF, oldHref, href));
		}
	}
	...
	public void setMatchStrength(double newMatchStrength) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, CorePackage.DIRECTORY_ENTRY__MATCH_STRENGTH, oldMatchStrength, matchStrength,
				!oldMatchStrengthESet));
		}
	}
	...
	public void unsetMatchStrength() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, CorePackage.DIRECTORY_ENTRY__MATCH_STRENGTH, oldMatchStrength,
	...
	public void setResourceName(String newResourceName) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, CorePackage.DIRECTORY_ENTRY__RESOURCE_NAME, oldResourceName, resourceName));
		}
	}

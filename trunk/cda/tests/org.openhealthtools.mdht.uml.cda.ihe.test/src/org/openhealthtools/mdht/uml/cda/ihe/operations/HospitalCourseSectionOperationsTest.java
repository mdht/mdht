...
public class HospitalCourseSectionOperationsTest extends SectionOperationsTest {

	protected static final String TEMPLATE_ID = "1.3.6.1.4.1.19376.1.5.3.1.3.5";

	protected static final String CODE = "8648-8";
	...
	protected EObject getEObjectInitToValidate() {
		return IHEFactory.eINSTANCE.createHospitalCourseSection().init();
	}

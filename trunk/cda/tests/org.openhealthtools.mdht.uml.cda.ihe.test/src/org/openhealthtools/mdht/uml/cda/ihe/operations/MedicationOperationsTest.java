...
public class MedicationOperationsTest extends MedicationActivityOperationsTest {
	...
	protected static final String TEMPLATE_ID = "1.3.6.1.4.1.19376.1.5.3.1.4.7";
	...
	new TemplateIDCCDValidationTest(TEMPLATE_ID) {
		...
		protected boolean validate(final EObject objectToTest,
			...
			return MedicationOperations.validateMedicationTemplateId(
	...
	protected EObject getObjectToTest() {
		return IHEFactory.eINSTANCE.createMedication();
	}

	@Override
	protected EObject getObjectInitToTest() {
		return IHEFactory.eINSTANCE.createMedication().init();
	}

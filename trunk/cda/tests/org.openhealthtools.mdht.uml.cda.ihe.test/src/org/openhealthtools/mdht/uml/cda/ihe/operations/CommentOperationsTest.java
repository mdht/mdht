...
//	}
	...
	public void testValidateCommentTemplateId() {
		...
		OperationsTestCase<Comment> testCase = new OperationsTestCase<Comment>(
				"validateCommentTemplateId", operationsForOCL.getOCLValue("VALIDATE_COMMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),objectFactory) {
	...
	public void testValidateIHECommentHasTextReference() {
		...
		OperationsTestCase<Comment> testCase = new OperationsTestCase<Comment>(
				"validateIHECommentHasTextReference", operationsForOCL.getOCLValue("VALIDATE_IHE_COMMENT_HAS_TEXT_REFERENCE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),objectFactory) {
	...
	public void testValidateIHECommentEffectiveTimeWhenAuthorPresent() {
		...
		OperationsTestCase<Comment> testCase = new OperationsTestCase<Comment>(
				"validateIHECommentEffectiveTimeWhenAuthorPresent", operationsForOCL.getOCLValue("VALIDATE_IHE_COMMENT_EFFECTIVE_TIME_WHEN_AUTHOR_PRESENT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),objectFactory) {
	...
	public void testValidateIHECommentHasAuthorId() {
		...
		OperationsTestCase<Comment> testCase = new OperationsTestCase<Comment>(
				"validateIHECommentHasAuthorId", operationsForOCL.getOCLValue("VALIDATE_IHE_COMMENT_HAS_AUTHOR_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),objectFactory) {
	...
	public void testValidateIHECommentHasAuthorOrganization() {
		...
		OperationsTestCase<Comment> testCase = new OperationsTestCase<Comment>(
				"validateIHECommentHasAuthorOrganization", operationsForOCL.getOCLValue("VALIDATE_IHE_COMMENT_HAS_AUTHOR_ORGANIZATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),objectFactory) {
	...
	public void testValidateIHECommentHasAuthorPerson() {
		...
		OperationsTestCase<Comment> testCase = new OperationsTestCase<Comment>(
				"validateIHECommentHasAuthorPerson", operationsForOCL.getOCLValue("VALIDATE_IHE_COMMENT_HAS_AUTHOR_ORGANIZATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),objectFactory) {
	...
	public void testValidateIHECommentStatusCode() {
		...
		OperationsTestCase<Comment> testCase = new OperationsTestCase<Comment>(
				"validateIHECommentStatusCode", operationsForOCL.getOCLValue("VALIDATE_IHE_COMMENT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),objectFactory) {
	...
	public void testValidateIHECommentText() {
		...
		OperationsTestCase<Comment> testCase = new OperationsTestCase<Comment>(
				"validateIHECommentText", operationsForOCL.getOCLValue("VALIDATE_IHE_COMMENT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),objectFactory) {

 ...
 * <ul>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.ccd.ProblemStatusObservation#validateStatusObservationTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
...
public class ProblemStatusObservationTest extends CDAValidationTest {
	...
	public void testValidateStatusObservationTemplateId() {
		OperationsTestCase<ProblemStatusObservation> validateStatusObservationTemplateIdTestCase = new OperationsTestCase<ProblemStatusObservation>(
			...
			protected boolean validate(EObject objectToTest,
				...
				return ProblemStatusObservationOperations
						.validateStatusObservationTemplateId(
								(ProblemStatusObservation) objectToTest,
								diagnostician, map);
			}
	...
	private static class ObjectFactory implements
			TestObjectFactory<ProblemStatusObservation> {

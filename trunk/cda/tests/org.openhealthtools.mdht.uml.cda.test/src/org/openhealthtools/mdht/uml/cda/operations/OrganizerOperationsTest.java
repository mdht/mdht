 ...
 */
public class OrganizerOperationsTest extends CDAValidationTest {
	...
	// Act
			...
			new CDAAddTestCase("ObservationMedia") {
				...
				protected EStructuralFeature getFeature() {
					return CDAPackage.eINSTANCE
							.getComponent4_ObservationMedia();
				}
			},
			...
			new CDAAddTestCase("RegionOfInterest") {
				...
				protected EStructuralFeature getFeature() {
					return CDAPackage.eINSTANCE
							.getComponent4_RegionOfInterest();
				}
			},
			...
			new CDAAddTestCase("SubstanceAdministration") {
				...
				protected EStructuralFeature getFeature() {
					return CDAPackage.eINSTANCE
							.getComponent4_SubstanceAdministration();
				}
			},

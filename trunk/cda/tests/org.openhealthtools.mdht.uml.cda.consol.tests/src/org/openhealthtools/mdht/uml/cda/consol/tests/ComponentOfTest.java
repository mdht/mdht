...
public class ComponentOfTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateComponentOfEncompassingEncounter() {
		OperationsTestCase<ComponentOf> validateComponentOfEncompassingEncounterTestCase = new OperationsTestCase<ComponentOf>(
			...
			@Override
			protected void updateToFail(ComponentOf target) {

			}

			@Override
			protected void updateToPass(ComponentOf target) {
				target.init();
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ComponentOfOperations.validateComponentOfEncompassingEncounter(
					(ComponentOf) objectToTest, diagnostician, map);
			}
	...
	* @generated
	*/
	private static class OperationsForOCL extends ComponentOfOperations {
	...
	* @generated
	*/
	private static class ObjectFactory implements TestObjectFactory<ComponentOf> {
		public ComponentOf create() {
			return ConsolFactory.eINSTANCE.createComponentOf();
		}
	}
	...
	* @generated
	*/
	private static class ConstructorTestClass extends ComponentOfOperations {
	};

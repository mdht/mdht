...
public class DiagnosticImagingReport_ComponentOfTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateComponentOfEncompassingEncounter() {
		OperationsTestCase<DiagnosticImagingReport_ComponentOf> validateComponentOfEncompassingEncounterTestCase = new OperationsTestCase<DiagnosticImagingReport_ComponentOf>(
			...
			@Override
			protected void updateToFail(DiagnosticImagingReport_ComponentOf target) {

			}

			@Override
			protected void updateToPass(DiagnosticImagingReport_ComponentOf target) {
				target.init();
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return DiagnosticImagingReport_ComponentOfOperations.validateComponentOfEncompassingEncounter(
					(DiagnosticImagingReport_ComponentOf) objectToTest, diagnostician, map);
			}
	...
	* @generated
	*/
	private static class OperationsForOCL extends DiagnosticImagingReport_ComponentOfOperations {
	...
	* @generated
	*/
	private static class ObjectFactory implements TestObjectFactory<DiagnosticImagingReport_ComponentOf> {
		public DiagnosticImagingReport_ComponentOf create() {
			return ConsolFactory.eINSTANCE.createDiagnosticImagingReport_ComponentOf();
		}
	}
	...
	* @generated
	*/
	private static class ConstructorTestClass extends DiagnosticImagingReport_ComponentOfOperations {
	};

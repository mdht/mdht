...
public class GeneralHeaderConstraints_ComponentOfTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateComponentOfEncompassingEncounter() {
		OperationsTestCase<GeneralHeaderConstraints_ComponentOf> validateComponentOfEncompassingEncounterTestCase = new OperationsTestCase<GeneralHeaderConstraints_ComponentOf>(
			...
			@Override
			protected void updateToFail(GeneralHeaderConstraints_ComponentOf target) {

			}

			@Override
			protected void updateToPass(GeneralHeaderConstraints_ComponentOf target) {
				target.init();
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return GeneralHeaderConstraints_ComponentOfOperations.validateComponentOfEncompassingEncounter(
					(GeneralHeaderConstraints_ComponentOf) objectToTest, diagnostician, map);
			}
	...
	* @generated
	*/
	private static class OperationsForOCL extends GeneralHeaderConstraints_ComponentOfOperations {
	...
	* @generated
	*/
	private static class ObjectFactory implements TestObjectFactory<GeneralHeaderConstraints_ComponentOf> {
		public GeneralHeaderConstraints_ComponentOf create() {
			return ConsolFactory.eINSTANCE.createGeneralHeaderConstraints_ComponentOf();
		}
	}
	...
	* @generated
	*/
	private static class ConstructorTestClass extends GeneralHeaderConstraints_ComponentOfOperations {
	};

...
public class CurrentMedicationTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateMedicationActivityTemplateId() {
		OperationsTestCase<CurrentMedication> validateMedicationActivityTemplateIdTestCase = new OperationsTestCase<CurrentMedication>(
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return CurrentMedicationOperations.validateMedicationActivityTemplateId(
					(CurrentMedication) objectToTest, diagnostician, map);
			}

...
public class AdvanceDirectivesSectionTest extends CDAValidationTest {
	...
	*/
	@Test
	public void testValidateAdvanceDirectivesSectionAdvancedDirectiveObservation() {
		OperationsTestCase<AdvanceDirectivesSection> validateAdvanceDirectivesSectionAdvancedDirectiveObservationTestCase = new OperationsTestCase<AdvanceDirectivesSection>(
			"validateAdvanceDirectivesSectionAdvancedDirectiveObservation",
			operationsForOCL.getOCLValue("VALIDATE_ADVANCE_DIRECTIVES_SECTION_ADVANCED_DIRECTIVE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
		...
		validateAdvanceDirectivesSectionAdvancedDirectiveObservationTestCase.doValidationTest();
	}
	...
	*/
	private static class ObjectFactory implements TestObjectFactory<AdvanceDirectivesSection> {
		public AdvanceDirectivesSection create() {
			return EmspcrFactory.eINSTANCE.createAdvanceDirectivesSection();
		}
	}

...
public class AdmissionMedicationHistorySectionOperationsTest extends
		org.openhealthtools.mdht.uml.cda.ihe.operations.AdmissionMedicationHistorySectionOperationsTest {

	protected static final String TEMPLATE_ID = "2.16.840.1.113883.3.88.11.83.113";
	...
	protected EObject getObjectInitToTest() {
		return HITSPFactory.eINSTANCE.createAdmissionMedicationHistorySection().init();
	}

...
public class HistoryOfPresentIllnessOperationsTest
extends
org.openhealthtools.mdht.uml.cda.ihe.operations.HistoryOfPresentIllnessOperationsTest {

	@SuppressWarnings("hiding")
	protected static final String TEMPLATE_ID = "2.16.840.1.113883.3.88.11.83.107";
		...
		new TemplateIDCCDValidationTest(TEMPLATE_ID) {
			...
			protected boolean validate(final EObject eObjectToTest,
				...
				.validateHITSPHistoryOfPresentIllnessTemplateId(
						(HistoryOfPresentIllness) eObjectToTest,
						diagnostician, map);
			}
	...
	protected EObject getEObjectInitToValidate() {
		return HITSPFactory.eINSTANCE.createHistoryOfPresentIllness().init();
	}

...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>toc</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ToCExample {
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(ToCPackage.eNS_URI, ToCPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.toc"));
				DischargeSummary root = ToCFactory.eINSTANCE.createDischargeSummary();

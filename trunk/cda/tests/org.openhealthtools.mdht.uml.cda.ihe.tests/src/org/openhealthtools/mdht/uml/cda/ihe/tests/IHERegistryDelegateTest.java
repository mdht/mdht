...
public class IHERegistryDelegateTest extends CDAValidationTest {
	...
	* @generated
	*/
	private static class ObjectFactory implements TestObjectFactory<IHERegistryDelegate> {

		public IHERegistryDelegate create() {
			return IHEFactory.eINSTANCE.createIHERegistryDelegate();
		}
	}
	...
	* @generated
	*/
	private static class ConstructorTestClass extends IHERegistryDelegateOperations {
	};

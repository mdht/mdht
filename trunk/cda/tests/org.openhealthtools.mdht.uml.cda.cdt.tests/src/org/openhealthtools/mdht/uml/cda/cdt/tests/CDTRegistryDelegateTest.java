...
public class CDTRegistryDelegateTest extends CDAValidationTest {
	...
	*/
	 ...
	 * @generated
	 */
	private static class OperationsForOCL extends CDTRegistryDelegateOperations {
	 ...
	 * @generated
	 */
	private static class ObjectFactory implements TestObjectFactory<CDTRegistryDelegate> {

		public CDTRegistryDelegate create() {
			return CDTFactory.eINSTANCE.createCDTRegistryDelegate();
		}
	}
	 ...
	 * @generated
	 */
	private static class ConstructorTestClass extends CDTRegistryDelegateOperations {
	};

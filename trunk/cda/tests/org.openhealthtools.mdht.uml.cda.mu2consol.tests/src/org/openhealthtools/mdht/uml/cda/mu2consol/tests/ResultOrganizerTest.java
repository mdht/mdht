 ...
 * <ul>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.mu2consol.ResultOrganizer#validateMu2consolResultOrganizerResultObservation(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Mu2consol Result Organizer Result Observation</em>}</li>
 * <li>
...
public class ResultOrganizerTest extends CDAValidationTest {
	...
	public void testValidateMu2consolResultOrganizerResultObservation() {
		OperationsTestCase<ResultOrganizer> validateMu2consolResultOrganizerResultObservationTestCase = new OperationsTestCase<ResultOrganizer>(
				...
				operationsForOCL
						.getOCLValue("VALIDATE_MU2CONSOL_RESULT_ORGANIZER_RESULT_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
				objectFactory) {
		...
		validateMu2consolResultOrganizerResultObservationTestCase
				.doValidationTest();
	}

 ...
 * <ul>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.mu2consol.ProceduresSection#validateMu2consolProceduresSectionProcedureActivityProcedure(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Mu2consol Procedures Section Procedure Activity Procedure</em>}</li>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.mu2consol.ProceduresSection#getMu2consolProcedureActivityProcedures()
 * <em>Get Mu2consol Procedure Activity Procedures</em>}</li>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.mu2consol.ProceduresSection#validateProceduresSectionEntriesOptionalTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
...
public class ProceduresSectionTest extends CDAValidationTest {
	...
	public void testValidateMu2consolProceduresSectionProcedureActivityProcedure() {
		OperationsTestCase<ProceduresSection> validateMu2consolProceduresSectionProcedureActivityProcedureTestCase = new OperationsTestCase<ProceduresSection>(
				...
				operationsForOCL
						.getOCLValue("VALIDATE_MU2CONSOL_PROCEDURES_SECTION_PROCEDURE_ACTIVITY_PROCEDURE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
				objectFactory) {
		...
		validateMu2consolProceduresSectionProcedureActivityProcedureTestCase
				.doValidationTest();
	}
	...
	public void testValidateProceduresSectionEntriesOptionalTemplateId() {
		...
		validateProceduresSectionEntriesOptionalTemplateIdTestCase
				.doValidationTest();
	}

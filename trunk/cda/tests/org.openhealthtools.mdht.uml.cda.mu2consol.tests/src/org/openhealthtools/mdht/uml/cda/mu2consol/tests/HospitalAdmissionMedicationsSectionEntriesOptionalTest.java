 ...
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.mu2consol.HospitalAdmissionMedicationsSectionEntriesOptional#validateMu2consolHospitalAdmissionMedicationsSectionEntriesOptionalMedicationActivity(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Mu2consol Hospital Admission Medications Section Entries
 * Optional Medication Activity</em>}</li>
 * <li>
 ...
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.mu2consol.HospitalAdmissionMedicationsSectionEntriesOptional#getMedicationActivity()
...
public class HospitalAdmissionMedicationsSectionEntriesOptionalTest extends
	 ...
	 */
	@Test
	public void testValidateMu2consolHospitalAdmissionMedicationsSectionEntriesOptionalMedicationActivity() {
		OperationsTestCase<HospitalAdmissionMedicationsSectionEntriesOptional> validateMu2consolHospitalAdmissionMedicationsSectionEntriesOptionalMedicationActivityTestCase = new OperationsTestCase<HospitalAdmissionMedicationsSectionEntriesOptional>(
				"validateMu2consolHospitalAdmissionMedicationsSectionEntriesOptionalMedicationActivity",
				operationsForOCL
						.getOCLValue("VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_MEDICATION_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
				objectFactory) {
		...
		validateMu2consolHospitalAdmissionMedicationsSectionEntriesOptionalMedicationActivityTestCase
				.doValidationTest();
	}

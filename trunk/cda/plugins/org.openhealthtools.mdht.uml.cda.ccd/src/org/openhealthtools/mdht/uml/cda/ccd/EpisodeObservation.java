...
public interface EpisodeObservation extends Observation {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='not self.code.oclIsUndefined() and self.code.code = \'ASSERTION\' and self.code.codeSystem = \'2.16.840.1.113883.5.4\' and self.code.codeSystemName = \'ActCode\''"
	 * @generated
	 */

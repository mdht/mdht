...
public class StatusObservationOperations extends ObservationOperations {
	 ...
	 * @ordered
	 */
	protected static final String STATUS_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "not self.code.oclIsUndefined() and self.code.code = '33999-4' and self.code.codeSystem = '2.16.840.1.113883.6.1' and self.code.codeSystemName = 'LOINC'";
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StatusObservation_code", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(statusObservation, context) }),
						 new Object [] { statusObservation }));
			}
			return false;
		}
	 ...
	 * @ordered
	 */
	protected static final String STATUS_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "not self.statusCode.oclIsUndefined() and self.statusCode.code = 'completed' and self.statusCode.codeSystem = '2.16.840.1.113883.5.14' and self.statusCode.codeSystemName = 'ActStatus'";

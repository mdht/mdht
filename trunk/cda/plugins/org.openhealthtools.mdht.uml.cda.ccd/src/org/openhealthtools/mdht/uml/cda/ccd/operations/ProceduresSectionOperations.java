...
public class ProceduresSectionOperations extends SectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String PROCEDURES_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.hasTemplateId('2.16.840.1.113883.10.20.1.14')";
	 ...
	 * @ordered
	 */
	protected static final String PROCEDURES_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "not self.code.oclIsUndefined() and self.code.oclIsTypeOf(datatypes::CE) and "+

 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.PayersSection#validatePayersSectionTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Payers Section Template Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HITSPValidator.PAYERS_SECTION__PAYERS_SECTION_TEMPLATE_ID,
						 HITSPPlugin.INSTANCE.getString("PayersSectionTemplateId"),

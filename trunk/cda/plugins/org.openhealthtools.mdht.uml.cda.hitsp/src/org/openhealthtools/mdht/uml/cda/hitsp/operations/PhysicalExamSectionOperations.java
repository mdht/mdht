 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.PhysicalExamSection#PhysicalExamSection_templateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Physical Exam Section template Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PhysicalExamSectionOperations extends org.openhealthtools.mdht.uml.cda.ihe.operations.PhysicalExamSectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String PHYSICAL_EXAM_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.hasTemplateId('2.16.840.1.113883.3.88.11.83.118')";
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.hasTemplateId('2.16.840.1.113883.3.88.11.83.118')
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HITSPValidator.PHYSICAL_EXAM_SECTION__PHYSICAL_EXAM_SECTION_TEMPLATE_ID,
						 HITSPPlugin.INSTANCE.getString("PhysicalExamSection_templateId"),

 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.core.cdaprofile.impl.ConceptDomainConstraintImpl#getMessage <em>Message</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.core.cdaprofile.impl.ConceptDomainConstraintImpl#getSeverity <em>Severity</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.core.cdaprofile.impl.ConceptDomainConstraintImpl#getRuleId <em>Rule Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ConceptDomainConstraintImpl extends org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ConceptDomainConstraintImpl implements ConceptDomainConstraint {
	/**
	...
	public EList<String> getRuleId() {
		if (ruleId == null) {
			ruleId = new EDataTypeUniqueEList<String>(String.class, this, CDAPackage.CONCEPT_DOMAIN_CONSTRAINT__RULE_ID);
		}
		return ruleId;
	}

...
public class SetRequiresParentIdAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		try {
			...
			IUndoableOperation operation = new AbstractEMFOperation(editingDomain, "Set requiresParentId") {
				@Override
				protected IStatus doExecute(IProgressMonitor monitor, IAdaptable info) {
					...
					while (iterator != null && iterator.hasNext()) {
						...
						if (child instanceof Generalization && ((Generalization) child).getGeneral() instanceof Class) {

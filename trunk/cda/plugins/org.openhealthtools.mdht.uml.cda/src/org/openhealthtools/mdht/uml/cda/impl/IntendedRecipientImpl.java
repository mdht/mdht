...
public class IntendedRecipientImpl extends EObjectImpl implements IntendedRecipient {
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.INTENDED_RECIPIENT__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setClassCode(x_InformationRecipientRole newClassCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.INTENDED_RECIPIENT__CLASS_CODE, oldClassCode, classCode));
	}

...
public class ActOperations extends ClinicalStatementOperations {
	...
	public static  EList<Act> getActs(Act act) {
		if (GET_ACTS__EOCL_QRY == null) {
			...
			helper.setOperationContext(CDAPackage.Literals.ACT, CDAPackage.Literals.ACT.getEAllOperations().get(10));
			try {
	...
	public static  EList<Encounter> getEncounters(Act act) {
		if (GET_ENCOUNTERS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(CDAPackage.Literals.ACT, CDAPackage.Literals.ACT.getEAllOperations().get(12));
			try {
	...
	public static  EList<SubstanceAdministration> getSubstanceAdministrations(Act act) {
		if (GET_SUBSTANCE_ADMINISTRATIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(CDAPackage.Literals.ACT, CDAPackage.Literals.ACT.getEAllOperations().get(19));
			try {

...
public class PersonImpl extends EObjectImpl implements Person {
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.PERSON__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setClassCode(EntityClass newClassCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.PERSON__CLASS_CODE, oldClassCode, classCode));
	}
	...
	public void setDeterminerCode(EntityDeterminer newDeterminerCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.PERSON__DETERMINER_CODE, oldDeterminerCode, determinerCode));
	}

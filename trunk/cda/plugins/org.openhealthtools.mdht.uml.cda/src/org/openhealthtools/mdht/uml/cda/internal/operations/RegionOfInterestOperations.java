...
public class RegionOfInterestOperations {
	...
	public static  EList<Encounter> getEncounter(RegionOfInterest regionOfInterest) {
		if (GET_ENCOUNTER__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(CDAPackage.eINSTANCE.getRegionOfInterest(), CDAPackage.eINSTANCE.getRegionOfInterest().getEAllOperations().get(10));
			try {
	...
	public static  EList<Supply> getSupply(RegionOfInterest regionOfInterest) {
		if (GET_SUPPLY__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(CDAPackage.eINSTANCE.getRegionOfInterest(), CDAPackage.eINSTANCE.getRegionOfInterest().getEAllOperations().get(17));
			try {

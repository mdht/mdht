 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.Specimen#validateTypeCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Type Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SpecimenOperations extends ParticipationOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "not self.typeCode.oclIsUndefined() implies self.typeCode=vocab::ParticipationType::SPC";
	 ...
	 * @generated
	 */
	public static  boolean validateTypeCode(Specimen specimen, DiagnosticChain diagnostics, Map<Object, Object> context) {

...
public class CustodianImpl extends EObjectImpl implements Custodian {
	...
	protected EClass eStaticClass() {
		return CDAPackage.eINSTANCE.getCustodian();
	}
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.CUSTODIAN__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setTypeCode(ParticipationType newTypeCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.CUSTODIAN__TYPE_CODE, oldTypeCode, typeCode));
	}

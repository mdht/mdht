 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.AssignedCustodian#validateClassCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Class Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssignedCustodianOperations extends RoleOperations {
	 ...
	 * @generated
	 */
	public static  boolean validateClassCode(AssignedCustodian assignedCustodian, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(assignedCustodian)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,

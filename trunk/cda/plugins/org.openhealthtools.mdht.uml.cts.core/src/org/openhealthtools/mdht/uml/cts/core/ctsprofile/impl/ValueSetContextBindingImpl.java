 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetContextBindingImpl#getEffectiveDate <em>Effective Date</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetContextBindingImpl#getConceptDomain <em>Concept Domain</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetContextBindingImpl#getValueSet <em>Value Set</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetContextBindingImpl#getUsageContext <em>Usage Context</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetContextBindingImpl#getBase_Class <em>Base Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValueSetContextBindingImpl extends EObjectImpl implements ValueSetContextBinding {
	...
	protected EClass eStaticClass() {
		return CTSPackage.Literals.VALUE_SET_CONTEXT_BINDING;
	}
	...
	public void setEffectiveDate(String newEffectiveDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_CONTEXT_BINDING__EFFECTIVE_DATE, oldEffectiveDate, effectiveDate));
	}
	...
	public ConceptDomain getConceptDomain() {
		if (conceptDomain != null && conceptDomain.eIsProxy()) {
			...
			if (conceptDomain != oldConceptDomain) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CTSPackage.VALUE_SET_CONTEXT_BINDING__CONCEPT_DOMAIN, oldConceptDomain, conceptDomain));
			}
		}
	...
	public void setConceptDomain(ConceptDomain newConceptDomain) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_CONTEXT_BINDING__CONCEPT_DOMAIN, oldConceptDomain, conceptDomain));
	}
	...
	public ValueSetVersion getValueSet() {
		if (valueSet != null && valueSet.eIsProxy()) {
			...
			if (valueSet != oldValueSet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CTSPackage.VALUE_SET_CONTEXT_BINDING__VALUE_SET, oldValueSet, valueSet));
			}
		}
		return valueSet;
	}
	...
	public void setValueSet(ValueSetVersion newValueSet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_CONTEXT_BINDING__VALUE_SET, oldValueSet, valueSet));
	}
	...
	public UsageContext getUsageContext() {
		if (usageContext != null && usageContext.eIsProxy()) {
			...
			if (usageContext != oldUsageContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CTSPackage.VALUE_SET_CONTEXT_BINDING__USAGE_CONTEXT, oldUsageContext, usageContext));
			}
		}
		return usageContext;
	}
	...
	public void setUsageContext(UsageContext newUsageContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_CONTEXT_BINDING__USAGE_CONTEXT, oldUsageContext, usageContext));
	}
	...
	public org.eclipse.uml2.uml.Class getBase_Class() {
		if (base_Class != null && base_Class.eIsProxy()) {
			...
			if (base_Class != oldBase_Class) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CTSPackage.VALUE_SET_CONTEXT_BINDING__BASE_CLASS, oldBase_Class, base_Class));
			}
		}
		return base_Class;
	}
	...
	public void setBase_Class(org.eclipse.uml2.uml.Class newBase_Class) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_CONTEXT_BINDING__BASE_CLASS, oldBase_Class, base_Class));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CTSPackage.VALUE_SET_CONTEXT_BINDING__EFFECTIVE_DATE:
				return getEffectiveDate();
			case CTSPackage.VALUE_SET_CONTEXT_BINDING__CONCEPT_DOMAIN:
				if (resolve) return getConceptDomain();
				return basicGetConceptDomain();
			case CTSPackage.VALUE_SET_CONTEXT_BINDING__VALUE_SET:
				if (resolve) return getValueSet();
				return basicGetValueSet();
			case CTSPackage.VALUE_SET_CONTEXT_BINDING__USAGE_CONTEXT:
				if (resolve) return getUsageContext();
				return basicGetUsageContext();
			case CTSPackage.VALUE_SET_CONTEXT_BINDING__BASE_CLASS:

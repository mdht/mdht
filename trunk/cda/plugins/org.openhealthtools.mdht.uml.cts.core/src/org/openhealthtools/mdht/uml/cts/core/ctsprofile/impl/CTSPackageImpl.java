...
import org.openhealthtools.mdht.uml.cts.core.ctsprofile.CTSFactory;
...
import org.openhealthtools.mdht.uml.cts.core.ctsprofile.ConceptDomain;
...
import org.openhealthtools.mdht.uml.cts.core.ctsprofile.UsageContext;
import org.openhealthtools.mdht.uml.cts.core.ctsprofile.ValueSetCode;
import org.openhealthtools.mdht.uml.cts.core.ctsprofile.ValueSetConstraint;
import org.openhealthtools.mdht.uml.cts.core.ctsprofile.ValueSetContextBinding;
 ...
 * @generated
 */
public class CTSPackageImpl extends EPackageImpl implements CTSPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.openhealthtools.mdht.uml.cts.core.ctsprofile.CTSPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CTSPackageImpl() {
		super(eNS_URI, CTSFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static CTSPackage init() {
		if (isInited) return (CTSPackage)EPackage.Registry.INSTANCE.getEPackage(CTSPackage.eNS_URI);

		// Obtain or create and register package
		CTSPackageImpl theCTSPackage = (CTSPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof CTSPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new CTSPackageImpl());
		...
		theCTSPackage.createPackageContents();

		// Initialize created meta-data
		theCTSPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theCTSPackage.freeze();

		return theCTSPackage;
	}
	 ...
	 * @generated
	 */
	public CTSFactory getCTSFactory() {
		return (CTSFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEClass(cdEClass, org.openhealthtools.mdht.uml.cts.core.ctsprofile.CD.class, "CD", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCD_Qualifier(), this.getCR(), null, "qualifier", null, 0, -1, org.openhealthtools.mdht.uml.cts.core.ctsprofile.CD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getCD_Translation(), this.getCD(), null, "translation", null, 0, -1, org.openhealthtools.mdht.uml.cts.core.ctsprofile.CD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getCD_Code(), ecorePackage.getEString(), "code", null, 0, 1, org.openhealthtools.mdht.uml.cts.core.ctsprofile.CD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getCD_CodeSystem(), ecorePackage.getEString(), "codeSystem", null, 0, 1, org.openhealthtools.mdht.uml.cts.core.ctsprofile.CD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getCD_CodeSystemName(), ecorePackage.getEString(), "codeSystemName", null, 0, 1, org.openhealthtools.mdht.uml.cts.core.ctsprofile.CD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getCD_CodeSystemVersion(), ecorePackage.getEString(), "codeSystemVersion", null, 0, 1, org.openhealthtools.mdht.uml.cts.core.ctsprofile.CD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getCD_DisplayName(), ecorePackage.getEString(), "displayName", null, 0, 1, org.openhealthtools.mdht.uml.cts.core.ctsprofile.CD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(crEClass, org.openhealthtools.mdht.uml.cts.core.ctsprofile.CR.class, "CR", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCR_Name(), this.getCD(), null, "name", null, 0, 1, org.openhealthtools.mdht.uml.cts.core.ctsprofile.CR.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getCR_Value(), this.getCD(), null, "value", null, 0, 1, org.openhealthtools.mdht.uml.cts.core.ctsprofile.CR.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getCR_Inverted(), ecorePackage.getEBoolean(), "inverted", null, 0, 1, org.openhealthtools.mdht.uml.cts.core.ctsprofile.CR.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

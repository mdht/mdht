				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "ProblemConcernEntry_templateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(problemConcernEntry, context) }),

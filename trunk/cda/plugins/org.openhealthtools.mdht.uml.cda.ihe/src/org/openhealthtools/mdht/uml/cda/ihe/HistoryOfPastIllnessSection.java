 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystemName='LOINC' constraints.validation.error='HistoryOfPastIllnessSection_templateId HistoryOfPastIllnessSection_code' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.3.8' code.displayName='HISTORY OF PAST ILLNESS' code.codeSystem='2.16.840.1.113883.6.1' code.code='11348-0'"
 * @generated
 */
public interface HistoryOfPastIllnessSection extends Section {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.hasTemplateId(\'1.3.6.1.4.1.19376.1.5.3.1.3.8\')'"
	 * @generated
	 */
	boolean HistoryOfPastIllnessSection_templateId(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean HistoryOfPastIllnessSection_code(DiagnosticChain diagnostics, Map<Object, Object> context);

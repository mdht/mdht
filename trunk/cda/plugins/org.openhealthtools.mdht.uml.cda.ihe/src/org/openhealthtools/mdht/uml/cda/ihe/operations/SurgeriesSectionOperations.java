 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.ihe.SurgeriesSection#SurgeriesSection_templateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Surgeries Section template Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SurgeriesSectionOperations extends ProceduresSectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String SURGERIES_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.hasTemplateId('1.3.6.1.4.1.19376.1.5.3.1.3.11')";
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.hasTemplateId('1.3.6.1.4.1.19376.1.5.3.1.3.11')
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 IHEPlugin.INSTANCE.getString("SurgeriesSection_templateId"),

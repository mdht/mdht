 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystemName='LOINC' constraints.validation.error='ReasonForReferralSection_templateId ReasonForReferralSection_code' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.3.1' code.displayName='REASON FOR REFERRAL' code.codeSystem='2.16.840.1.113883.6.1' code.code='42349-1'"
 * @generated
 */
public interface ReasonForReferralSection extends Section {
	 ...
	 * @generated
	 */
	boolean ReasonForReferralSection_code(DiagnosticChain diagnostics, Map<Object, Object> context);

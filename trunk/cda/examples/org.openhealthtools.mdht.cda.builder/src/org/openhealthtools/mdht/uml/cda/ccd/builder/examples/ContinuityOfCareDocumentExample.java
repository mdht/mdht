...
public class ContinuityOfCareDocumentExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Patient patient = patientBuilder.withName(patientName)
											.withAdministrativeGender(DatatypesFactory.eINSTANCE.createCE("M", "2.16.840.1.113883.5.1"))
											.withBirthTime(DatatypesFactory.eINSTANCE.createTS("1/1/1970"))
											.withId( DatatypesFactory.eINSTANCE.createII("123456789"))
											.build();
			...
			ContinuityOfCareDocument continuityOfCareDocument = CCDbuilder.with(patient)
														  				  .with(problemSection)
														  				  .with(familyHistorySection)

...
import org.openhealthtools.mdht.builder.ccd.DocumentBuilder.MedicationsSectionBuilder;
import org.openhealthtools.mdht.builder.ccd.DocumentBuilder.PayersSectionBuilder;
import org.openhealthtools.mdht.builder.ccd.DocumentBuilder.PlanOfCareSectionBuilder;
...
public class C32PlanOfCareExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			CDAUtil.save(clinicalDocument, new FileOutputStream("/home/eclipse/heliosworkspaceG/org.openhealthtools.mdht.cda.builder/resource/ExampleC32PlanOfCare.xml"));

...
public class GlobalDomainAnalysisModelImpl extends DomainAnalysisModelImpl implements GlobalDomainAnalysisModel {
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.GLOBAL_DOMAIN_ANALYSIS_MODEL__SCHEMA_VERSION, oldSchemaVersion,
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, Mif2Package.GLOBAL_DOMAIN_ANALYSIS_MODEL__SCHEMA_VERSION, oldSchemaVersion,

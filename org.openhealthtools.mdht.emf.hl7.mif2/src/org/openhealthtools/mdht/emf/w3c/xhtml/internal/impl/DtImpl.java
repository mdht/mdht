 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.DtImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.DtImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.DtImpl#getStyle <em>Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DtImpl extends InlineImpl implements Dt {
	/**
	...
	protected EClass eStaticClass() {
		return XhtmlPackage.Literals.DT;
	}
	...
	public void setClass(MifClassType newClass) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, XhtmlPackage.DT__CLASS, oldClass, class_, !oldClassESet));
		}
	}
	...
	public void unsetClass() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, XhtmlPackage.DT__CLASS, oldClass, CLASS_EDEFAULT, oldClassESet));
		}
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.DT__LANG, oldLang, lang));
		}
	}
	...
	public void setStyle(StyleSheet newStyle) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, XhtmlPackage.DT__STYLE, oldStyle, style, !oldStyleESet));
		}
	}
	...
	public void unsetStyle() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, XhtmlPackage.DT__STYLE, oldStyle, STYLE_EDEFAULT, oldStyleESet));
		}
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XhtmlPackage.DT__CLASS:
				return getClass_();
			case XhtmlPackage.DT__LANG:
				return getLang();
			case XhtmlPackage.DT__STYLE:
				return getStyle();
		}

		...
		if (newNumerator != numerator) {
			...
			if (numerator != null) {
				msgs = ((InternalEObject) numerator).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - DatatypesPackage.RTO_QTY_QTY__NUMERATOR, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DatatypesPackage.RTO_QTY_QTY__NUMERATOR, newNumerator,
				newNumerator));
		}
	}
		...
		if (newDenominator != denominator) {
			...
			if (denominator != null) {
				msgs = ((InternalEObject) denominator).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - DatatypesPackage.RTO_QTY_QTY__DENOMINATOR, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DatatypesPackage.RTO_QTY_QTY__DENOMINATOR,

...
public class ReactionObservationOperations extends ObservationOperations {
	 ...
	 * @ordered
	 */
	protected static final String REACTION_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "not self.statusCode.oclIsUndefined() and self.statusCode.oclIsTypeOf(datatypes::CS) and "+

...
public interface ProblemStatus extends Observation {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='not self.value.oclIsUndefined() and self.value.codeSystem = \'2.16.840.1.113883.1.11.20.13\' and self.value.codeSystemName = \'ProblemStatusCode\' and self.value.codeSystemVersion = \'20061017\''"
	 * @generated
	 */

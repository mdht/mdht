...
public class NeonatalCareReportOperations extends ClinicalDocumentOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_NEONATAL_CARE_REPORT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.hasTemplateId('2.16.840.1.113883.10.20.17.1.1')";
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.hasTemplateId('2.16.840.1.113883.10.20.17.1.1')

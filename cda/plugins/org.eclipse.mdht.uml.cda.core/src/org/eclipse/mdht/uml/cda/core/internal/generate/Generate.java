 ...
 * $Id$
 *******************************************************************************/
package org.eclipse.mdht.uml.cda.core.internal.generate;
...
public class Generate {
	...
	public static void main(String[] args) {
		...
		String cdaProfileLocation = org.eclipse.mdht.uml.cda.resources.util.CDAResource.CDA_PROFILE_URI +
		...
		URI cdaPathmap = URI.createURI(org.eclipse.mdht.uml.cda.resources.util.CDAResource.PROFILES_PATHMAP);
		...
		UMLPlugin.getEPackageNsURIToProfileLocationMap().put(
			org.eclipse.mdht.uml.cda.core.profile.CDAPackage.eNS_URI, URI.createURI(cdaProfileLocation));

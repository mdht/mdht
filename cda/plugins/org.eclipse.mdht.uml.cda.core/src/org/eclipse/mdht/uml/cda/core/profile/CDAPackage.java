...
public interface CDAPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int CONCEPT_DOMAIN_CONSTRAINT_FEATURE_COUNT = VALIDATION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int CODE_SYSTEM_CONSTRAINT__MESSAGE = VALIDATION__MESSAGE;
	 ...
	 * @ordered
	 */
	int CODE_SYSTEM_CONSTRAINT__SEVERITY = VALIDATION__SEVERITY;
	 ...
	 * @ordered
	 */
	int CODE_SYSTEM_CONSTRAINT__RULE_ID = VALIDATION__RULE_ID;
	 ...
	 * @ordered
	 */
	int CODE_SYSTEM_CONSTRAINT__MANDATORY = VALIDATION__MANDATORY;
	 ...
	 * @ordered
	 */
	int CODE_SYSTEM_CONSTRAINT__KIND = VALIDATION__KIND;
	 ...
	 * @ordered
	 */
	int CODE_SYSTEM_CONSTRAINT__STRICT = VALIDATION__STRICT;
	 ...
	 * @ordered
	 */
	int CODE_SYSTEM_CONSTRAINT__NEGATION_INDICATOR = VALIDATION__NEGATION_INDICATOR;
	 ...
	 * @ordered
	 */
	int CODE_SYSTEM_CONSTRAINT_FEATURE_COUNT = VALIDATION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int VALUE_SET_CONSTRAINT_FEATURE_COUNT = VALIDATION_FEATURE_COUNT + 0;

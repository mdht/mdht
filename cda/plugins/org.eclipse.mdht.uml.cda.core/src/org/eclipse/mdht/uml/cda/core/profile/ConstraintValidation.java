 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.mdht.uml.cda.core.profile.ConstraintValidation#getBase_Constraint <em>Base Constraint</em>}</li>
 * <li>{@link org.eclipse.mdht.uml.cda.core.profile.ConstraintValidation#isEnabledDitaForConstraints <em>Enabled Dita For Constraints</em>}</li>
 * </ul>
 *
 * @see org.eclipse.mdht.uml.cda.core.profile.CDAPackage#getConstraintValidation()
 * @model
 * @generated
 */
public interface ConstraintValidation extends Validation {
	...
	/**
	 * Sets the value of the '{@link org.eclipse.mdht.uml.cda.core.profile.ConstraintValidation#getBase_Constraint <em>Base Constraint</em>}'
	 * reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *

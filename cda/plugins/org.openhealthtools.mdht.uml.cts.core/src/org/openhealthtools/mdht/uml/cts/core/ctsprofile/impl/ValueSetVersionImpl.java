...
import org.openhealthtools.mdht.uml.cts.core.ctsprofile.StatusKind;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getFullName <em>Full Name</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getDefinition <em>Definition</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getEffectiveDate <em>Effective Date</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getExpirationDate <em>Expiration Date</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getReleaseDate <em>Release Date</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getRevisionDate <em>Revision Date</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getStatusDate <em>Status Date</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getBinding <em>Binding</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getCodeSystem <em>Code System</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetVersionImpl#getBase_Enumeration <em>Base Enumeration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValueSetVersionImpl extends EObjectImpl implements ValueSetVersion {
	...
	protected EClass eStaticClass() {
		return CTSPackage.Literals.VALUE_SET_VERSION;
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__VERSION, oldVersion, version));
	}
	...
	public void setFullName(String newFullName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__FULL_NAME, oldFullName, fullName));
	}
	...
	public void setSource(String newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__SOURCE, oldSource, source));
	}
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__URL, oldUrl, url));
	}
	...
	public void setDefinition(String newDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__DEFINITION, oldDefinition, definition));
	}
	...
	public void setEffectiveDate(String newEffectiveDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__EFFECTIVE_DATE, oldEffectiveDate, effectiveDate));
	}
	...
	public void setExpirationDate(String newExpirationDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__EXPIRATION_DATE, oldExpirationDate, expirationDate));
	}
	...
	public void setReleaseDate(String newReleaseDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__RELEASE_DATE, oldReleaseDate, releaseDate));
	}
	...
	public void setRevisionDate(String newRevisionDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__REVISION_DATE, oldRevisionDate, revisionDate));
	}
	...
	public void setStatus(StatusKind newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__STATUS, oldStatus, status));
	}
	...
	public void setStatusDate(String newStatusDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__STATUS_DATE, oldStatusDate, statusDate));
	}
	...
	public void setType(ValueSetType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__TYPE, oldType, type));
	}
	...
	public void setBinding(BindingKind newBinding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__BINDING, oldBinding, binding));
	}
	...
	public CodeSystemVersion getCodeSystem() {
		if (codeSystem != null && codeSystem.eIsProxy()) {
			...
			if (codeSystem != oldCodeSystem) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CTSPackage.VALUE_SET_VERSION__CODE_SYSTEM, oldCodeSystem, codeSystem));
			}
		}
		return codeSystem;
	}
	...
	public void setCodeSystem(CodeSystemVersion newCodeSystem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__CODE_SYSTEM, oldCodeSystem, codeSystem));
	}
	...
	public Enumeration getBase_Enumeration() {
		if (base_Enumeration != null && base_Enumeration.eIsProxy()) {
			...
			if (base_Enumeration != oldBase_Enumeration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CTSPackage.VALUE_SET_VERSION__BASE_ENUMERATION, oldBase_Enumeration, base_Enumeration));
			}
		}
	...
	public void setBase_Enumeration(Enumeration newBase_Enumeration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_VERSION__BASE_ENUMERATION, oldBase_Enumeration, base_Enumeration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CTSPackage.VALUE_SET_VERSION__IDENTIFIER:
				return getIdentifier();
			case CTSPackage.VALUE_SET_VERSION__VERSION:
				return getVersion();
			case CTSPackage.VALUE_SET_VERSION__FULL_NAME:
				return getFullName();
			case CTSPackage.VALUE_SET_VERSION__SOURCE:
				return getSource();
			case CTSPackage.VALUE_SET_VERSION__URL:
				return getUrl();
			case CTSPackage.VALUE_SET_VERSION__DEFINITION:
				return getDefinition();
			case CTSPackage.VALUE_SET_VERSION__EFFECTIVE_DATE:
				return getEffectiveDate();
			case CTSPackage.VALUE_SET_VERSION__EXPIRATION_DATE:
				return getExpirationDate();
			case CTSPackage.VALUE_SET_VERSION__RELEASE_DATE:
				return getReleaseDate();
			case CTSPackage.VALUE_SET_VERSION__REVISION_DATE:
				return getRevisionDate();
			case CTSPackage.VALUE_SET_VERSION__STATUS:
				return getStatus();
			case CTSPackage.VALUE_SET_VERSION__STATUS_DATE:
				return getStatusDate();
			case CTSPackage.VALUE_SET_VERSION__TYPE:
				return getType();
			case CTSPackage.VALUE_SET_VERSION__BINDING:
				return getBinding();
			case CTSPackage.VALUE_SET_VERSION__CODE_SYSTEM:
				if (resolve) return getCodeSystem();
				return basicGetCodeSystem();
			case CTSPackage.VALUE_SET_VERSION__BASE_ENUMERATION:

...
import org.openhealthtools.mdht.uml.cts.core.ctsprofile.CD;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.CDImpl#getQualifier <em>Qualifier</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.CDImpl#getTranslation <em>Translation</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.CDImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.CDImpl#getCodeSystem <em>Code System</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.CDImpl#getCodeSystemName <em>Code System Name</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.CDImpl#getCodeSystemVersion <em>Code System Version</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.CDImpl#getDisplayName <em>Display Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CDImpl extends EObjectImpl implements CD {
	...
	public EList<CR> getQualifier() {
		if (qualifier == null) {
			qualifier = new EObjectContainmentEList<CR>(CR.class, this, CTSPackage.CD__QUALIFIER);
		}
		return qualifier;
	}
	...
	public EList<CD> getTranslation() {
		if (translation == null) {
			translation = new EObjectContainmentEList<CD>(CD.class, this, CTSPackage.CD__TRANSLATION);
		}
		return translation;
	}
	...
	public void setCode(String newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.CD__CODE, oldCode, code));
	}
	...
	public void setCodeSystem(String newCodeSystem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.CD__CODE_SYSTEM, oldCodeSystem, codeSystem));
	}
	...
	public void setCodeSystemName(String newCodeSystemName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.CD__CODE_SYSTEM_NAME, oldCodeSystemName, codeSystemName));
	}
	...
	public void setCodeSystemVersion(String newCodeSystemVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.CD__CODE_SYSTEM_VERSION, oldCodeSystemVersion, codeSystemVersion));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.CD__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CTSPackage.CD__QUALIFIER:
				return ((InternalEList<?>)getQualifier()).basicRemove(otherEnd, msgs);
			case CTSPackage.CD__TRANSLATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CTSPackage.CD__CODE:
				return getCode();
			case CTSPackage.CD__CODE_SYSTEM:
				return getCodeSystem();
			case CTSPackage.CD__CODE_SYSTEM_NAME:
				return getCodeSystemName();
			case CTSPackage.CD__CODE_SYSTEM_VERSION:
				return getCodeSystemVersion();
			case CTSPackage.CD__DISPLAY_NAME:

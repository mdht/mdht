 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetCodeImpl#getConceptName <em>Concept Name</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetCodeImpl#getUsageNote <em>Usage Note</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetCodeImpl#getCodeSystem <em>Code System</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cts.core.ctsprofile.impl.ValueSetCodeImpl#getBase_EnumerationLiteral <em>Base Enumeration Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValueSetCodeImpl extends EObjectImpl implements ValueSetCode {
	...
	protected EClass eStaticClass() {
		return CTSPackage.Literals.VALUE_SET_CODE;
	}
	...
	public void setConceptName(String newConceptName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_CODE__CONCEPT_NAME, oldConceptName, conceptName));
	}
	...
	public void setUsageNote(String newUsageNote) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_CODE__USAGE_NOTE, oldUsageNote, usageNote));
	}
	...
	public CodeSystemVersion getCodeSystem() {
		if (codeSystem != null && codeSystem.eIsProxy()) {
			...
			if (codeSystem != oldCodeSystem) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CTSPackage.VALUE_SET_CODE__CODE_SYSTEM, oldCodeSystem, codeSystem));
			}
		}
		return codeSystem;
	}
	...
	public void setCodeSystem(CodeSystemVersion newCodeSystem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_CODE__CODE_SYSTEM, oldCodeSystem, codeSystem));
	}
	...
	public EnumerationLiteral getBase_EnumerationLiteral() {
		if (base_EnumerationLiteral != null && base_EnumerationLiteral.eIsProxy()) {
			...
			if (base_EnumerationLiteral != oldBase_EnumerationLiteral) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CTSPackage.VALUE_SET_CODE__BASE_ENUMERATION_LITERAL, oldBase_EnumerationLiteral, base_EnumerationLiteral));
			}
		}
	...
	public void setBase_EnumerationLiteral(EnumerationLiteral newBase_EnumerationLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CTSPackage.VALUE_SET_CODE__BASE_ENUMERATION_LITERAL, oldBase_EnumerationLiteral, base_EnumerationLiteral));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CTSPackage.VALUE_SET_CODE__CONCEPT_NAME:
				return getConceptName();
			case CTSPackage.VALUE_SET_CODE__USAGE_NOTE:
				return getUsageNote();
			case CTSPackage.VALUE_SET_CODE__CODE_SYSTEM:
				if (resolve) return getCodeSystem();
				return basicGetCodeSystem();
			case CTSPackage.VALUE_SET_CODE__BASE_ENUMERATION_LITERAL:

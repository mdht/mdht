 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.AdmissionMedicationHistorySection#AdmissionMedicationHistorySection_templateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Admission Medication History Section template Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AdmissionMedicationHistorySectionOperations extends org.openhealthtools.mdht.uml.cda.ihe.operations.AdmissionMedicationHistorySectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String ADMISSION_MEDICATION_HISTORY_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.hasTemplateId('2.16.840.1.113883.3.88.11.83.113')";
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.hasTemplateId('2.16.840.1.113883.3.88.11.83.113')
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HITSPPlugin.INSTANCE.getString("AdmissionMedicationHistorySection_templateId"),

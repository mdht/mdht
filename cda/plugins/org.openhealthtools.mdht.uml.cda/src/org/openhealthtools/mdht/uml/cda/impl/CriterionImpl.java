...
import org.openhealthtools.mdht.uml.cda.operations.CriterionOperations;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.CriterionImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.CriterionImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.CriterionImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.CriterionImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.CriterionImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.CriterionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.CriterionImpl#getNullFlavor <em>Null Flavor</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.CriterionImpl#getClassCode <em>Class Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.CriterionImpl#getMoodCode <em>Mood Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CriterionImpl extends ActImpl implements Criterion {
	...
	public NotificationChain basicSetTypeId(InfrastructureRootTypeId newTypeId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.CRITERION__TYPE_ID, oldTypeId, newTypeId);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newTypeId != typeId) {
			...
			if (typeId != null) {
				msgs = ((InternalEObject) typeId).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.CRITERION__TYPE_ID, null, msgs);
			}
			if (newTypeId != null) {
	...
	public NotificationChain basicSetCode(CD newCode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.CRITERION__CODE, oldCode, newCode);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newCode != code) {
			...
			if (code != null) {
				msgs = ((InternalEObject) code).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.CRITERION__CODE, null, msgs);
			}
			if (newCode != null) {
	...
	public NotificationChain basicSetText(ED newText, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.CRITERION__TEXT, oldText, newText);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newText != text) {
			...
			if (text != null) {
				msgs = ((InternalEObject) text).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.CRITERION__TEXT, null, msgs);
			}
			if (newText != null) {
	...
	public NotificationChain basicSetValue(ANY newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.CRITERION__VALUE, oldValue, newValue);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newValue != value) {
			...
			if (value != null) {
				msgs = ((InternalEObject) value).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.CRITERION__VALUE, null, msgs);
			}
			if (newValue != null) {
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		nullFlavorESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.CRITERION__NULL_FLAVOR, oldNullFlavor,
	...
	public void unsetNullFlavor() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.CRITERION__NULL_FLAVOR, oldNullFlavor,
	...
	public void setClassCode(ActClassObservation newClassCode) {
		...
		classCodeESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.CRITERION__CLASS_CODE, oldClassCode,
	...
	public void unsetClassCode() {
		...
		classCodeESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.CRITERION__CLASS_CODE, oldClassCode,
	...
	public void setMoodCode(ActMood newMoodCode) {
		...
		moodCodeESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.CRITERION__MOOD_CODE, oldMoodCode,
	...
	public void unsetMoodCode() {
		...
		moodCodeESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.CRITERION__MOOD_CODE, oldMoodCode,

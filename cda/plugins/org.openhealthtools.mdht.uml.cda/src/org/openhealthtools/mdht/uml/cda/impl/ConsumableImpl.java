 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.ConsumableImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.ConsumableImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.ConsumableImpl#getTemplateIds <em>Template Id</em>}</li>
...
public class ConsumableImpl extends ParticipationImpl implements Consumable {
	...
	public NotificationChain basicSetTypeId(InfrastructureRootTypeId newTypeId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.CONSUMABLE__TYPE_ID, oldTypeId, newTypeId);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newTypeId != typeId) {
			...
			if (typeId != null) {
				msgs = ((InternalEObject) typeId).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.CONSUMABLE__TYPE_ID, null, msgs);
			}
			if (newTypeId != null) {
			...
			eNotify(
				new ENotificationImpl(this, Notification.SET, CDAPackage.CONSUMABLE__TYPE_ID, newTypeId, newTypeId));
		}
	}
	...
	public NotificationChain basicSetManufacturedProduct(ManufacturedProduct newManufacturedProduct,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.CONSUMABLE__MANUFACTURED_PRODUCT, oldManufacturedProduct,
		...
		if (newManufacturedProduct != manufacturedProduct) {
			...
			if (manufacturedProduct != null) {
				msgs = ((InternalEObject) manufacturedProduct).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.CONSUMABLE__MANUFACTURED_PRODUCT, null, msgs);
			}

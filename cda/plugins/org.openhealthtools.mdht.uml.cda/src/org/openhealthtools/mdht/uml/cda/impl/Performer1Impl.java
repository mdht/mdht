 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.Performer1Impl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.Performer1Impl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.Performer1Impl#getTemplateIds <em>Template Id</em>}</li>
...
public class Performer1Impl extends ParticipationImpl implements Performer1 {
	...
	public NotificationChain basicSetTypeId(InfrastructureRootTypeId newTypeId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.PERFORMER1__TYPE_ID, oldTypeId, newTypeId);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newTypeId != typeId) {
			...
			if (typeId != null) {
				msgs = ((InternalEObject) typeId).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.PERFORMER1__TYPE_ID, null, msgs);
			}
			if (newTypeId != null) {
			...
			eNotify(
				new ENotificationImpl(this, Notification.SET, CDAPackage.PERFORMER1__TYPE_ID, newTypeId, newTypeId));
		}
	}
	...
	public NotificationChain basicSetFunctionCode(CE newFunctionCode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.PERFORMER1__FUNCTION_CODE, oldFunctionCode, newFunctionCode);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newFunctionCode != functionCode) {
			...
			if (functionCode != null) {
				msgs = ((InternalEObject) functionCode).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.PERFORMER1__FUNCTION_CODE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.PERFORMER1__FUNCTION_CODE, newFunctionCode,
				newFunctionCode));
		}
	}
	...
	public NotificationChain basicSetTime(IVL_TS newTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.PERFORMER1__TIME, oldTime, newTime);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newTime != time) {
			...
			if (time != null) {
				msgs = ((InternalEObject) time).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.PERFORMER1__TIME, null, msgs);
			}
			if (newTime != null) {
	...
	public NotificationChain basicSetAssignedEntity(AssignedEntity newAssignedEntity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.PERFORMER1__ASSIGNED_ENTITY, oldAssignedEntity, newAssignedEntity);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newAssignedEntity != assignedEntity) {
			...
			if (assignedEntity != null) {
				msgs = ((InternalEObject) assignedEntity).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.PERFORMER1__ASSIGNED_ENTITY, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.PERFORMER1__ASSIGNED_ENTITY,
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		nullFlavorESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.PERFORMER1__NULL_FLAVOR, oldNullFlavor,
	...
	public void unsetNullFlavor() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.PERFORMER1__NULL_FLAVOR, oldNullFlavor,
	...
	public void setTypeCode(x_ServiceEventPerformer newTypeCode) {
		...
		typeCodeESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.PERFORMER1__TYPE_CODE, oldTypeCode,
	...
	public void unsetTypeCode() {
		...
		typeCodeESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.PERFORMER1__TYPE_CODE, oldTypeCode,

 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.DeviceImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.DeviceImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.DeviceImpl#getTemplateIds <em>Template Id</em>}</li>
...
public class DeviceImpl extends EntityImpl implements Device {
	...
	public NotificationChain basicSetTypeId(InfrastructureRootTypeId newTypeId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.DEVICE__TYPE_ID, oldTypeId, newTypeId);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newTypeId != typeId) {
			...
			if (typeId != null) {
				msgs = ((InternalEObject) typeId).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.DEVICE__TYPE_ID, null, msgs);
			}
			if (newTypeId != null) {
	...
	public NotificationChain basicSetCode(CE newCode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.DEVICE__CODE, oldCode, newCode);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newCode != code) {
			...
			if (code != null) {
				msgs = ((InternalEObject) code).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.DEVICE__CODE, null, msgs);
			}
			if (newCode != null) {
	...
	public NotificationChain basicSetManufacturerModelName(SC newManufacturerModelName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.DEVICE__MANUFACTURER_MODEL_NAME, oldManufacturerModelName,
	...
	public void setManufacturerModelName(SC newManufacturerModelName) {
		if (newManufacturerModelName != manufacturerModelName) {
			...
			if (manufacturerModelName != null) {
				msgs = ((InternalEObject) manufacturerModelName).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.DEVICE__MANUFACTURER_MODEL_NAME, null, msgs);
			}
			if (newManufacturerModelName != null) {
				msgs = ((InternalEObject) newManufacturerModelName).eInverseAdd(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.DEVICE__MANUFACTURER_MODEL_NAME, null, msgs);
			}
	...
	public NotificationChain basicSetSoftwareName(SC newSoftwareName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.DEVICE__SOFTWARE_NAME, oldSoftwareName, newSoftwareName);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	...
	public void setSoftwareName(SC newSoftwareName) {
		if (newSoftwareName != softwareName) {
			...
			if (softwareName != null) {
				msgs = ((InternalEObject) softwareName).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.DEVICE__SOFTWARE_NAME, null, msgs);
			}
			if (newSoftwareName != null) {
				msgs = ((InternalEObject) newSoftwareName).eInverseAdd(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.DEVICE__SOFTWARE_NAME, null, msgs);
			}

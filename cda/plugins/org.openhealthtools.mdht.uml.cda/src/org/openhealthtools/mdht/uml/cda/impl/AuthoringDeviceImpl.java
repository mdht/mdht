...
public class AuthoringDeviceImpl extends EObjectImpl implements AuthoringDevice {
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.AUTHORING_DEVICE__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setClassCode(EntityClassDevice newClassCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.AUTHORING_DEVICE__CLASS_CODE, oldClassCode, classCode));
	}
	...
	public void setDeterminerCode(EntityDeterminer newDeterminerCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.AUTHORING_DEVICE__DETERMINER_CODE, oldDeterminerCode, determinerCode));
	}

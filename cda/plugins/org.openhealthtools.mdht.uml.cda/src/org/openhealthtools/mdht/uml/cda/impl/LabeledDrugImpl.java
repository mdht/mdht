 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.LabeledDrugImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.LabeledDrugImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.LabeledDrugImpl#getTemplateIds <em>Template Id</em>}</li>
		...
		if (newTypeId != typeId) {
			...
			if (typeId != null) {
				msgs = ((InternalEObject) typeId).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.LABELED_DRUG__TYPE_ID, null, msgs);
			}
			if (newTypeId != null) {
			...
			eNotify(
				new ENotificationImpl(this, Notification.SET, CDAPackage.LABELED_DRUG__TYPE_ID, newTypeId, newTypeId));
		}
	}
		...
		if (newCode != code) {
			...
			if (code != null) {
				msgs = ((InternalEObject) code).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.LABELED_DRUG__CODE, null, msgs);
			}
			if (newCode != null) {
		...
		if (newName != name) {
			...
			if (name != null) {
				msgs = ((InternalEObject) name).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.LABELED_DRUG__NAME, null, msgs);
			}
			if (newName != null) {

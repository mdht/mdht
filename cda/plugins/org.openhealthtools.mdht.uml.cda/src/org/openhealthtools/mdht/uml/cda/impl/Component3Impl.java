...
import org.openhealthtools.mdht.uml.cda.operations.Component3Operations;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.Component3Impl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.Component3Impl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.Component3Impl#getTemplateIds <em>Template Id</em>}</li>
...
public class Component3Impl extends ActRelationshipImpl implements Component3 {
	...
	public NotificationChain basicSetTypeId(InfrastructureRootTypeId newTypeId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT3__TYPE_ID, oldTypeId, newTypeId);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newTypeId != typeId) {
			...
			if (typeId != null) {
				msgs = ((InternalEObject) typeId).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT3__TYPE_ID, null, msgs);
			}
			if (newTypeId != null) {
			...
			eNotify(
				new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT3__TYPE_ID, newTypeId, newTypeId));
		}
	}
	...
	public NotificationChain basicSetSection(Section newSection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT3__SECTION, oldSection, newSection);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	...
	public void setSection(Section newSection) {
		if (newSection != section) {
			NotificationChain msgs = null;
			if (section != null) {
				msgs = ((InternalEObject) section).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT3__SECTION, null, msgs);
			}
			if (newSection != null) {
				msgs = ((InternalEObject) newSection).eInverseAdd(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT3__SECTION, null, msgs);
			}
			...
			eNotify(
				new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT3__SECTION, newSection, newSection));
		}
	}
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		nullFlavorESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT3__NULL_FLAVOR, oldNullFlavor,
	...
	public void unsetNullFlavor() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.COMPONENT3__NULL_FLAVOR, oldNullFlavor,
	...
	public void setTypeCode(ActRelationshipHasComponent newTypeCode) {
		...
		typeCodeESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT3__TYPE_CODE, oldTypeCode,
	...
	public void unsetTypeCode() {
		...
		typeCodeESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.COMPONENT3__TYPE_CODE, oldTypeCode,
	...
	public void setContextConductionInd(Boolean newContextConductionInd) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT3__CONTEXT_CONDUCTION_IND,
	...
	public void unsetContextConductionInd() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.COMPONENT3__CONTEXT_CONDUCTION_IND,

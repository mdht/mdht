...
public class Component4Impl extends ActRelationshipImpl implements Component4 {
	...
	public NotificationChain basicSetTypeId(InfrastructureRootTypeId newTypeId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT4__TYPE_ID, oldTypeId, newTypeId);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newTypeId != typeId) {
			...
			if (typeId != null) {
				msgs = ((InternalEObject) typeId).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT4__TYPE_ID, null, msgs);
			}
			if (newTypeId != null) {
			...
			eNotify(
				new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT4__TYPE_ID, newTypeId, newTypeId));
		}
	}
	...
	public NotificationChain basicSetSequenceNumber(INT newSequenceNumber, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT4__SEQUENCE_NUMBER, oldSequenceNumber, newSequenceNumber);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newSequenceNumber != sequenceNumber) {
			...
			if (sequenceNumber != null) {
				msgs = ((InternalEObject) sequenceNumber).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT4__SEQUENCE_NUMBER, null, msgs);
			}
	...
	public NotificationChain basicSetSeperatableInd(BL newSeperatableInd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT4__SEPERATABLE_IND, oldSeperatableInd, newSeperatableInd);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newSeperatableInd != seperatableInd) {
			...
			if (seperatableInd != null) {
				msgs = ((InternalEObject) seperatableInd).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT4__SEPERATABLE_IND, null, msgs);
			}
	...
	public NotificationChain basicSetAct(Act newAct, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT4__ACT, oldAct, newAct);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newAct != act) {
			...
			if (act != null) {
				msgs = ((InternalEObject) act).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT4__ACT, null, msgs);
			}
			if (newAct != null) {
	...
	public NotificationChain basicSetEncounter(Encounter newEncounter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT4__ENCOUNTER, oldEncounter, newEncounter);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newEncounter != encounter) {
			...
			if (encounter != null) {
				msgs = ((InternalEObject) encounter).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT4__ENCOUNTER, null, msgs);
			}
	...
	public NotificationChain basicSetObservation(Observation newObservation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT4__OBSERVATION, oldObservation, newObservation);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newObservation != observation) {
			...
			if (observation != null) {
				msgs = ((InternalEObject) observation).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT4__OBSERVATION, null, msgs);
			}
	...
	public NotificationChain basicSetObservationMedia(ObservationMedia newObservationMedia, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT4__OBSERVATION_MEDIA, oldObservationMedia,
				newObservationMedia);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newObservationMedia != observationMedia) {
			...
			if (observationMedia != null) {
				msgs = ((InternalEObject) observationMedia).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT4__OBSERVATION_MEDIA, null, msgs);
			}
	...
	public NotificationChain basicSetOrganizer(Organizer newOrganizer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT4__ORGANIZER, oldOrganizer, newOrganizer);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newOrganizer != organizer) {
			...
			if (organizer != null) {
				msgs = ((InternalEObject) organizer).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT4__ORGANIZER, null, msgs);
			}
	...
	public NotificationChain basicSetProcedure(Procedure newProcedure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT4__PROCEDURE, oldProcedure, newProcedure);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newProcedure != procedure) {
			...
			if (procedure != null) {
				msgs = ((InternalEObject) procedure).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT4__PROCEDURE, null, msgs);
			}
	...
	public NotificationChain basicSetRegionOfInterest(RegionOfInterest newRegionOfInterest, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT4__REGION_OF_INTEREST, oldRegionOfInterest,
				newRegionOfInterest);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newRegionOfInterest != regionOfInterest) {
			...
			if (regionOfInterest != null) {
				msgs = ((InternalEObject) regionOfInterest).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT4__REGION_OF_INTEREST, null, msgs);
			}
	...
	public NotificationChain basicSetSubstanceAdministration(SubstanceAdministration newSubstanceAdministration,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT4__SUBSTANCE_ADMINISTRATION, oldSubstanceAdministration,
		...
		if (newSubstanceAdministration != substanceAdministration) {
			...
			if (substanceAdministration != null) {
				msgs = ((InternalEObject) substanceAdministration).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT4__SUBSTANCE_ADMINISTRATION, null, msgs);
			}
	...
	public NotificationChain basicSetSupply(Supply newSupply, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT4__SUPPLY, oldSupply, newSupply);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newSupply != supply) {
			...
			if (supply != null) {
				msgs = ((InternalEObject) supply).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT4__SUPPLY, null, msgs);
			}
			if (newSupply != null) {

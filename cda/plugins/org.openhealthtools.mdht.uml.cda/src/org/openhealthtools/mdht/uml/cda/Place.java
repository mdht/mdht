 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.Place#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.Place#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.Place#getTemplateIds <em>Template Id</em>}</li>
...
public interface Place extends Entity {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.isClassCodeDefined() implies self.classCode=vocab::EntityClassPlace::PLC'"
	 * @generated
	 */

...
public class AuthenticatorOperations extends ParticipationOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "not self.typeCode.oclIsUndefined() implies self.typeCode=vocab::ParticipationType::AUTHEN";

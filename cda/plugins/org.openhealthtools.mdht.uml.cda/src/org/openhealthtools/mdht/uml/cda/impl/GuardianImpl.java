...
import org.openhealthtools.mdht.uml.cda.internal.operations.GuardianOperations;
...
public class GuardianImpl extends EObjectImpl implements Guardian {
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.GUARDIAN__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setClassCode(RoleClass newClassCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.GUARDIAN__CLASS_CODE, oldClassCode, classCode));
	}

...
import org.openhealthtools.mdht.uml.cda.operations.Component5Operations;
...
public class Component5Impl extends ActRelationshipImpl implements Component5 {
	...
	public NotificationChain basicSetTypeId(InfrastructureRootTypeId newTypeId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT5__TYPE_ID, oldTypeId, newTypeId);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newTypeId != typeId) {
			...
			if (typeId != null) {
				msgs = ((InternalEObject) typeId).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT5__TYPE_ID, null, msgs);
			}
			if (newTypeId != null) {
			...
			eNotify(
				new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT5__TYPE_ID, newTypeId, newTypeId));
		}
	}
	...
	public NotificationChain basicSetSection(Section newSection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.COMPONENT5__SECTION, oldSection, newSection);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newSection != section) {
			...
			if (section != null) {
				msgs = ((InternalEObject) section).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT5__SECTION, null, msgs);
			}
			if (newSection != null) {
			...
			eNotify(
				new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT5__SECTION, newSection, newSection));
		}
	}
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		nullFlavorESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT5__NULL_FLAVOR, oldNullFlavor,
	...
	public void unsetNullFlavor() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.COMPONENT5__NULL_FLAVOR, oldNullFlavor,
	...
	public void setTypeCode(ActRelationshipHasComponent newTypeCode) {
		...
		typeCodeESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT5__TYPE_CODE, oldTypeCode,
	...
	public void unsetTypeCode() {
		...
		typeCodeESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.COMPONENT5__TYPE_CODE, oldTypeCode,
	...
	public void setContextConductionInd(Boolean newContextConductionInd) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT5__CONTEXT_CONDUCTION_IND,
	...
	public void unsetContextConductionInd() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.COMPONENT5__CONTEXT_CONDUCTION_IND,

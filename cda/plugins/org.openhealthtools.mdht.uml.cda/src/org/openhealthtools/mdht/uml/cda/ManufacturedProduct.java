...
public interface ManufacturedProduct extends Role {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='not self.classCode.oclIsUndefined() implies self.classCode=vocab::RoleClassManufacturedProduct::MANU'"
	 * @generated
	 */

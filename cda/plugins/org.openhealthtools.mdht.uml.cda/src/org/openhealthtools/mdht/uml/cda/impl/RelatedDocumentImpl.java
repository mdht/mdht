 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.RelatedDocumentImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.RelatedDocumentImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.RelatedDocumentImpl#getTemplateIds <em>Template Id</em>}</li>
		...
		if (newTypeId != typeId) {
			...
			if (typeId != null) {
				msgs = ((InternalEObject) typeId).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.RELATED_DOCUMENT__TYPE_ID, null, msgs);
			}
			if (newTypeId != null) {
	...
	public void setParentDocument(ParentDocument newParentDocument) {
		if (newParentDocument != parentDocument) {
			...
			if (parentDocument != null) {
				msgs = ((InternalEObject) parentDocument).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.RELATED_DOCUMENT__PARENT_DOCUMENT, null, msgs);
			}
			if (newParentDocument != null) {
				msgs = ((InternalEObject) newParentDocument).eInverseAdd(
					this, EOPPOSITE_FEATURE_BASE - CDAPackage.RELATED_DOCUMENT__PARENT_DOCUMENT, null, msgs);
			}

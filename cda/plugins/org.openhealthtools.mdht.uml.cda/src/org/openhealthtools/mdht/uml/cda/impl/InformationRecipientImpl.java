 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.InformationRecipientImpl#getRealmCode <em>Realm Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.InformationRecipientImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.InformationRecipientImpl#getTemplateId <em>Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.InformationRecipientImpl#getIntendedRecipient <em>Intended Recipient</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.InformationRecipientImpl#getNullFlavor <em>Null Flavor</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.InformationRecipientImpl#getTypeCode <em>Type Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InformationRecipientImpl extends EObjectImpl implements InformationRecipient {
	/**
	...
	public EList<CS> getRealmCode() {
		if (realmCode == null) {
			realmCode = new EObjectContainmentEList<CS>(CS.class, this, CDAPackage.INFORMATION_RECIPIENT__REALM_CODE);
		}
		return realmCode;
	}
	...
	public EList<II> getTemplateId() {
		if (templateId == null) {
			templateId = new EObjectContainmentEList<II>(II.class, this, CDAPackage.INFORMATION_RECIPIENT__TEMPLATE_ID);
		}
		return templateId;
	}
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.INFORMATION_RECIPIENT__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setTypeCode(x_InformationRecipient newTypeCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.INFORMATION_RECIPIENT__TYPE_CODE, oldTypeCode, typeCode));
	}

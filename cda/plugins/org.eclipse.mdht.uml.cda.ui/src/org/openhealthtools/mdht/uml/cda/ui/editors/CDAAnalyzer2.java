...
import org.openhealthtools.mdht.uml.cda.ui.views.MetricsView;
...
public class CDAAnalyzer2 extends EditorPart {
	...
	class ViewLabelProvider extends LabelProvider implements ITableLabelProvider {
		public String getColumnText(Object obj, int index) {
			...
			if (obj instanceof org.openhealthtools.mdht.uml.cda.ui.handlers.AnalyzeCDAHandler.CDAAnalaysisInput.CDAMetrics) {
				org.openhealthtools.mdht.uml.cda.ui.handlers.AnalyzeCDAHandler.CDAAnalaysisInput.CDAMetrics cdaMetrics = (org.openhealthtools.mdht.uml.cda.ui.handlers.AnalyzeCDAHandler.CDAAnalaysisInput.CDAMetrics) obj;
		...
		try {
			...
			if (getSite().getPage().getPerspective() != null) {
				...
				metricsView = (MetricsView) getSite().getPage().showView(
					"org.openhealthtools.mdht.uml.cda.ui.views.metricsview");
				if (metricsView != null) {

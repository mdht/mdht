...
public class CDAPackageImpl extends EPackageImpl implements CDAPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(
			...
			!IS_DERIVED, !IS_ORDERED);
		initEAttribute(
			getCDATemplate_TemplateVersion(), ecorePackage.getEString(), "templateVersion", null, 0, 1,
			CDATemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, !IS_ORDERED);
		initEAttribute(
			getCDATemplate_TemplateMultiplicity(), ecorePackage.getEString(), "templateMultiplicity", null, 0, 1,
			CDATemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, !IS_ORDERED);
		...
		initEReference(
			...
			IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(
			getConstraintValidation_EnabledDitaForConstraints(), ecorePackage.getEBoolean(),
		...
		initEAttribute(
			...
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(
			getInline_PublishSeperately(), ecorePackage.getEBoolean(), "publishSeperately", null, 0, 1, Inline.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

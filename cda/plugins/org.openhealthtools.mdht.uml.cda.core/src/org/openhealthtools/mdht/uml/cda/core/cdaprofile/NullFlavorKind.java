 ...
 * <!-- end-user-doc -->
 * @see org.openhealthtools.mdht.uml.cda.core.cdaprofile.CDAPackage#getNullFlavorKind()
 * @model
 * @generated
 */
public enum NullFlavorKind implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final NullFlavorKind[] VALUES_ARRAY =
		new NullFlavorKind[] {
			ASKU,
			MSK,
			NA,
	...
	public static NullFlavorKind get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NullFlavorKind result = VALUES_ARRAY[i];

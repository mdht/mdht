 ...
 * @generated
 */
public class ValueSetConstraintImpl extends ValidationImpl
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == org.openhealthtools.mdht.uml.term.core.profile.ValueSetConstraint.class) {
			switch (derivedFeatureID) {
				case CDAPackage.VALUE_SET_CONSTRAINT__REFERENCE: return TermPackage.VALUE_SET_CONSTRAINT__REFERENCE;
				case CDAPackage.VALUE_SET_CONSTRAINT__IDENTIFIER: return TermPackage.VALUE_SET_CONSTRAINT__IDENTIFIER;
				case CDAPackage.VALUE_SET_CONSTRAINT__NAME: return TermPackage.VALUE_SET_CONSTRAINT__NAME;
				case CDAPackage.VALUE_SET_CONSTRAINT__VERSION: return TermPackage.VALUE_SET_CONSTRAINT__VERSION;
				case CDAPackage.VALUE_SET_CONSTRAINT__BINDING: return TermPackage.VALUE_SET_CONSTRAINT__BINDING;
				case CDAPackage.VALUE_SET_CONSTRAINT__BASE_PROPERTY: return TermPackage.VALUE_SET_CONSTRAINT__BASE_PROPERTY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == org.openhealthtools.mdht.uml.term.core.profile.ValueSetConstraint.class) {
			switch (baseFeatureID) {
				case TermPackage.VALUE_SET_CONSTRAINT__REFERENCE: return CDAPackage.VALUE_SET_CONSTRAINT__REFERENCE;
				case TermPackage.VALUE_SET_CONSTRAINT__IDENTIFIER: return CDAPackage.VALUE_SET_CONSTRAINT__IDENTIFIER;
				case TermPackage.VALUE_SET_CONSTRAINT__NAME: return CDAPackage.VALUE_SET_CONSTRAINT__NAME;
				case TermPackage.VALUE_SET_CONSTRAINT__VERSION: return CDAPackage.VALUE_SET_CONSTRAINT__VERSION;
				case TermPackage.VALUE_SET_CONSTRAINT__BINDING: return CDAPackage.VALUE_SET_CONSTRAINT__BINDING;
				case TermPackage.VALUE_SET_CONSTRAINT__BASE_PROPERTY: return CDAPackage.VALUE_SET_CONSTRAINT__BASE_PROPERTY;
				default: return -1;
			}
		}
		...
		if (reference != null && reference.eIsProxy()) {
			...
			if (reference != oldReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CDAPackage.VALUE_SET_CONSTRAINT__REFERENCE, oldReference, reference));
			}
		}
		return reference;
	}
	...
	public void setReference(ValueSetVersion newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.VALUE_SET_CONSTRAINT__REFERENCE, oldReference, reference));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.VALUE_SET_CONSTRAINT__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.VALUE_SET_CONSTRAINT__VERSION, oldVersion, version));
	}
	...
	public void setBinding(BindingKind newBinding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.VALUE_SET_CONSTRAINT__BINDING, oldBinding, binding));
	}
	...
	public Property getBase_Property() {
		if (base_Property != null && base_Property.eIsProxy()) {
			...
			if (base_Property != oldBase_Property) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CDAPackage.VALUE_SET_CONSTRAINT__BASE_PROPERTY, oldBase_Property, base_Property));
			}
		}
	...
	public void setBase_Property(Property newBase_Property) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.VALUE_SET_CONSTRAINT__BASE_PROPERTY, oldBase_Property, base_Property));
	}

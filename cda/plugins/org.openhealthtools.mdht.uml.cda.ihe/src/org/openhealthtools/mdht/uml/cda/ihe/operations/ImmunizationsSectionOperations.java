 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.ihe.ImmunizationsSection#ImmunizationsSection_templateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Immunizations Section template Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImmunizationsSectionOperations extends org.openhealthtools.mdht.uml.cda.ccd.operations.ImmunizationsSectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String IMMUNIZATIONS_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.hasTemplateId('1.3.6.1.4.1.19376.1.5.3.1.3.23')";
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 IHEPlugin.INSTANCE.getString("ImmunizationsSection_templateId"),

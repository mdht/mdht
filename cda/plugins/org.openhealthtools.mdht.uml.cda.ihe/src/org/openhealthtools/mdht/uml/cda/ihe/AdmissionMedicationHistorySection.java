 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystemName='LOINC' constraints.validation.error='AdmissionMedicationHistorySection_templateId AdmissionMedicationHistorySection_code' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.3.20' code.displayName='MEDICATIONS ON ADMISSION' code.codeSystem='2.16.840.1.113883.6.1' code.code='42346-7'"
 * @generated
 */
public interface AdmissionMedicationHistorySection extends Section {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.hasTemplateId(\'1.3.6.1.4.1.19376.1.5.3.1.3.20\')'"
	 * @generated
	 */
	boolean AdmissionMedicationHistorySection_templateId(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean AdmissionMedicationHistorySection_code(DiagnosticChain diagnostics, Map<Object, Object> context);

 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation templateId.root='1.3.6.1.4.1.19376.1.5.3.1.4.5.3' constraints.validation.error='AllergyIntoleranceConcern_templateId'"
...
public interface AllergyIntoleranceConcern extends ConcernEntry {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.hasTemplateId(\'1.3.6.1.4.1.19376.1.5.3.1.4.5.3\')'"
	 * @generated
	 */
	boolean AllergyIntoleranceConcern_templateId(DiagnosticChain diagnostics, Map<Object, Object> context);

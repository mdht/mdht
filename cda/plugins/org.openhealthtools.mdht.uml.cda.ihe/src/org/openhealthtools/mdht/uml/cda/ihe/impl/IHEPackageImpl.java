		...
		addAnnotation
		  (commentEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "CommentTemplateId CommentClassCode CommentCode CommentMoodCode CommentStatusCode CommentText",
			 "code.codeSystemName", "LOINC",
			 "classCode", "ACT",
			 "code.code", "48767-8",
			 "moodCode", "EVN"
		...
		addAnnotation
		  (scanningDeviceEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "ScanningDeviceTemplateId ScanningDeviceTimeEqualsDocumentEffectiveTime ScanningDeviceHasAssignedAuthorId ScanningDeviceHasAssignedAuthoringDeviceCode"
		   });																
	}

 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystemName='LOINC' constraints.validation.error='HospitalCourseSection_templateId HospitalCourseSection_code' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.3.5' code.displayName='HOSPITAL COURSE' code.codeSystem='2.16.840.1.113883.6.1' code.code='8648-8'"
 * @generated
 */
public interface HospitalCourseSection extends Section {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.hasTemplateId(\'1.3.6.1.4.1.19376.1.5.3.1.3.5\')'"
	 * @generated
	 */
	boolean HospitalCourseSection_templateId(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean HospitalCourseSection_code(DiagnosticChain diagnostics, Map<Object, Object> context);

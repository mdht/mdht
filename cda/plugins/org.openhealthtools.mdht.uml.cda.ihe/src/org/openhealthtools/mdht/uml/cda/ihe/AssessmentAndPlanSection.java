 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystemName='LOINC' constraints.validation.error='AssessmentAndPlanSection_templateId AssessmentAndPlanSection_code' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.1.13.2.5' code.displayName='ASSESSMENT AND PLAN' code.codeSystem='2.16.840.1.113883.6.1' code.code='51847-2'"
 * @generated
 */
public interface AssessmentAndPlanSection extends Section {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.hasTemplateId(\'1.3.6.1.4.1.19376.1.5.3.1.1.13.2.5\')'"
	 * @generated
	 */
	boolean AssessmentAndPlanSection_templateId(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean AssessmentAndPlanSection_code(DiagnosticChain diagnostics, Map<Object, Object> context);

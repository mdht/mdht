 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystemName='LOINC' constraints.validation.error='HospitalAdmissionDiagnosisSection_templateId HospitalAdmissionDiagnosisSection_code' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.3.3' code.displayName='HOSPITAL ADMISSION DX' code.codeSystem='2.16.840.1.113883.6.1' code.code='46241-6'"
 * @generated
 */
public interface HospitalAdmissionDiagnosisSection extends Section {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.hasTemplateId(\'1.3.6.1.4.1.19376.1.5.3.1.3.3\')'"
	 * @generated
	 */
	boolean HospitalAdmissionDiagnosisSection_templateId(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean HospitalAdmissionDiagnosisSection_code(DiagnosticChain diagnostics, Map<Object, Object> context);

...
public abstract class StructuralAttributeValidationTest extends CCDValidationTest {
	...
	final static List<String> STRUCTURAL_ATTRIBUTE_NAMES = Arrays.asList(CLASS_CODE_ATTRIBUTE_NAME, /* DETERMINER_CODE_ATTRIBUTE_NAME, */
	...
	public final void testValidateStructuralAttributes() {
		...
		for (final String structuralAttributeName : STRUCTURAL_ATTRIBUTE_NAMES) {
			final EStructuralFeature structuralFeature = objectToTest.eClass().getEStructuralFeature(
				structuralAttributeName);
			// Did we get it?
			if (structuralFeature != null) {
				// Yes
				objectToTest.eSet(structuralFeature, doGetValidStructuralAttributeValue(structuralAttributeName));
			}
		} // for each suffix

		final boolean isValid = doValidateStructuralAttributeValues(objectToTest, diagnostician, map);
	 ...
	 */
	protected abstract Enumerator doGetValidStructuralAttributeValue(String structuralAttributeName);
	 ...
	 */
	protected abstract boolean doValidateStructuralAttributeValues(EObject eObjectToValidate,

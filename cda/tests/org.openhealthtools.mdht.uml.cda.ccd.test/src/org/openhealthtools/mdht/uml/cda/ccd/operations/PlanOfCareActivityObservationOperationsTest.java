...
public class PlanOfCareActivityObservationOperationsTest extends CCDValidationTest {
	...
	protected EObject getObjectInitToTest() {
		return CCDFactory.eINSTANCE.createPlanOfCareActivityObservation().init();
	}

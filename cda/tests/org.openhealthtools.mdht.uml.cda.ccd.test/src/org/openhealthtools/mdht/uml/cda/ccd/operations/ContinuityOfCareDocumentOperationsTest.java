...
public class ContinuityOfCareDocumentOperationsTest extends CCDValidationTest {
	...
	private static final CDATestCase TEST_CASE_ARRAY[] = {
		...
		new CCDValidationTestCase("documentationOf") {
			...
			protected Object getValueToSet() {
				...
				final DocumentationOf doc = CDAFactory.eINSTANCE
				.createDocumentationOf();
				final ServiceEvent se = CDAFactory.eINSTANCE
				.createServiceEvent();
		...
		new CCDValidationTestCase("author") {
			...
			protected Object getValueToSet() {
				...
				final AssignedAuthor assignedAuthor1 = CDAFactory.eINSTANCE
				...
				final AssignedAuthor assignedAuthor2 = CDAFactory.eINSTANCE
				.createAssignedAuthor();
				final II id = DatatypesFactory.eINSTANCE.createII();
				id.setNullFlavor(NullFlavor.NA);

				assignedAuthor2
				.setRepresentedOrganization(CDAFactory.eINSTANCE
						.createOrganization());
		...
		new CCDValidationTestCase("informationRecipient") {
			...
			protected Object getValueToSet() {
				...
				retValue.add(CDAFactory.eINSTANCE
	...
	public void testValidateContinuityOfCareDocumentNoTemplateIdExtension() {
		...
		ccd.getTemplateIds().add(
				DatatypesFactory.eINSTANCE.createII("root", "extension"));
	...
	public void testValidateContinuityOfCareDocumentOneOrTwoRecordTarget() {
		...
		.createDefaultDiagnostic(ccd);
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentOneOrTwoRecordTarget(ccd,
				diagnostician, map);
		assertTrue(
	...
	public final void testValidateContinuityOfCareLanguageCode() {
		...
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentLanguageCode(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);

		final CS languageCode = DatatypesFactory.eINSTANCE
		.createCS(LANGUAGE_CODE);
	...
	public final void testValidateContinuityOfCareDocumentProblemSection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentProblemSection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentFamilyHistorySection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentFamilyHistorySection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentSocialHistorySection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentSocialHistorySection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentAlertsSection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentAlertsSection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentMedicationSection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentMedicationsSection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentResultsSection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentResultsSection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentProceduresSection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentProceduresSection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentEncountersSection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentEncountersSection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentPlanOfCareSection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentPlanOfCareSection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentImmunizationsSection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentImmunizationsSection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentVitalSignsSection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentVitalSignsSection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentMedicalEquipmentSection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentMedicalEquipmentSection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentFunctionalStatusSection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentFunctionalStatusSection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentAdvanceDirectivesSection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentAdvanceDirectivesSection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentPayersSection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentPayersSection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);
	...
	public final void testValidateContinuityOfCareDocumentPurposeSection() {
		...
		// Can't have zero sections
		boolean isValid = ContinuityOfCareDocumentOperations
		.validateContinuityOfCareDocumentPurposeSection(ccd,
				diagnostician, map);
		assertTrue(diagnostician.getMessage(), !isValid);

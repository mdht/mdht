...
public class MedicationsAdministeredSectionOperationsTest
extends
org.openhealthtools.mdht.uml.cda.ihe.operations.MedicationsAdministeredSectionOperationsTest {

	@SuppressWarnings("hiding")
	protected static final String TEMPLATE_ID = "2.16.840.1.113883.3.88.11.83.115";
		...
		new TemplateIDCCDValidationTest(TEMPLATE_ID) {
			...
			protected boolean validate(final EObject eObjectToTest,
				...
				.validateHITSPMedicationsAdministeredSectionTemplateId(
						(MedicationsAdministeredSection) eObjectToTest,
						diagnostician, map);
			}

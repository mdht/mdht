...
public class HospitalCourseSectionOperationsTest
extends
org.openhealthtools.mdht.uml.cda.ihe.operations.HospitalCourseSectionOperationsTest {

	@SuppressWarnings("hiding")
	protected static final String TEMPLATE_ID = "2.16.840.1.113883.3.88.11.83.121";
		...
		new TemplateIDCCDValidationTest(TEMPLATE_ID) {
			...
			protected boolean validate(final EObject eObjectToTest,
				...
				.validateHITSPHospitalCourseSectionTemplateId(
						(HospitalCourseSection) eObjectToTest,
						diagnostician, map);
			}
	...
	protected EObject getEObjectInitToValidate() {
		return HITSPFactory.eINSTANCE.createHospitalCourseSection().init();
	}

} // HospitalCourseSectionOperationsTest
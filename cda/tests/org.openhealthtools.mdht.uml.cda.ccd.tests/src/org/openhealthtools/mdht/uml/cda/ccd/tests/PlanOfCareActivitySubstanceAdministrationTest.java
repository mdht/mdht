 ...
 * <ul>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.ccd.PlanOfCareActivitySubstanceAdministration#validatePlanOfCareActivitySubstanceAdministrationMoodCodeValue(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Plan Of Care Activity Substance Administration Mood Code Value
 * </em>}</li>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.ccd.PlanOfCareActivitySubstanceAdministration#validatePlanOfCareActivitySubstanceAdministrationTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Plan Of Care Activity Substance Administration Template Id</em>}
 * </li>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.ccd.PlanOfCareActivitySubstanceAdministration#validatePlanOfCareActivitySubstanceAdministrationId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Plan Of Care Activity Substance Administration Id</em>}</li>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.ccd.PlanOfCareActivitySubstanceAdministration#validatePlanOfCareActivitySubstanceAdministrationMoodCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Plan Of Care Activity Substance Administration Mood Code</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class PlanOfCareActivitySubstanceAdministrationTest extends
		CDAValidationTest {
	...
	public void testValidatePlanOfCareActivitySubstanceAdministrationMoodCodeValue() {
		OperationsTestCase<PlanOfCareActivitySubstanceAdministration> validatePlanOfCareActivitySubstanceAdministrationMoodCodeValueTestCase = new OperationsTestCase<PlanOfCareActivitySubstanceAdministration>(
				...
				operationsForOCL
						.getOCLValue("VALIDATE_PLAN_OF_CARE_ACTIVITY_SUBSTANCE_ADMINISTRATION_MOOD_CODE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
				objectFactory) {

			@Override
			protected void updateToFail(
					PlanOfCareActivitySubstanceAdministration target) {
		...
		validatePlanOfCareActivitySubstanceAdministrationMoodCodeValueTestCase
				.doValidationTest();
	}
	...
	public void testValidatePlanOfCareActivitySubstanceAdministrationTemplateId() {
		...
		validatePlanOfCareActivitySubstanceAdministrationTemplateIdTestCase
				.doValidationTest();
	}
	...
	public void testValidatePlanOfCareActivitySubstanceAdministrationId() {
		OperationsTestCase<PlanOfCareActivitySubstanceAdministration> validatePlanOfCareActivitySubstanceAdministrationIdTestCase = new OperationsTestCase<PlanOfCareActivitySubstanceAdministration>(
				...
				operationsForOCL
						.getOCLValue("VALIDATE_PLAN_OF_CARE_ACTIVITY_SUBSTANCE_ADMINISTRATION_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
				objectFactory) {
		...
		validatePlanOfCareActivitySubstanceAdministrationIdTestCase
				.doValidationTest();
	}
	...
	public void testValidatePlanOfCareActivitySubstanceAdministrationMoodCode() {
		OperationsTestCase<PlanOfCareActivitySubstanceAdministration> validatePlanOfCareActivitySubstanceAdministrationMoodCodeTestCase = new OperationsTestCase<PlanOfCareActivitySubstanceAdministration>(
				...
				operationsForOCL
						.getOCLValue("VALIDATE_PLAN_OF_CARE_ACTIVITY_SUBSTANCE_ADMINISTRATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
				objectFactory) {
		...
		validatePlanOfCareActivitySubstanceAdministrationMoodCodeTestCase
				.doValidationTest();
	}
	...
	private static class ObjectFactory implements
			TestObjectFactory<PlanOfCareActivitySubstanceAdministration> {

 ...
 * <em>Get Mu2consol Encounter Activitiess</em>}</li>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.mu2consol.EncountersSection#validateEncountersSectionEntriesOptionalTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Encounters Section Entries Optional Template Id</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class EncountersSectionTest extends CDAValidationTest {
	...
	public void testValidateMu2consolEncountersSectionEncounterActivities() {
		OperationsTestCase<EncountersSection> validateMu2consolEncountersSectionEncounterActivitiesTestCase = new OperationsTestCase<EncountersSection>(
				...
				operationsForOCL
						.getOCLValue("VALIDATE_MU2CONSOL_ENCOUNTERS_SECTION_ENCOUNTER_ACTIVITIES__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
				objectFactory) {
		...
		validateMu2consolEncountersSectionEncounterActivitiesTestCase
				.doValidationTest();
	}
	...
	public void testValidateEncountersSectionEntriesOptionalTemplateId() {
		OperationsTestCase<EncountersSection> validateEncountersSectionEntriesOptionalTemplateIdTestCase = new OperationsTestCase<EncountersSection>(
				...
				operationsForOCL
						.getOCLValue("VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
				objectFactory) {
		...
		validateEncountersSectionEntriesOptionalTemplateIdTestCase
				.doValidationTest();
	}

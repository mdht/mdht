 ...
 * <ul>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.mu2consol.EncounterActivities#validateMu2consolEncounterActivitiesCodeValue(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Mu2consol Encounter Activities Code Value</em>}</li>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.mu2consol.EncounterActivities#validateEncounterActivitiesTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Encounter Activities Template Id</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class EncounterActivitiesTest extends CDAValidationTest {
	...
	public void testValidateEncounterActivitiesTemplateId() {
		OperationsTestCase<EncounterActivities> validateEncounterActivitiesTemplateIdTestCase = new OperationsTestCase<EncounterActivities>(
				...
				operationsForOCL
						.getOCLValue("VALIDATE_ENCOUNTER_ACTIVITIES_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
				objectFactory) {

...
public class Mu2consolExample {
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(Mu2consolPackage.eNS_URI,
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						.createURI("http:///My.mu2consol"));
				GeneralHeaderConstraints root = Mu2consolFactory.eINSTANCE
						.createGeneralHeaderConstraints();

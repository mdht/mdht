...
public class EMSCurrentMedicationSectionTest extends CDAValidationTest {
	...
	*/
	@Test
	public void testValidateEMSCurrentMedicationSectionPatientOnAnticoagulants() {
		OperationsTestCase<EMSCurrentMedicationSection> validateEMSCurrentMedicationSectionPatientOnAnticoagulantsTestCase = new OperationsTestCase<EMSCurrentMedicationSection>(
			"validateEMSCurrentMedicationSectionPatientOnAnticoagulants",
			operationsForOCL.getOCLValue("VALIDATE_EMS_CURRENT_MEDICATION_SECTION_PATIENT_ON_ANTICOAGULANTS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
		...
		validateEMSCurrentMedicationSectionPatientOnAnticoagulantsTestCase.doValidationTest();
	}

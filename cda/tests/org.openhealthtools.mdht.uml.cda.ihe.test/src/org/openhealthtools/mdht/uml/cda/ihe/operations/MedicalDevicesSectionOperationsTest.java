...
import org.openhealthtools.mdht.uml.cda.ccd.operations.MedicalEquipmentSectionOperationsTest;
...
public class MedicalDevicesSectionOperationsTest extends
		...
		protected boolean validate(final EObject eObjectToTest,
			...
			return MedicalDevicesSectionOperations
					.validateMedicalDevicesSectionTemplateId(
							(MedicalDevicesSection) eObjectToTest,
							diagnostician, map);
		}
	...
	protected EObject getEObjectInitToValidate() {
		return IHEFactory.eINSTANCE.createMedicalDevicesSection().init();
	}

} // MedicalDevicesSectionOperationsTest
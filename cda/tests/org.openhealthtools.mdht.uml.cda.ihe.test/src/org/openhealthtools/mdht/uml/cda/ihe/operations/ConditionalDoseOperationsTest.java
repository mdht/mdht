...
//	protected static final String TEMPLATE_ID = "1.3.6.1.4.1.19376.1.5.3.1.4.10";
//
//	/**
...
//	}
	...
	public void testValidateConditionalDoseConditionalDosingSubstanceAdministration() {
		...
		OperationsTestCase<ConditionalDose> testCase = new OperationsTestCase<ConditionalDose>(
				"ValidateConditionalDoseConditionalDosingSubstanceAdministration", operationsForOCL.getOCLValue("VALIDATE_CONDITIONAL_DOSE_CONDITIONAL_DOSING_SUBSTANCE_ADMINISTRATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),objectFactory) {
	...
	public void testValidateConditionalDoseTemplateId() {
		...
		OperationsTestCase<ConditionalDose> testCase = new OperationsTestCase<ConditionalDose>(
				"ValidateConditionalDoseTemplateId", operationsForOCL.getOCLValue("VALIDATE_CONDITIONAL_DOSE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),objectFactory) {

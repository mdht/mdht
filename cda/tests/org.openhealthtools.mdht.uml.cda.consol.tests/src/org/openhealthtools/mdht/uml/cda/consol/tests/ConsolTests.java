...
@Suite.SuiteClasses({
		...
		HealthStatusObservationTest.class, CommentTest.class, MedicationSeriesNumberObservationTest.class,
		MedicationStatusObservationTest.class, InternalReferenceTest.class, MedicationTypeTest.class,
		...
		AdvanceDirectiveObservationTest.class, AllergiesSectionTest.class, AllergiesSectionEntriesOptionalTest.class,

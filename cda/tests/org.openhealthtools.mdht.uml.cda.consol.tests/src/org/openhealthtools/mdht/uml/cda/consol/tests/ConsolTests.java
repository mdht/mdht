...
@Suite.SuiteClasses({
		...
		MedicationActivityTest.class, NonMedicinalSupplyActivityTest.class, ProductInstanceTest.class,
		InstructionsTest.class, IndicationTest.class, MedicationDispenseTest.class, DrugVehicleTest.class,
		...
		ProceduresSectionTest.class, ProceduresSectionEntriesOptionalTest.class, ProcedureActivityActTest.class,
		ProcedureActivityProcedureTest.class, ProcedureAcivityObservationTest.class,
		...
		SocialHistoryObservationTest.class, PregnancyObservationTest.class, ResultsSectionTest.class,
		...
		ImmunizationActivityTest.class, ImmunizationRefusalReasonTest.class, InsuranceProviderTest.class,
		PayerEntryTest.class, CoveredPartyTest.class, PolicySubscriberTest.class, ProcedureTest.class,

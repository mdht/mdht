...
@Suite.SuiteClasses({
		...
		VitalSignObservationTest.class, ImmunizationsSectionTest.class, VitalSignsSectionTest.class,
		...
		SurgicalDrainsSectionTest.class, UnstructuredDocumentTest.class, MedicationInformationTest.class,
		...
		MedicationInformationManufacturedMaterialTest.class, HospitalDischargeMedicationsSectionTest.class,
		EncounterPerformerTest.class, EncounterPerformerAssignedEntityTest.class, AnesthesiaSectionTest.class,

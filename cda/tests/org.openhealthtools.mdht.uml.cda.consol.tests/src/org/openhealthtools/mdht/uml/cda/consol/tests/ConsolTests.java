...
@Suite.SuiteClasses({
		...
		IndicationTest.class, MedicationActivityTest.class, MedicationSupplyOrderTest.class, InstructionsTest.class,
		MedicationDispenseTest.class, DrugVehicleTest.class, ProductInstanceTest.class,
		...
		ProceduresSectionTest.class, ProceduresSectionEntriesOptionalTest.class, ProcedureAcivityObservationTest.class,
		ProcedureActivityActTest.class, VitalSignsSectionEntriesOptionalTest.class, VitalSignsOrganizerTest.class,
		VitalSignObservationTest.class, FamilyHistorySectionTest.class, FamilyHistoryOrganizerTest.class,
		...
		DiagnosticResultsSectionTest.class, HistoryOfPastIllnessSectionTest.class, ChiefComplaintSectionTest.class,
		ReasonForReferralSectionTest.class, HistoryOfPresentIllnessTest.class,
		...
		ImmunizationMedicationInformationTest.class, ProcedureTest.class, ProcedureSpecimenTest.class,
		ProcedurePerformerTest.class, ProcedureEncounterTest.class, MedicationInformationManufacturedMaterialTest.class })

...
//
//			@Override
//			public DiagnosticResultsSectionBuilder getDiagnosticResultsSection() {
//
...
//
//			@Override
//			public EncoutersSectionBuilder getEncoutersSection() {
...
//				return new BuilderUtil.BuildII("2.16.840.1.113883.3.72", "HITSP_C32v2.5_Rev6_16Sections_Entries_MinimalErrors", "NIST Healthcare Project").construct();
//			}
//
//			@Override
...
//				return new BuilderUtil.BuildST("Example Healthcare Record").construct();
//			}
//
//			@Override
...
//				return new HITSPC32PatientRoleBuilder().construct();
//			}
//
//			@Override
//			public Patient buildPatient() {
//				return new HITSPC32PatientBuilder(new String[] { "FirstName", "MiddleName" }, "PatientLastName", "", "19840704", "M").construct();
//			}
//
////			@Override
////			public List<Author> buildAuthors() {
////				return new HITSPC32BuildAuthor().construct();
////			}
//
...
//
//			@Override
//			public PurposeSectionBuilder getPurposeSectionDirector() {
...
//
//			@Override
//			public PayersSectionBuilder getPayersSectionDirector() {
//
////				return new PayersSectionBuilder() {
////
////					@Override
////					public ST buildSectionTitle() {
////						return new BuilderUtil.BuildST("Insurance Providers").construct();
////					}
////
////					@Override
////					public List<Entry> buildEntrys() {
////		
////								ArrayList<Entry> entries = new ArrayList<Entry>();
////								//
////								// Entry entry =
////								// CDAFactory.eINSTANCE.createEntry();
////								//
////								//
////								// entry.setTypeCode(x_ActRelationshipEntry.DRIV);
////								//
////								// CoverageEntry coverageEntry =
////								// IHEFactory.eINSTANCE.createCoverageEntry().init();
////								//
...
////								// CDAFactory.eINSTANCE.createEntryRelationship();
////								//
////								// entryRelationship.setTypeCode(x_ActRelationshipEntryRelationship.COMP);
////								//
////								// InsuranceProvider insuranceProvider =
////								// HITSPFactory.eINSTANCE.createInsuranceProvider().init();
////								//
////								// insuranceProvider.getIds().add(DatatypesFactory.eINSTANCE.createII("3e676a50-7aac-11db-9fe1-0800200c9a66",
...
////								//
////								// assignedEntity.setCode(DatatypesFactory.eINSTANCE.createCE("PAYOR",
////								// "2.16.840.1.113883.5.110",
////								// "HL7 RoleClassRelationship", ""));
////								//
...
////								//
////								// SDTCPatient patient =
////								// CDAFactory.eINSTANCE.createSDTCPatient();
////								//
...
////								// CDAFactory.eINSTANCE.createParticipant2();
////								//
...
////								//
////								// participantRole.getIds().add(DatatypesFactory.eINSTANCE.createII("PayorAuthorityID",
////								// "SubscriberIDAsKnownToPayor"));
////								//
...
////								//
////								// participantRole.getIds().add(DatatypesFactory.eINSTANCE.createII("14d4a520-7aae-11db-9fe1-0800200c9a66ID",
////								// "1138345"));
////								//
////								// participantRole.setCode(DatatypesFactory.eINSTANCE.createCE("SELF",
////								// "2.16.840.1.113883.5.111", "", "SELF"));
////								//
...
////								//
////								// // Add Authorization
////								// EntryRelationship authorizationRelationship =
////								// CDAFactory.eINSTANCE.createEntryRelationship();
////								//
////								// AuthorizationActivity authorizationActivity =
////								// CCDFactory.eINSTANCE.createAuthorizationActivity().init();
////								//
...
//
//			@Override
//			public AllergiesReactionSectionBuilder getAllergiesReactionSection() {
//
//				return new AllergiesReactionSectionBuilder() {
//
//					@Override
//					public ST buildSectionTitle() {
//						return new BuilderUtil.BuildST("Allergies and Adverse Reactions").construct();
//					}
//
...
//
//			@Override
//			public SurgeriesSectionBuilder getSurgeriesSection() {
//				return new SurgeriesSectionBuilder() {
//
//					@Override
//					public ST buildSectionTitle() {
//						return new BuilderUtil.BuildST("Surgeries/Procedures").construct();
//					}
//
//					@Override
...
//
//			@Override
//			public MedicationsSectionBuilder getMedicationsSectionDirector() {
...
//
//								// comment.setCode(DatatypesFactory.eINSTANCE.createCD("48767-8",
//								// "LOINC", "2.16.840.1.113883.6.1",
//								// "comment"));
//
//								comment.getCode().setOriginalText(
//										DatatypesFactory.eINSTANCE.createED("ccccccccccccccccccccccccccccccccccccccc Reference goes on text element rather than here."));
//
...
//
//			@Override
//			public AdvanceDirectivesSectionBuilder getAdvanceDirectivesSectionDirector() {
//
...
//
//			@Override
//			public ImmunizationsSectionBuilder getImmunizationsSectionDirector() {
...
//
//			@Override
//			public FunctionalStatusSectionBuilder getFunctionalStatusSectionDirector() {
...
//
//			@Override
//			public FamilyHistorySectionBuilder getFamilyHistorySectionDirector() {
...
//					@Override
//					public ST buildSectionTitle() {
//						return new BuilderUtil.BuildST("Medical Equipment").construct();
//					}
//
//					@Override
...
//
//			@Override
//			public SocialHistorySectionBuilder getSocialHistorySectionDirector() {
//
...
//								// HITSPFactory.eINSTANCE.createSocialHistoryObservation().init();
//								//
//								// //
...
//								//
//								// observation.setCode(BuilderUtil.buildSNOMEDCT("230056004",
//								// "Cigarette smoking"));
//								//
//								// observation.setStatusCode(DatatypesFactory.eINSTANCE.createCS("completed"));
//								//
//								// observation.setEffectiveTime(BuilderUtil.buildIVL_TS("1947",
//								// "1972"));
//								//
//								// ST st =
//								// DatatypesFactory.eINSTANCE.createST("1 pack per day");
//								//
...
//
////			@Override
////			public PlanOfCareSectionBuilder getPlanOfCareSectionDirector() {
...
//////			//
//////			CDAUtil.save(clinicalDocument, new FileOutputStream("c32.xml"));

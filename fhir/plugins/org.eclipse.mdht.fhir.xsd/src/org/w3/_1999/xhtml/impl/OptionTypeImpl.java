 ...
 * </p>
 * <ul>
 *   <li>{@link org.w3._1999.xhtml.impl.OptionTypeImpl#getMixed <em>Mixed</em>}</li>
...
public class OptionTypeImpl extends MinimalEObjectImpl.Container implements OptionType {
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, XhtmlPackage.OPTION_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XhtmlPackage.OPTION_TYPE__MIXED:

 ...
 *   <li>{@link org.w3._1999.xhtml.impl.LabelTypeImpl#getDir <em>Dir</em>}</li>
 ...
 * @generated
 */
public class LabelTypeImpl extends InlineImpl implements LabelType {
	/**
	...
	protected EClass eStaticClass() {
		return XhtmlPackage.eINSTANCE.getLabelType();
	}
	...
	public void setAccesskey(String newAccesskey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__ACCESSKEY, oldAccesskey, accesskey));
	}
	...
	public void setClass(List<String> newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.LABEL_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setFor(String newFor) {
		...
		for_ = newFor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__FOR, oldFor, for_));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__ID, oldId, id));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(String newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__LANG1, oldLang1, lang1));
	}
	...
	public void setOnblur(String newOnblur) {
		...
		onblur = newOnblur;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__ONBLUR, oldOnblur, onblur));
	}
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnfocus(String newOnfocus) {
		...
		onfocus = newOnfocus;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__ONFOCUS, oldOnfocus, onfocus));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.LABEL_TYPE__TITLE, oldTitle, title));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XhtmlPackage.LABEL_TYPE__ACCESSKEY:
				return getAccesskey();
			case XhtmlPackage.LABEL_TYPE__CLASS:
				return getClass_();
			case XhtmlPackage.LABEL_TYPE__DIR:
				return getDir();
			case XhtmlPackage.LABEL_TYPE__FOR:
				return getFor();
			case XhtmlPackage.LABEL_TYPE__ID:
				return getId();
			case XhtmlPackage.LABEL_TYPE__LANG:
				return getLang();
			case XhtmlPackage.LABEL_TYPE__LANG1:
				return getLang1();
			case XhtmlPackage.LABEL_TYPE__ONBLUR:
				return getOnblur();
			case XhtmlPackage.LABEL_TYPE__ONCLICK:
				return getOnclick();
			case XhtmlPackage.LABEL_TYPE__ONDBLCLICK:
				return getOndblclick();
			case XhtmlPackage.LABEL_TYPE__ONFOCUS:
				return getOnfocus();
			case XhtmlPackage.LABEL_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case XhtmlPackage.LABEL_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case XhtmlPackage.LABEL_TYPE__ONKEYUP:
				return getOnkeyup();
			case XhtmlPackage.LABEL_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case XhtmlPackage.LABEL_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case XhtmlPackage.LABEL_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case XhtmlPackage.LABEL_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case XhtmlPackage.LABEL_TYPE__ONMOUSEUP:
				return getOnmouseup();
			case XhtmlPackage.LABEL_TYPE__STYLE:
				return getStyle();
			case XhtmlPackage.LABEL_TYPE__TITLE:
				return getTitle();
		}

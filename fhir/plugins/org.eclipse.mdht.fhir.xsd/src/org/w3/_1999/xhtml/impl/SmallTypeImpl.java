 ...
 *   <li>{@link org.w3._1999.xhtml.impl.SmallTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.SmallTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.SmallTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.SmallTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.SmallTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.SmallTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.SmallTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.SmallTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.SmallTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.SmallTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
...
public class SmallTypeImpl extends InlineImpl implements SmallType {
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.SMALL_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.SMALL_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.SMALL_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.SMALL_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.SMALL_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.SMALL_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.SMALL_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.SMALL_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.SMALL_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.SMALL_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case XhtmlPackage.SMALL_TYPE__LANG1:
				return getLang1();
			case XhtmlPackage.SMALL_TYPE__ONCLICK:
				return getOnclick();
			case XhtmlPackage.SMALL_TYPE__ONDBLCLICK:
				return getOndblclick();
			case XhtmlPackage.SMALL_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case XhtmlPackage.SMALL_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case XhtmlPackage.SMALL_TYPE__ONKEYUP:
				return getOnkeyup();
			case XhtmlPackage.SMALL_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case XhtmlPackage.SMALL_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case XhtmlPackage.SMALL_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case XhtmlPackage.SMALL_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case XhtmlPackage.SMALL_TYPE__ONMOUSEUP:
				return getOnmouseup();

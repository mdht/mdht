 ...
 *   <li>{@link org.w3._1999.xhtml.impl.BlockquoteTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BlockquoteTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BlockquoteTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BlockquoteTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BlockquoteTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BlockquoteTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BlockquoteTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BlockquoteTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BlockquoteTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BlockquoteTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
...
public class BlockquoteTypeImpl extends BlockImpl implements BlockquoteType {
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BLOCKQUOTE_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BLOCKQUOTE_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BLOCKQUOTE_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BLOCKQUOTE_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BLOCKQUOTE_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BLOCKQUOTE_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BLOCKQUOTE_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BLOCKQUOTE_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BLOCKQUOTE_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BLOCKQUOTE_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case XhtmlPackage.BLOCKQUOTE_TYPE__LANG1:
				return getLang1();
			case XhtmlPackage.BLOCKQUOTE_TYPE__ONCLICK:
				return getOnclick();
			case XhtmlPackage.BLOCKQUOTE_TYPE__ONDBLCLICK:
				return getOndblclick();
			case XhtmlPackage.BLOCKQUOTE_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case XhtmlPackage.BLOCKQUOTE_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case XhtmlPackage.BLOCKQUOTE_TYPE__ONKEYUP:
				return getOnkeyup();
			case XhtmlPackage.BLOCKQUOTE_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case XhtmlPackage.BLOCKQUOTE_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case XhtmlPackage.BLOCKQUOTE_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case XhtmlPackage.BLOCKQUOTE_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case XhtmlPackage.BLOCKQUOTE_TYPE__ONMOUSEUP:
				return getOnmouseup();

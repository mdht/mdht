 ...
 * </p>
 * <ul>
 *   <li>{@link org.w3._1999.xhtml.impl.TitleTypeImpl#getMixed <em>Mixed</em>}</li>
...
public class TitleTypeImpl extends MinimalEObjectImpl.Container implements TitleType {
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, XhtmlPackage.TITLE_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XhtmlPackage.TITLE_TYPE__MIXED:

 ...
 * </p>
 * <ul>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getOnload <em>Onload</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getOnunload <em>Onunload</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3._1999.xhtml.impl.BodyTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BodyTypeImpl extends BlockImpl implements BodyType {
	...
	/**
	 * The default value of the '{@link #getOnload() <em>Onload</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getOnload()
	 * @generated
	 * @ordered
	 */
	protected static final String ONLOAD_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getOnload() <em>Onload</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getOnload()
	 * @generated
	 * @ordered
	 */
	protected String onload = ONLOAD_EDEFAULT;
	...
	/**
	 * The default value of the '{@link #getOnunload() <em>Onunload</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getOnunload()
	 * @generated
	 * @ordered
	 */
	protected static final String ONUNLOAD_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getOnunload() <em>Onunload</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getOnunload()
	 * @generated
	 * @ordered
	 */
	protected String onunload = ONUNLOAD_EDEFAULT;
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.BODY_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(String newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__LANG1, oldLang1, lang1));
	}
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	 ...
	 * @generated
	 */
	public void setOnload(String newOnload) {
		String oldOnload = onload;
		onload = newOnload;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__ONLOAD, oldOnload, onload));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	 ...
	 * @generated
	 */
	public void setOnunload(String newOnunload) {
		String oldOnunload = onunload;
		onunload = newOnunload;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.BODY_TYPE__ONUNLOAD, oldOnunload, onunload));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XhtmlPackage.BODY_TYPE__CLASS:
				return getClass_();
			case XhtmlPackage.BODY_TYPE__DIR:
				return getDir();
			case XhtmlPackage.BODY_TYPE__ID:
				return getId();
			case XhtmlPackage.BODY_TYPE__LANG:
				return getLang();
			case XhtmlPackage.BODY_TYPE__LANG1:
				return getLang1();
			case XhtmlPackage.BODY_TYPE__ONCLICK:
				return getOnclick();
			case XhtmlPackage.BODY_TYPE__ONDBLCLICK:
				return getOndblclick();
			case XhtmlPackage.BODY_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case XhtmlPackage.BODY_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case XhtmlPackage.BODY_TYPE__ONKEYUP:
				return getOnkeyup();
			case XhtmlPackage.BODY_TYPE__ONLOAD:
				return getOnload();
			case XhtmlPackage.BODY_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case XhtmlPackage.BODY_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case XhtmlPackage.BODY_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case XhtmlPackage.BODY_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case XhtmlPackage.BODY_TYPE__ONMOUSEUP:
				return getOnmouseup();
			case XhtmlPackage.BODY_TYPE__ONUNLOAD:
				return getOnunload();
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case XhtmlPackage.BODY_TYPE__ONLOAD:
				return ONLOAD_EDEFAULT == null ? onload != null : !ONLOAD_EDEFAULT.equals(onload);
			case XhtmlPackage.BODY_TYPE__ONMOUSEDOWN:
			...
			case XhtmlPackage.BODY_TYPE__ONUNLOAD:
				return ONUNLOAD_EDEFAULT == null ? onunload != null : !ONUNLOAD_EDEFAULT.equals(onunload);
			case XhtmlPackage.BODY_TYPE__STYLE:

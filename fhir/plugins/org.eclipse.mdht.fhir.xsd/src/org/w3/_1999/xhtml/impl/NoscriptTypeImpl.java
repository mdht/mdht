 ...
 *   <li>{@link org.w3._1999.xhtml.impl.NoscriptTypeImpl#getDir <em>Dir</em>}</li>
 ...
 * @generated
 */
public class NoscriptTypeImpl extends BlockImpl implements NoscriptType {
	/**
	...
	protected EClass eStaticClass() {
		return XhtmlPackage.eINSTANCE.getNoscriptType();
	}
	...
	public void setClass(List<String> newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.NOSCRIPT_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__ID, oldId, id));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(String newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__LANG1, oldLang1, lang1));
	}
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.NOSCRIPT_TYPE__TITLE, oldTitle, title));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XhtmlPackage.NOSCRIPT_TYPE__CLASS:
				return getClass_();
			case XhtmlPackage.NOSCRIPT_TYPE__DIR:
				return getDir();
			case XhtmlPackage.NOSCRIPT_TYPE__ID:
				return getId();
			case XhtmlPackage.NOSCRIPT_TYPE__LANG:
				return getLang();
			case XhtmlPackage.NOSCRIPT_TYPE__LANG1:
				return getLang1();
			case XhtmlPackage.NOSCRIPT_TYPE__ONCLICK:
				return getOnclick();
			case XhtmlPackage.NOSCRIPT_TYPE__ONDBLCLICK:
				return getOndblclick();
			case XhtmlPackage.NOSCRIPT_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case XhtmlPackage.NOSCRIPT_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case XhtmlPackage.NOSCRIPT_TYPE__ONKEYUP:
				return getOnkeyup();
			case XhtmlPackage.NOSCRIPT_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case XhtmlPackage.NOSCRIPT_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case XhtmlPackage.NOSCRIPT_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case XhtmlPackage.NOSCRIPT_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case XhtmlPackage.NOSCRIPT_TYPE__ONMOUSEUP:
				return getOnmouseup();
			case XhtmlPackage.NOSCRIPT_TYPE__STYLE:
				return getStyle();
			case XhtmlPackage.NOSCRIPT_TYPE__TITLE:
				return getTitle();
		}

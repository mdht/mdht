...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Audit Event Object Role List</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getAuditEventObjectRoleList()
 * @model extendedMetaData="name='AuditEventObjectRole-list'"
 * @generated
 */
public enum AuditEventObjectRoleList implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final int _18_VALUE = 17;
	 ...
	 * @ordered
	 */
	public static final int _19_VALUE = 18;
	 ...
	 * @ordered
	 */
	public static final int _20_VALUE = 19;
	 ...
	 * @ordered
	 */
	public static final int _21_VALUE = 20;
	 ...
	 * @ordered
	 */
	public static final int _22_VALUE = 21;
	 ...
	 * @ordered
	 */
	public static final int _23_VALUE = 22;
	 ...
	 * @ordered
	 */
	public static final int _24_VALUE = 23;

	/**
	 * An array of all the '<em><b>Audit Event Object Role List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final AuditEventObjectRoleList[] VALUES_ARRAY =
		new AuditEventObjectRoleList[] {
			_1,
			_2,
			_3,
			_4,
	...
	/**
	 * A public read-only list of all the '<em><b>Audit Event Object Role List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<AuditEventObjectRoleList> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Audit Event Object Role List</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static AuditEventObjectRoleList get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			AuditEventObjectRoleList result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Audit Event Object Role List</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static AuditEventObjectRoleList getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			AuditEventObjectRoleList result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Audit Event Object Role List</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static AuditEventObjectRoleList get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private AuditEventObjectRoleList(int value, String name, String literal) {
		this.value = value;
		this.name = name;

...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Data Element Specificity List</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getDataElementSpecificityList()
 * @model extendedMetaData="name='DataElementSpecificity-list'"
 * @generated
 */
public enum DataElementSpecificityList implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Data Element Specificity List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final DataElementSpecificityList[] VALUES_ARRAY =
		new DataElementSpecificityList[] {
			COMPARABLE,
			FULLY_SPECIFIED,
			EQUIVALENT,
			CONVERTABLE,
	...
	/**
	 * A public read-only list of all the '<em><b>Data Element Specificity List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<DataElementSpecificityList> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Data Element Specificity List</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static DataElementSpecificityList get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DataElementSpecificityList result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Data Element Specificity List</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static DataElementSpecificityList getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DataElementSpecificityList result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Data Element Specificity List</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static DataElementSpecificityList get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private DataElementSpecificityList(int value, String name, String literal) {
		this.value = value;
		this.name = name;

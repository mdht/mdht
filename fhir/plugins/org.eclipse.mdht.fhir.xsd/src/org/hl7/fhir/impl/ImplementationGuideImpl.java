 ...
 *   <li>{@link org.hl7.fhir.impl.ImplementationGuideImpl#getCode <em>Code</em>}</li>
 ...
 *   <li>{@link org.hl7.fhir.impl.ImplementationGuideImpl#getDefault <em>Default</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImplementationGuideImpl extends DomainResourceImpl implements ImplementationGuide {
	 ...
	 * @ordered
	 */
	protected EList<ImplementationGuideDefault> default_;
	...
	public EList<Coding> getCode() {
		if (code == null) {
			code = new EObjectContainmentEList<Coding>(Coding.class, this, FhirPackage.IMPLEMENTATION_GUIDE__CODE);
		}
		return code;
	}
	...
	public EList<ImplementationGuidePage> getPage() {
		if (page == null) {
			page = new EObjectContainmentEList<ImplementationGuidePage>(ImplementationGuidePage.class, this, FhirPackage.IMPLEMENTATION_GUIDE__PAGE);
		}
		return page;
	}
	 ...
	 * @generated
	 */
	public EList<ImplementationGuideDefault> getDefault() {
		if (default_ == null) {
			default_ = new EObjectContainmentEList<ImplementationGuideDefault>(ImplementationGuideDefault.class, this, FhirPackage.IMPLEMENTATION_GUIDE__DEFAULT);
		}
		return default_;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.IMPLEMENTATION_GUIDE__CODE:
			...
			case FhirPackage.IMPLEMENTATION_GUIDE__DEFAULT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.IMPLEMENTATION_GUIDE__DEFAULT:
				getDefault().clear();
				getDefault().addAll((Collection<? extends ImplementationGuideDefault>)newValue);
				return;
		}

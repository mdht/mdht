...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Device Use Request Status List</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getDeviceUseRequestStatusList()
 * @model extendedMetaData="name='DeviceUseRequestStatus-list'"
 * @generated
 */
public enum DeviceUseRequestStatusList implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Device Use Request Status List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final DeviceUseRequestStatusList[] VALUES_ARRAY =
		new DeviceUseRequestStatusList[] {
			PROPOSED,
			PLANNED,
			REQUESTED,
			RECEIVED,
	...
	/**
	 * A public read-only list of all the '<em><b>Device Use Request Status List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<DeviceUseRequestStatusList> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Device Use Request Status List</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static DeviceUseRequestStatusList get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DeviceUseRequestStatusList result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Device Use Request Status List</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static DeviceUseRequestStatusList getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DeviceUseRequestStatusList result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Device Use Request Status List</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static DeviceUseRequestStatusList get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private DeviceUseRequestStatusList(int value, String name, String literal) {
		this.value = value;
		this.name = name;

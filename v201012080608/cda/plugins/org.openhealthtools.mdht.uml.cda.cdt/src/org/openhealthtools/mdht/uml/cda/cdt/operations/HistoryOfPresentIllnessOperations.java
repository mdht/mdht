 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.cdt.HistoryOfPresentIllness#validateHistoryOfPresentIllnessTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate History Of Present Illness Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.cdt.HistoryOfPresentIllness#validateHistoryOfPresentIllnessCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate History Of Present Illness Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HistoryOfPresentIllnessOperations extends SectionOperations {
	...
	public static  boolean validateHistoryOfPresentIllnessTemplateId(HistoryOfPresentIllness historyOfPresentIllness, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_HISTORY_OF_PRESENT_ILLNESS_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(CDTPackage.Literals.HISTORY_OF_PRESENT_ILLNESS);
			try {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 CDTValidator.HISTORY_OF_PRESENT_ILLNESS__HISTORY_OF_PRESENT_ILLNESS_TEMPLATE_ID,
						 CDTPlugin.INSTANCE.getString("HistoryOfPresentIllnessTemplateId"),
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 CDTValidator.DIAGNOSTIC_SOURCE,
						 CDTValidator.HISTORY_OF_PRESENT_ILLNESS__HISTORY_OF_PRESENT_ILLNESS_CODE,
						 CDTPlugin.INSTANCE.getString("HistoryOfPresentIllnessCode"),
						 new Object [] { historyOfPresentIllness }));
			}
			return false;
		}

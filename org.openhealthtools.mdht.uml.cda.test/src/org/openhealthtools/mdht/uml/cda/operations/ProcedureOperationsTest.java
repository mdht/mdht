	...
	private static final CDATestCase TEST_CASE_ARRAY[] = {
			...
			new CDAAddTestCase("Act") {
				...
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					ClinicalStatementOperations.addAct((Procedure) objectToTest, (Act) eObjectToAdd);
				}
			...
			new CDAAddTestCase("Encounter") {
				...
				@Override
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					ClinicalStatementOperations.addEncounter((Procedure) objectToTest, (Encounter) eObjectToAdd);
				}
			...
			new CDAAddTestCase("Observation") {
				...
				@Override
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					ClinicalStatementOperations.addObservation((Procedure) objectToTest, (Observation) eObjectToAdd);
			...
			new CDAAddTestCase("ObservationMedia") {
				...
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					ClinicalStatementOperations.addObservationMedia(
						(Procedure) objectToTest, (ObservationMedia) eObjectToAdd);
			...
			new CDAAddTestCase("Organizer") {
				...
				@Override
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					ClinicalStatementOperations.addOrganizer((Procedure) objectToTest, (Organizer) eObjectToAdd);
				}
			...
			new CDAAddTestCase("Procedure") {
				...
				@Override
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					ClinicalStatementOperations.addProcedure((Procedure) objectToTest, (Procedure) eObjectToAdd);
				}
			...
			new CDAAddTestCase("RegionOfInterest") {
				...
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					ClinicalStatementOperations.addRegionOfInterest(
						(Procedure) objectToTest, (RegionOfInterest) eObjectToAdd);
				}
			...
			new CDAAddTestCase("SubstanceAdministration") {
				...
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					ClinicalStatementOperations.addSubstanceAdministration(
						(Procedure) objectToTest, (SubstanceAdministration) eObjectToAdd);
				}
			...
			new CDAAddTestCase("Supply") {
				...
				@Override
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					ClinicalStatementOperations.addSupply((Procedure) objectToTest, (Supply) eObjectToAdd);
				}
			...
			new CDAGetTestCase("Act") {
				...
				protected Object doGet(final EObject objectToTest) {
					return ClinicalStatementOperations.getActs((Procedure) objectToTest);
				}
			},
			...
			new CDAGetTestCase("Encounter") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return ClinicalStatementOperations.getEncounters((Procedure) objectToTest);
				}
			...
			new CDAGetTestCase("Observation") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return ClinicalStatementOperations.getObservations((Procedure) objectToTest);
				}
			},
			...
			new CDAGetTestCase("ObservationMedia") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return ClinicalStatementOperations.getObservationMedia((Procedure) objectToTest);
				}
			},
			...
			new CDAGetTestCase("Organizer") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return ClinicalStatementOperations.getOrganizers((Procedure) objectToTest);
				}
			},
			...
			new CDAGetTestCase("Procedure") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return ClinicalStatementOperations.getProcedures((Procedure) objectToTest);
				}
			},
			...
			new CDAGetTestCase("RegionOfInterest") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return ClinicalStatementOperations.getRegionsOfInterest((Procedure) objectToTest);
				}
			},
			...
			new CDAGetTestCase("SubstanceAdministration") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return ClinicalStatementOperations.getSubstanceAdministrations((Procedure) objectToTest);
				}
			},
			...
			new CDAGetTestCase("Supply") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return ClinicalStatementOperations.getSupplies((Procedure) objectToTest);
				}
			},
			...
			new CDAGetTestCase("ClinicalDocument") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return ClinicalStatementOperations.getClinicalDocument((Procedure) objectToTest);
				}
			...
			new CDAGetTestCase("Section") {
				...
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					// The Add is reversed, the objectToTest is added to the
					// clinical document
					((Section) eObjectToAdd).addProcedure((Procedure) objectToTest);
				}

				@Override
				protected Object doGet(final EObject objectToTest) {
					return ClinicalStatementOperations.getSection((Procedure) objectToTest);
				}
			...
			new CDAHasTestCase("Act") {
				...
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return ClinicalStatementOperations.hasActTemplate((Procedure) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("Encounter") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return ClinicalStatementOperations.hasEncounterTemplate((Procedure) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("Code") {
				...
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return ClinicalStatementOperations.hasCode(
						(Procedure) objectToTest, CODE, CODE_SYSTEM, CODE_SYSTEM_NAME);
				}
			...
			new CDAHasTestCase("Observation") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return ClinicalStatementOperations.hasObservationTemplate((Procedure) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("ObservationMedia") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return ClinicalStatementOperations.hasObservationMediaTemplate((Procedure) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("Organizer") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return ClinicalStatementOperations.hasOrganizerTemplate((Procedure) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("Procedure") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return ClinicalStatementOperations.hasProcedureTemplate((Procedure) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("RegionOfInterest") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return ClinicalStatementOperations.hasRegionOfInterestTemplate((Procedure) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("Supply") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return ClinicalStatementOperations.hasSupplyTemplate((Procedure) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("TemplateID") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return ClinicalStatementOperations.hasTemplateId((Procedure) objectToTest, templateId);
				}

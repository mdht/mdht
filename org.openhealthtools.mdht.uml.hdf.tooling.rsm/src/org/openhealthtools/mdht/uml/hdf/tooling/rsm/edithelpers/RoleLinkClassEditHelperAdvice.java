 ...
 * @generated
 */
public class RoleLinkClassEditHelperAdvice extends RIMBaseEditHelperAdvice {
	...
	protected String getLocalizedName(EObject eObject) {
		...
		Stereotype stereotype = element.getAppliedStereotype(RIMElementTypes._ROLELINK__CLASS.getStereotypeName());

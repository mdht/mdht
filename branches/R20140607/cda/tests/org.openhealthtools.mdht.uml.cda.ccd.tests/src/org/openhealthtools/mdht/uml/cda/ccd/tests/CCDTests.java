...
@Suite.SuiteClasses({
		...
		SocialHistorySectionTest.class, SocialHistoryObservationTest.class, SocialHistoryStatusObservationTest.class,
		AlertsSectionTest.class, ResultsSectionTest.class, ResultOrganizerTest.class, ResultObservationTest.class,
		ProceduresSectionTest.class, EncountersSectionTest.class, EncountersActivityTest.class,

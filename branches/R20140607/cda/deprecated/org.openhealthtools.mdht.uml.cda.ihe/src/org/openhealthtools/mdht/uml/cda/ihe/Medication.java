 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation templateId.root='1.3.6.1.4.1.19376.1.5.3.1.4.7' constraints.validation.error='MedicationTemplateId MedicationConsumableName' constraints.validation.warning='MedicationDoseQuantity MedicationRateQuantity MedicationRouteCode' constraints.validation.info='MedicationApproachSiteCode'"
 * @generated
 */
public interface Medication extends MedicationActivity {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='not self.consumable.manufacturedProduct.manufacturedLabeledDrug.name.oclIsUndefined()\r\n   or not self.consumable.manufacturedProduct.manufacturedMaterial.name.oclIsUndefined()'"
	 * @generated
	 */
	boolean validateMedicationConsumableName(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='not self.doseQuantity.oclIsUndefined()'"
	 * @generated
	 */
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='not self.rateQuantity.oclIsUndefined()'"
	 * @generated
	 */
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='not self.routeCode.oclIsUndefined()'"
	 * @generated
	 */
	boolean validateMedicationRouteCode(DiagnosticChain diagnostics, Map<Object, Object> context);

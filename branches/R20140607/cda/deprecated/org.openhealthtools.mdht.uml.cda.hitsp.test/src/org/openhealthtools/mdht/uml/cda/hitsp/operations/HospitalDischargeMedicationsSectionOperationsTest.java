...
public class HospitalDischargeMedicationsSectionOperationsTest extends
		org.openhealthtools.mdht.uml.cda.ihe.operations.HospitalDischargeMedicationsSectionOperationsTest {

	protected static final String TEMPLATE_ID = "2.16.840.1.113883.3.88.11.83.114";
	...
	protected EObject getObjectInitToTest() {
		return HITSPFactory.eINSTANCE.createHospitalDischargeMedicationsSection().init();
	}

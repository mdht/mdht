...
public class InteractionProfileDocumentationImpl extends EObjectImpl implements InteractionProfileDocumentation {
	...
	public NotificationChain basicSetDescription(CascadableAnnotation newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__DESCRIPTION, oldDescription,
				newDescription);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newDescription != description) {
			...
			if (description != null) {
				msgs = ((InternalEObject) description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__DESCRIPTION, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__DESCRIPTION, newDescription,
				newDescription));
		}
	}
	...
	public EList<ContextAnnotation> getUsageConstraint() {
		if (usageConstraint == null) {
			usageConstraint = new EObjectContainmentEList<ContextAnnotation>(
				ContextAnnotation.class, this, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__USAGE_CONSTRAINT);
		}
	...
	public EList<ContextAnnotation> getUsageNotes() {
		if (usageNotes == null) {
			usageNotes = new EObjectContainmentEList<ContextAnnotation>(
				ContextAnnotation.class, this, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__USAGE_NOTES);
		}
		return usageNotes;
	}
	...
	public NotificationChain basicSetRationale(CascadableAnnotation newRationale, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__RATIONALE, oldRationale,
				newRationale);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newRationale != rationale) {
			...
			if (rationale != null) {
				msgs = ((InternalEObject) rationale).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__RATIONALE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__RATIONALE, newRationale,
				newRationale));
		}
	}
	...
	public NotificationChain basicSetRequirements(ContextAnnotation newRequirements, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__REQUIREMENTS, oldRequirements,
				newRequirements);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newRequirements != requirements) {
			...
			if (requirements != null) {
				msgs = ((InternalEObject) requirements).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__REQUIREMENTS, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__REQUIREMENTS, newRequirements,
				newRequirements));
		}
	}
	...
	public EList<DesignComment> getDesignComments() {
		if (designComments == null) {
			designComments = new EObjectContainmentEList<DesignComment>(
				DesignComment.class, this, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__DESIGN_COMMENTS);
		}
	...
	public EList<ContextAnnotation> getStabilityRemarks() {
		if (stabilityRemarks == null) {
			stabilityRemarks = new EObjectContainmentEList<ContextAnnotation>(
				ContextAnnotation.class, this, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__STABILITY_REMARKS);
		}
	...
	public NotificationChain basicSetWalkthrough(ContextAnnotation newWalkthrough, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__WALKTHROUGH, oldWalkthrough,
				newWalkthrough);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newWalkthrough != walkthrough) {
			...
			if (walkthrough != null) {
				msgs = ((InternalEObject) walkthrough).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__WALKTHROUGH, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__WALKTHROUGH, newWalkthrough,
				newWalkthrough));
		}
	}
	...
	public EList<OpenIssue> getOpenIssue() {
		if (openIssue == null) {
			openIssue = new EObjectContainmentEList<OpenIssue>(
				OpenIssue.class, this, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__OPEN_ISSUE);
		}
		return openIssue;
	}
	...
	public EList<OtherAnnotation> getOtherAnnotation() {
		if (otherAnnotation == null) {
			otherAnnotation = new EObjectContainmentEList<OtherAnnotation>(
				OtherAnnotation.class, this, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__OTHER_ANNOTATION);
		}
	...
	public EList<Appendix> getAppendix() {
		if (appendix == null) {
			appendix = new EObjectContainmentEList<Appendix>(
				Appendix.class, this, Mif2Package.INTERACTION_PROFILE_DOCUMENTATION__APPENDIX);
		}
		return appendix;
	}

 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.DocumentationOfImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.DocumentationOfImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.DocumentationOfImpl#getTemplateIds <em>Template Id</em>}</li>
...
public class DocumentationOfImpl extends ActRelationshipImpl implements DocumentationOf {
	...
	public NotificationChain basicSetTypeId(InfrastructureRootTypeId newTypeId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.DOCUMENTATION_OF__TYPE_ID, oldTypeId, newTypeId);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public NotificationChain basicSetServiceEvent(ServiceEvent newServiceEvent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.DOCUMENTATION_OF__SERVICE_EVENT, oldServiceEvent, newServiceEvent);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);

...
public class HospitalAdmissionDiagnosisSectionOperationsTest extends
		org.openhealthtools.mdht.uml.cda.ihe.operations.HospitalAdmissionDiagnosisSectionOperationsTest {

	protected static final String TEMPLATE_ID = "2.16.840.1.113883.3.88.11.83.110";
	...
	protected EObject getObjectInitToTest() {
		return HITSPFactory.eINSTANCE.createHospitalAdmissionDiagnosisSection().init();
	}

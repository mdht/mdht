...
public class GlobalGenericPackageImpl extends GenericPackageImpl implements GlobalGenericPackage {
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.GLOBAL_GENERIC_PACKAGE__SCHEMA_VERSION, oldSchemaVersion,
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, Mif2Package.GLOBAL_GENERIC_PACKAGE__SCHEMA_VERSION, oldSchemaVersion,

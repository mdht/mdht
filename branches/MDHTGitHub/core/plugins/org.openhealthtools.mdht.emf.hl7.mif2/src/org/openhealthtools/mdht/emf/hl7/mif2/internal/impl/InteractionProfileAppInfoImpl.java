	...
	public EList<ChangeRequest> getChangeRequest() {
		if (changeRequest == null) {
			changeRequest = new EObjectContainmentEList<ChangeRequest>(
				ChangeRequest.class, this, Mif2Package.INTERACTION_PROFILE_APP_INFO__CHANGE_REQUEST);
		}
	...
	public NotificationChain basicSetDeprecationInfo(DeprecationInfo newDeprecationInfo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, Mif2Package.INTERACTION_PROFILE_APP_INFO__DEPRECATION_INFO, oldDeprecationInfo,
				newDeprecationInfo);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newDeprecationInfo != deprecationInfo) {
			...
			if (deprecationInfo != null) {
				msgs = ((InternalEObject) deprecationInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						Mif2Package.INTERACTION_PROFILE_APP_INFO__DEPRECATION_INFO, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.INTERACTION_PROFILE_APP_INFO__DEPRECATION_INFO, newDeprecationInfo,
				newDeprecationInfo));
		}
	}

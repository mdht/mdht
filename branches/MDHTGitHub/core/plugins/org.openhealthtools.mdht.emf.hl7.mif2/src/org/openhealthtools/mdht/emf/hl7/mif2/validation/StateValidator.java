...
/**
 * A sample validator interface for {@link org.openhealthtools.mdht.emf.hl7.mif2.State}.
...
public interface StateValidator {
	...
	boolean validateAnnotations(StateAnnotations value);

	boolean validateDerivedFrom(EList<StateDerivation> value);

	boolean validateContainedStates(EList<String> value);

	boolean validateName(String value);

	boolean validateParentStateName(String value);
}

 ...
 * @generated
 */
public class ActClassEditHelperAdvice extends RIMBaseEditHelperAdvice {
	...
	protected String getLocalizedName(EObject eObject) {
		...
		Stereotype stereotype = element.getAppliedStereotype(RIMElementTypes._ACT__CLASS.getStereotypeName());

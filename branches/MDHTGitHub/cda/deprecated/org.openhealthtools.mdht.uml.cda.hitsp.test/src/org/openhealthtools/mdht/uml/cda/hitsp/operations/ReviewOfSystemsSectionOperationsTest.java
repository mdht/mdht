...
public class ReviewOfSystemsSectionOperationsTest extends
		org.openhealthtools.mdht.uml.cda.ihe.operations.ReviewOfSystemsSectionOperationsTest {
	protected static final String TEMPLATE_ID = "2.16.840.1.113883.3.88.11.83.120";
	...
	protected EObject getObjectInitToTest() {
		return HITSPFactory.eINSTANCE.createReviewOfSystemsSection().init();
	}

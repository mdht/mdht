 ...
 * related to '<em><b>Diagnostic Findings</b></em>' model objects. <!--
 * end-user-doc -->
 *
 * <p>
...
public class DiagnosticFindingsTest extends CDAValidationTest {
	...
	public void testValidateDiagnosticFindingsTitle() {
		OperationsTestCase<DiagnosticFindings> validateDiagnosticFindingsTitleTestCase = new OperationsTestCase<DiagnosticFindings>(
			"validateDiagnosticFindingsTitle",
			operationsForOCL.getOCLValue("VALIDATE_DIAGNOSTIC_FINDINGS_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {

			@Override
			protected void updateToFail(DiagnosticFindings target) {
		...
		validateDiagnosticFindingsTitleTestCase.doValidationTest();
	}
	 ...
	 * @generated
	 */
	private static class OperationsForOCL extends DiagnosticFindingsOperations {
	 ...
	 * @generated
	 */
	private static class ObjectFactory implements TestObjectFactory<DiagnosticFindings> {

		public DiagnosticFindings create() {
	 ...
	 * @generated
	 */
	private static class ConstructorTestClass extends DiagnosticFindingsOperations {
	};

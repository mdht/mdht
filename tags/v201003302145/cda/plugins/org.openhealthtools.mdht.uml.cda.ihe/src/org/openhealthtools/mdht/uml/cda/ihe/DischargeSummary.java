 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystem='2.16.840.1.113883.6.1' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.1.4' constraints.validation.error='DischargeSummaryTemplateId DischargeSummaryCode DischargeSummaryActiveProblemsSection' code.codeSystemName='LOINC'"
 * @generated
 */
public interface DischargeSummary extends MedicalSummary {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getSections()->one(section : cda::Section | section.oclIsKindOf(ihe::ActiveProblemsSection))'"
	 * @generated
	 */

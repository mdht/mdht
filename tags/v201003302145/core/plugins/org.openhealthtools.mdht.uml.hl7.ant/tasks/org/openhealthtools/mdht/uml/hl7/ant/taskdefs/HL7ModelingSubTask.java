...
public abstract class HL7ModelingSubTask extends Task {

	private HL7ModelingTask hl7modelingTask = null;

	public HL7ModelingSubTask(HL7ModelingTask parentTask) {
		this.hl7modelingTask = parentTask;
	}

	public HL7ModelingTask getHL7ModelingTask() {

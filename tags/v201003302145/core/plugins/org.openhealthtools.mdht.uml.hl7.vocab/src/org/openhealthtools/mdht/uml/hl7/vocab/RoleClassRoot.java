...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Role Class Root</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.openhealthtools.mdht.uml.hl7.vocab.VocabPackage#getRoleClassRoot()
 * @model
 * @generated
 */
public enum RoleClassRoot implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Role Class Root</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public static final List<RoleClassRoot> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	...
	public static RoleClassRoot get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RoleClassRoot result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private RoleClassRoot(int value, String name, String literal) {
		this.value = value;
		this.name = name;

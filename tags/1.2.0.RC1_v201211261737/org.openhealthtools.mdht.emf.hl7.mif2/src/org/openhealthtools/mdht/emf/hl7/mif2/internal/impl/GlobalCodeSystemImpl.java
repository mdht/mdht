...
public class GlobalCodeSystemImpl extends CodeSystemImpl implements GlobalCodeSystem {
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.GLOBAL_CODE_SYSTEM__SCHEMA_VERSION, oldSchemaVersion,
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, Mif2Package.GLOBAL_CODE_SYSTEM__SCHEMA_VERSION, oldSchemaVersion,

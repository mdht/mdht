	...
	public NotificationChain basicSetGraphElement(GraphConnectorWithEdge newGraphElement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, Mif2Package.GRAPH_EDGE_GRAPHIC_INFORMATION__GRAPH_ELEMENT, oldGraphElement,
				newGraphElement);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newGraphElement != graphElement) {
			...
			if (graphElement != null) {
				msgs = ((InternalEObject) graphElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						Mif2Package.GRAPH_EDGE_GRAPHIC_INFORMATION__GRAPH_ELEMENT, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.GRAPH_EDGE_GRAPHIC_INFORMATION__GRAPH_ELEMENT, newGraphElement,
				newGraphElement));
		}
	}

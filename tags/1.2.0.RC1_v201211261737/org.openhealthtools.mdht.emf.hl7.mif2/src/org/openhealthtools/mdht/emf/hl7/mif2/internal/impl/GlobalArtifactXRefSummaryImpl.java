...
public class GlobalArtifactXRefSummaryImpl extends ArtifactXRefSummaryImpl implements GlobalArtifactXRefSummary {
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.GLOBAL_ARTIFACT_XREF_SUMMARY__SCHEMA_VERSION, oldSchemaVersion,
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, Mif2Package.GLOBAL_ARTIFACT_XREF_SUMMARY__SCHEMA_VERSION, oldSchemaVersion,

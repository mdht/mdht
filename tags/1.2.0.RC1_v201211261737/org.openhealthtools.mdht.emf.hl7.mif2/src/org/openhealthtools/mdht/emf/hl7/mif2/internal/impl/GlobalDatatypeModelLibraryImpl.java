...
public class GlobalDatatypeModelLibraryImpl extends DatatypeModelLibraryImpl implements GlobalDatatypeModelLibrary {
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.GLOBAL_DATATYPE_MODEL_LIBRARY__SCHEMA_VERSION, oldSchemaVersion,
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, Mif2Package.GLOBAL_DATATYPE_MODEL_LIBRARY__SCHEMA_VERSION, oldSchemaVersion,

...
public class ADTest {
	public static void main(String[] args) throws Exception {
		...
		ADXP deliveryInstallationType = DatatypesFactory.eINSTANCE.createADXP(
			AddressPartType.DINST, "TheDeliveryInstallationType");
		address.getDeliveryInstallationTypes().add(deliveryInstallationType);
		ADXP deliveryInstallationArea = DatatypesFactory.eINSTANCE.createADXP(
			AddressPartType.DINSTA, "TheDeliveryInstallationArea");
		address.getDeliveryInstallationAreas().add(deliveryInstallationArea);
		ADXP deliveryInstallQual = DatatypesFactory.eINSTANCE.createADXP(
			AddressPartType.DINSTQ, "TheDeliveryInstallationQualification");
		...
		ADXP deliveryModeIdentifier = DatatypesFactory.eINSTANCE.createADXP(
			AddressPartType.DMODID, "TheDeliveryModeIdentifier");
		address.getDeliveryModeIdentifiers().add(deliveryModeIdentifier);
		ADXP buildingNumberSuffix = DatatypesFactory.eINSTANCE.createADXP(
			AddressPartType.BNS, "TheBuildingNumberSuffix");

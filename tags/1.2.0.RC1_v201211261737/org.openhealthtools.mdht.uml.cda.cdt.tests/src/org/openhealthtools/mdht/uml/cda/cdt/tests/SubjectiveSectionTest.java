 ...
 * related to '<em><b>Subjective Section</b></em>' model objects. <!--
 * end-user-doc -->
 *
 * <p>
...
public class SubjectiveSectionTest extends CDAValidationTest {
	 ...
	 */
	@Test
	public void testValidateSubjectiveSectionHasClinicalStatements() {
		OperationsTestCase<SubjectiveSection> validateSubjectiveSectionHasClinicalStatementsTestCase = new OperationsTestCase<SubjectiveSection>(
			"validateSubjectiveSectionHasClinicalStatements",
			operationsForOCL.getOCLValue("VALIDATE_SUBJECTIVE_SECTION_HAS_CLINICAL_STATEMENTS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return SubjectiveSectionOperations.validateSubjectiveSectionHasClinicalStatements(
					(SubjectiveSection) objectToTest, diagnostician, map);
			}

		};

		validateSubjectiveSectionHasClinicalStatementsTestCase.doValidationTest();
	}
	...
	private static class ObjectFactory implements TestObjectFactory<SubjectiveSection> {
		...
		public SubjectiveSection create() {
			return CDTFactory.eINSTANCE.createSubjectiveSection();
		}
	}

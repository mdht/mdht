 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.TdImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.TdImpl#getChar <em>Char</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.TdImpl#getCharoff <em>Charoff</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.TdImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.TdImpl#getColspan <em>Colspan</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.TdImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.TdImpl#getRowspan <em>Rowspan</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.TdImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.TdImpl#getValign <em>Valign</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TdImpl extends FlowImpl implements Td {
	/**
	...
	protected EClass eStaticClass() {
		return XhtmlPackage.Literals.TD;
	}
	...
	public void setAlign(AlignType newAlign) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.TD__ALIGN, oldAlign, align, !oldAlignESet));
	}
	...
	public void unsetAlign() {
		...
		alignESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.TD__ALIGN, oldAlign, ALIGN_EDEFAULT, oldAlignESet));
	}
	...
	public void setChar(String newChar) {
		...
		char_ = newChar;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.TD__CHAR, oldChar, char_));
	}
	...
	public void setCharoff(String newCharoff) {
		...
		charoff = newCharoff;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.TD__CHAROFF, oldCharoff, charoff));
	}
	...
	public void setClass(MifClassType newClass) {
		...
		classESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.TD__CLASS, oldClass, class_, !oldClassESet));
	}
	...
	public void unsetClass() {
		...
		classESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.TD__CLASS, oldClass, CLASS_EDEFAULT, oldClassESet));
	}
	...
	public void setColspan(BigInteger newColspan) {
		...
		colspanESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.TD__COLSPAN, oldColspan, colspan, !oldColspanESet));
	}
	...
	public void unsetColspan() {
		...
		colspanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.TD__COLSPAN, oldColspan, COLSPAN_EDEFAULT, oldColspanESet));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.TD__LANG, oldLang, lang));
	}
	...
	public void setRowspan(BigInteger newRowspan) {
		...
		rowspanESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.TD__ROWSPAN, oldRowspan, rowspan, !oldRowspanESet));
	}
	...
	public void unsetRowspan() {
		...
		rowspanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.TD__ROWSPAN, oldRowspan, ROWSPAN_EDEFAULT, oldRowspanESet));
	}
	...
	public void setStyle(StyleSheet newStyle) {
		...
		styleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.TD__STYLE, oldStyle, style, !oldStyleESet));
	}
	...
	public void unsetStyle() {
		...
		styleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.TD__STYLE, oldStyle, STYLE_EDEFAULT, oldStyleESet));
	}
	...
	public void setValign(ValignType newValign) {
		...
		valignESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.TD__VALIGN, oldValign, valign, !oldValignESet));
	}
	...
	public void unsetValign() {
		...
		valignESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.TD__VALIGN, oldValign, VALIGN_EDEFAULT, oldValignESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XhtmlPackage.TD__ALIGN:
				return getAlign();
			case XhtmlPackage.TD__CHAR:
				return getChar();
			case XhtmlPackage.TD__CHAROFF:
				return getCharoff();
			case XhtmlPackage.TD__CLASS:
				return getClass_();
			case XhtmlPackage.TD__COLSPAN:
				return getColspan();
			case XhtmlPackage.TD__LANG:
				return getLang();
			case XhtmlPackage.TD__ROWSPAN:
				return getRowspan();
			case XhtmlPackage.TD__STYLE:
				return getStyle();
			case XhtmlPackage.TD__VALIGN:
				return getValign();
		}

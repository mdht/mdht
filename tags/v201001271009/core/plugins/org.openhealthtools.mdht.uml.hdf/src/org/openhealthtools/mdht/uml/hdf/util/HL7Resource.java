...
public interface HL7Resource {
	...
	public static final String HL7_DATATYPES_LIBRARY_URI = LIBRARIES_PATHMAP
		+ "HL7Datatypes." + LIBRARY_FILE_EXTENSION; //$NON-NLS-1$

	public static final String HL7_VOC_LIBRARY_URI = LIBRARIES_PATHMAP
		+ "HL7VocSchema." + UMLResource.FILE_EXTENSION; //$NON-NLS-1$

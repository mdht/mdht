...
public class ActiveProblemsSectionOperations extends ProblemSectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String ACTIVE_PROBLEMS_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "not self.code.oclIsUndefined() and self.code.oclIsKindOf(datatypes::CE) and "+

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Global Conformance Profile</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.GlobalConformanceProfileImpl#getSchemaVersion <em>Schema Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GlobalConformanceProfileImpl extends ConformanceProfileImpl implements GlobalConformanceProfile {
	/**
	 ...
	 * @generated
	 */
	protected GlobalConformanceProfileImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Mif2Package.Literals.GLOBAL_CONFORMANCE_PROFILE;
	}
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.GLOBAL_CONFORMANCE_PROFILE__SCHEMA_VERSION, oldSchemaVersion, schemaVersion, !oldSchemaVersionESet));
	}
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Mif2Package.GLOBAL_CONFORMANCE_PROFILE__SCHEMA_VERSION, oldSchemaVersion, SCHEMA_VERSION_EDEFAULT, oldSchemaVersionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Mif2Package.GLOBAL_CONFORMANCE_PROFILE__SCHEMA_VERSION:

...
public class VitalSignsSectionOperations extends org.openhealthtools.mdht.uml.cda.ccd.operations.VitalSignsSectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_IHE_VITAL_SIGNS_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.hasTemplateId('1.3.6.1.4.1.19376.1.5.3.1.3.25')";

...
public class ConformanceProfileAppInfoImpl extends EObjectImpl implements ConformanceProfileAppInfo {
	...
	public EList<ChangeRequest> getChangeRequest() {
		if (changeRequest == null) {
			changeRequest = new EObjectContainmentEList<ChangeRequest>(ChangeRequest.class, this, Mif2Package.CONFORMANCE_PROFILE_APP_INFO__CHANGE_REQUEST);
		}
	...
	public NotificationChain basicSetDeprecationInfo(DeprecationInfo newDeprecationInfo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.CONFORMANCE_PROFILE_APP_INFO__DEPRECATION_INFO, oldDeprecationInfo, newDeprecationInfo);
	...
	public void setDeprecationInfo(DeprecationInfo newDeprecationInfo) {
		if (newDeprecationInfo != deprecationInfo) {
			...
			if (deprecationInfo != null)
				msgs = ((InternalEObject)deprecationInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.CONFORMANCE_PROFILE_APP_INFO__DEPRECATION_INFO, null, msgs);
			if (newDeprecationInfo != null)
				msgs = ((InternalEObject)newDeprecationInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.CONFORMANCE_PROFILE_APP_INFO__DEPRECATION_INFO, null, msgs);
			msgs = basicSetDeprecationInfo(newDeprecationInfo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.CONFORMANCE_PROFILE_APP_INFO__DEPRECATION_INFO, newDeprecationInfo, newDeprecationInfo));
	}

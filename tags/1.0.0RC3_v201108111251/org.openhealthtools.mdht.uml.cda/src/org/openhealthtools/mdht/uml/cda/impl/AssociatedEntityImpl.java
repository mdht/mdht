...
public class AssociatedEntityImpl extends RoleImpl implements AssociatedEntity {
	...
	public NotificationChain basicSetTypeId(InfrastructureRootTypeId newTypeId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.ASSOCIATED_ENTITY__TYPE_ID, oldTypeId, newTypeId);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newTypeId != typeId) {
			...
			if (typeId != null) {
				msgs = ((InternalEObject) typeId).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						CDAPackage.ASSOCIATED_ENTITY__TYPE_ID, null, msgs);
			}
			if (newTypeId != null) {
	...
	public NotificationChain basicSetCode(CE newCode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.ASSOCIATED_ENTITY__CODE, oldCode, newCode);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newCode != code) {
			...
			if (code != null) {
				msgs = ((InternalEObject) code).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						CDAPackage.ASSOCIATED_ENTITY__CODE, null, msgs);
			}
			if (newCode != null) {
	...
	public NotificationChain basicSetSDTCPatient(SDTCPatient newSDTCPatient, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.ASSOCIATED_ENTITY__SDTC_PATIENT, oldSDTCPatient, newSDTCPatient);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newSDTCPatient != sDTCPatient) {
			...
			if (sDTCPatient != null) {
				msgs = ((InternalEObject) sDTCPatient).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						CDAPackage.ASSOCIATED_ENTITY__SDTC_PATIENT, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(
				this, Notification.SET, CDAPackage.ASSOCIATED_ENTITY__SDTC_PATIENT, newSDTCPatient, newSDTCPatient));
		}
	}
	...
	public NotificationChain basicSetAssociatedPerson(Person newAssociatedPerson, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.ASSOCIATED_ENTITY__ASSOCIATED_PERSON, oldAssociatedPerson,
				newAssociatedPerson);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setAssociatedPerson(Person newAssociatedPerson) {
		if (newAssociatedPerson != associatedPerson) {
			...
			if (associatedPerson != null) {
				msgs = ((InternalEObject) associatedPerson).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						CDAPackage.ASSOCIATED_ENTITY__ASSOCIATED_PERSON, null, msgs);
			}
			if (newAssociatedPerson != null) {
				msgs = ((InternalEObject) newAssociatedPerson).eInverseAdd(this, EOPPOSITE_FEATURE_BASE -
						CDAPackage.ASSOCIATED_ENTITY__ASSOCIATED_PERSON, null, msgs);
			}
	...
	public NotificationChain basicSetScopingOrganization(Organization newScopingOrganization, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, CDAPackage.ASSOCIATED_ENTITY__SCOPING_ORGANIZATION, oldScopingOrganization,
	...
	public void setScopingOrganization(Organization newScopingOrganization) {
		if (newScopingOrganization != scopingOrganization) {
			...
			if (scopingOrganization != null) {
				msgs = ((InternalEObject) scopingOrganization).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						CDAPackage.ASSOCIATED_ENTITY__SCOPING_ORGANIZATION, null, msgs);
			}
			if (newScopingOrganization != null) {
				msgs = ((InternalEObject) newScopingOrganization).eInverseAdd(this, EOPPOSITE_FEATURE_BASE -
						CDAPackage.ASSOCIATED_ENTITY__SCOPING_ORGANIZATION, null, msgs);
			}
	...
	public void unsetClassCode() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, CDAPackage.ASSOCIATED_ENTITY__CLASS_CODE, oldClassCode, CLASS_CODE_EDEFAULT,
				oldClassCodeESet));
		}
	}

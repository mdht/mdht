...
public class RIMUtil {
    ...
    public static ImageDescriptor getImageDescriptor(String imageFilePath) {
        ...
        URL result = org.openhealthtools.mdht.uml.hdf.tooling.rsm.internal.Activator.getDefault().getBundle().getEntry(imageFilePath);
        ...
        return new ImageDescriptor() {
            public ImageData getImageData() {
            	try {
            		...
            		org.openhealthtools.mdht.uml.hdf.tooling.rsm.internal.Activator.getDefault().getLog().log(new Status(IStatus.ERROR, org.openhealthtools.mdht.uml.hdf.tooling.rsm.internal.Activator.PLUGIN_ID, -1, e.getLocalizedMessage(), e)); //$NON-NLS-1$
            	}

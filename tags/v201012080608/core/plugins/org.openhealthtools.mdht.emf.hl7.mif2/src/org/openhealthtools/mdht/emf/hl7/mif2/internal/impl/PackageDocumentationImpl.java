...
import org.openhealthtools.mdht.emf.hl7.mif2.PackageDocumentation;

/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Package Documentation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.PackageDocumentationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.PackageDocumentationImpl#getDesignComments <em>Design Comments</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.PackageDocumentationImpl#getStabilityRemarks <em>Stability Remarks</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.PackageDocumentationImpl#getWalkthrough <em>Walkthrough</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.PackageDocumentationImpl#getOpenIssue <em>Open Issue</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.PackageDocumentationImpl#getAppendix <em>Appendix</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.PackageDocumentationImpl#getOtherAnnotation <em>Other Annotation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PackageDocumentationImpl extends EObjectImpl implements PackageDocumentation {
	/**
	 ...
	 * @generated
	 */
	protected PackageDocumentationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Mif2Package.Literals.PACKAGE_DOCUMENTATION;
	}
	...
	public NotificationChain basicSetDescription(CascadableAnnotation newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.PACKAGE_DOCUMENTATION__DESCRIPTION, oldDescription, newDescription);
	...
	public void setDescription(CascadableAnnotation newDescription) {
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject)description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.PACKAGE_DOCUMENTATION__DESCRIPTION, null, msgs);
			if (newDescription != null)
				msgs = ((InternalEObject)newDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.PACKAGE_DOCUMENTATION__DESCRIPTION, null, msgs);
			msgs = basicSetDescription(newDescription, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.PACKAGE_DOCUMENTATION__DESCRIPTION, newDescription, newDescription));
	}
	...
	public EList<DesignComment> getDesignComments() {
		if (designComments == null) {
			designComments = new EObjectContainmentEList<DesignComment>(DesignComment.class, this, Mif2Package.PACKAGE_DOCUMENTATION__DESIGN_COMMENTS);
		}
	...
	public EList<ContextAnnotation> getStabilityRemarks() {
		if (stabilityRemarks == null) {
			stabilityRemarks = new EObjectContainmentEList<ContextAnnotation>(ContextAnnotation.class, this, Mif2Package.PACKAGE_DOCUMENTATION__STABILITY_REMARKS);
		}
	...
	public NotificationChain basicSetWalkthrough(ContextAnnotation newWalkthrough, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.PACKAGE_DOCUMENTATION__WALKTHROUGH, oldWalkthrough, newWalkthrough);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setWalkthrough(ContextAnnotation newWalkthrough) {
		if (newWalkthrough != walkthrough) {
			NotificationChain msgs = null;
			if (walkthrough != null)
				msgs = ((InternalEObject)walkthrough).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.PACKAGE_DOCUMENTATION__WALKTHROUGH, null, msgs);
			if (newWalkthrough != null)
				msgs = ((InternalEObject)newWalkthrough).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.PACKAGE_DOCUMENTATION__WALKTHROUGH, null, msgs);
			msgs = basicSetWalkthrough(newWalkthrough, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.PACKAGE_DOCUMENTATION__WALKTHROUGH, newWalkthrough, newWalkthrough));
	}
	...
	public EList<OpenIssue> getOpenIssue() {
		if (openIssue == null) {
			openIssue = new EObjectContainmentEList<OpenIssue>(OpenIssue.class, this, Mif2Package.PACKAGE_DOCUMENTATION__OPEN_ISSUE);
		}
		return openIssue;
	}
	...
	public EList<Appendix> getAppendix() {
		if (appendix == null) {
			appendix = new EObjectContainmentEList<Appendix>(Appendix.class, this, Mif2Package.PACKAGE_DOCUMENTATION__APPENDIX);
		}
		return appendix;
	}
	...
	public EList<OtherAnnotation> getOtherAnnotation() {
		if (otherAnnotation == null) {
			otherAnnotation = new EObjectContainmentEList<OtherAnnotation>(OtherAnnotation.class, this, Mif2Package.PACKAGE_DOCUMENTATION__OTHER_ANNOTATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Mif2Package.PACKAGE_DOCUMENTATION__DESCRIPTION:
				return basicSetDescription(null, msgs);
			case Mif2Package.PACKAGE_DOCUMENTATION__DESIGN_COMMENTS:
				return ((InternalEList<?>)getDesignComments()).basicRemove(otherEnd, msgs);
			case Mif2Package.PACKAGE_DOCUMENTATION__STABILITY_REMARKS:
				return ((InternalEList<?>)getStabilityRemarks()).basicRemove(otherEnd, msgs);
			case Mif2Package.PACKAGE_DOCUMENTATION__WALKTHROUGH:
				return basicSetWalkthrough(null, msgs);
			case Mif2Package.PACKAGE_DOCUMENTATION__OPEN_ISSUE:
				return ((InternalEList<?>)getOpenIssue()).basicRemove(otherEnd, msgs);
			case Mif2Package.PACKAGE_DOCUMENTATION__APPENDIX:
				return ((InternalEList<?>)getAppendix()).basicRemove(otherEnd, msgs);
			case Mif2Package.PACKAGE_DOCUMENTATION__OTHER_ANNOTATION:

...
public class DomainAnalysisModelAppInfoImpl extends EObjectImpl implements DomainAnalysisModelAppInfo {
	...
	public EList<Mapping> getMapping() {
		if (mapping == null) {
			mapping = new EObjectContainmentEList<Mapping>(Mapping.class, this, Mif2Package.DOMAIN_ANALYSIS_MODEL_APP_INFO__MAPPING);
		}
		return mapping;
	}
	...
	public EList<FormalConstraint> getFormalConstraint() {
		if (formalConstraint == null) {
			formalConstraint = new EObjectContainmentEList<FormalConstraint>(FormalConstraint.class, this, Mif2Package.DOMAIN_ANALYSIS_MODEL_APP_INFO__FORMAL_CONSTRAINT);
		}
	...
	public EList<StaticExample> getStaticExample() {
		if (staticExample == null) {
			staticExample = new EObjectContainmentEList<StaticExample>(StaticExample.class, this, Mif2Package.DOMAIN_ANALYSIS_MODEL_APP_INFO__STATIC_EXAMPLE);
		}
	...
	public EList<BallotComment> getBallotComment() {
		if (ballotComment == null) {
			ballotComment = new EObjectContainmentEList<BallotComment>(BallotComment.class, this, Mif2Package.DOMAIN_ANALYSIS_MODEL_APP_INFO__BALLOT_COMMENT);
		}
	...
	public EList<ChangeRequest> getChangeRequest() {
		if (changeRequest == null) {
			changeRequest = new EObjectContainmentEList<ChangeRequest>(ChangeRequest.class, this, Mif2Package.DOMAIN_ANALYSIS_MODEL_APP_INFO__CHANGE_REQUEST);
		}
	...
	public NotificationChain basicSetDeprecationInfo(DeprecationInfo newDeprecationInfo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.DOMAIN_ANALYSIS_MODEL_APP_INFO__DEPRECATION_INFO, oldDeprecationInfo, newDeprecationInfo);
	...
	public void setDeprecationInfo(DeprecationInfo newDeprecationInfo) {
		if (newDeprecationInfo != deprecationInfo) {
			...
			if (deprecationInfo != null)
				msgs = ((InternalEObject)deprecationInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.DOMAIN_ANALYSIS_MODEL_APP_INFO__DEPRECATION_INFO, null, msgs);
			if (newDeprecationInfo != null)
				msgs = ((InternalEObject)newDeprecationInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.DOMAIN_ANALYSIS_MODEL_APP_INFO__DEPRECATION_INFO, null, msgs);
			msgs = basicSetDeprecationInfo(newDeprecationInfo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.DOMAIN_ANALYSIS_MODEL_APP_INFO__DEPRECATION_INFO, newDeprecationInfo, newDeprecationInfo));
	}

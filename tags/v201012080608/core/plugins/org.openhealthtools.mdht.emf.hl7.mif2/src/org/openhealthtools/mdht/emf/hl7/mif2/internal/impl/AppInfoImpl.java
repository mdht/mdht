...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>App Info</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.AppInfoImpl#getMapping <em>Mapping</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.AppInfoImpl#getFormalConstraint <em>Formal Constraint</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.AppInfoImpl#getOpenIssue <em>Open Issue</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.AppInfoImpl#getStaticExample <em>Static Example</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.AppInfoImpl#getBallotComment <em>Ballot Comment</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.AppInfoImpl#getChangeRequest <em>Change Request</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.AppInfoImpl#getDeprecationInfo <em>Deprecation Info</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AppInfoImpl extends EObjectImpl implements AppInfo {
	/**
	...
	protected EClass eStaticClass() {
		return Mif2Package.Literals.APP_INFO;
	}
	...
	public EList<Mapping> getMapping() {
		if (mapping == null) {
			mapping = new EObjectContainmentEList<Mapping>(Mapping.class, this, Mif2Package.APP_INFO__MAPPING);
		}
		return mapping;
	}
	...
	public EList<OpenIssue> getOpenIssue() {
		if (openIssue == null) {
			openIssue = new EObjectContainmentEList<OpenIssue>(OpenIssue.class, this, Mif2Package.APP_INFO__OPEN_ISSUE);
		}
		return openIssue;
	}

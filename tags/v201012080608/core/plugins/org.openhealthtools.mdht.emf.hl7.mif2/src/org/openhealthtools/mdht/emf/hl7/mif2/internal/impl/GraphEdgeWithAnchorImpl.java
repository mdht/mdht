...
public class GraphEdgeWithAnchorImpl extends GraphEdgeImpl implements GraphEdgeWithAnchor {
	...
	public NotificationChain basicSetAnchor(GraphConnector newAnchor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.GRAPH_EDGE_WITH_ANCHOR__ANCHOR, oldAnchor, newAnchor);
	...
	public void setAnchor(GraphConnector newAnchor) {
		if (newAnchor != anchor) {
			...
			if (anchor != null)
				msgs = ((InternalEObject)anchor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.GRAPH_EDGE_WITH_ANCHOR__ANCHOR, null, msgs);
			if (newAnchor != null)
				msgs = ((InternalEObject)newAnchor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.GRAPH_EDGE_WITH_ANCHOR__ANCHOR, null, msgs);
			msgs = basicSetAnchor(newAnchor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.GRAPH_EDGE_WITH_ANCHOR__ANCHOR, newAnchor, newAnchor));
	}

...
public class XSDDatatypeUtil {
	...
	public static Package importHL7DatatypesLibrary(Package pkg) {
		...
		try {
			...
			Resource hl7LibraryResource = resourceSet.getResource(URI
					.createURI(HL7Resource.HL7_DATATYPES_LIBRARY_URI), true);
			
			if (hl7LibraryResource != null) {
				hl7Library = (Package) EcoreUtil.getObjectByType(
						hl7LibraryResource.getContents(), 
	...
	public static Package loadHL7VocabularyLibrary(Package pkg) {
		ResourceSet resourceSet = pkg.eResource().getResourceSet();
		Resource hl7LibraryResource = resourceSet.getResource(URI
				.createURI(HL7Resource.HL7_VOC_LIBRARY_URI), true);
	 ...
	 * datatype name.
	 * @param basePackage	model package where HL7 datatypes is imported
	 * @param localName
	 ...
	 * enumeration name.
	 * @param basePackage	model package where HL7 vocabulary will be referenced
	 * @param localName

...
public class AddCodeSystemVersionAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		try {
			...
			IUndoableOperation operation = new AbstractEMFOperation(editingDomain, Messages.AddCodeSystemVersion_operation_title) {
			    protected IStatus doExecute(IProgressMonitor monitor, IAdaptable info) {
					...
					String name = UMLUtil.getUniqueTypeName(selectedPackage, 
							Messages.AddCodeSystemVersion_default_name);

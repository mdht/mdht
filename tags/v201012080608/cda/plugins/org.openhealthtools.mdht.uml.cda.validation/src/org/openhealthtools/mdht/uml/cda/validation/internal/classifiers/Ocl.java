...
import org.openhealthtools.mdht.uml.cda.validation.internal.classifiers.oclconstraints.MissingOCLConstraint;

/**
 * 
 * $Id: $
 */
public class Ocl extends AbstractModelConstraint {

	private static void initialize() {

		InvalidOCLConstraint.register();
		MissingOCLConstraint.register();

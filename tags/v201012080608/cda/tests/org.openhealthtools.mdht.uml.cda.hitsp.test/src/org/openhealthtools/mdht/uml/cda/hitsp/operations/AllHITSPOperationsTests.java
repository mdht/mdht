...
@Suite.SuiteClasses({ AdmissionMedicationHistorySectionOperationsTest.class,
		...
		ChiefComplaintSectionOperationsTest.class, CommentOperationsTest.class,
		...
		EncounterOperationsTest.class, EncountersSectionOperationsTest.class,
		...
		InsuranceProviderOperationsTest.class,
		...
		MedicationTaperedDoseOperationsTest.class,
		...
		ProblemListSectionOperationsTest.class, ProcedureOperationsTest.class,
		ReasonForReferralSectionOperationsTest.class,
		ResultOperationsTest.class, ReviewOfSystemsSectionOperationsTest.class,
		SocialHistorySectionOperationsTest.class,
		SurgeriesSectionOperationsTest.class, VitalSignOperationsTest.class,

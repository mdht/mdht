...
public interface HospitalDischargeMedicationsSection extends org.openhealthtools.mdht.uml.cda.ihe.HospitalDischargeMedicationsSection {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.hasTemplateId(\'2.16.840.1.113883.3.88.11.83.114\')'"
	 * @generated
	 */
	boolean validateHITSPHospitalDischargeMedicationsSectionTemplateId(DiagnosticChain diagnostics, Map<Object, Object> context);

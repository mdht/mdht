...
public class SocialHistorySectionOperations extends org.openhealthtools.mdht.uml.cda.ccd.operations.SocialHistorySectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_IHE_SOCIAL_HISTORY_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.hasTemplateId('1.3.6.1.4.1.19376.1.5.3.1.3.16')";

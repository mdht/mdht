 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.BImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.BImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.BImpl#getStyle <em>Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BImpl extends InlineImpl implements B {
	/**
	...
	protected EClass eStaticClass() {
		return XhtmlPackage.Literals.B;
	}
	...
	public void setClass(MifClassType newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.B__CLASS, oldClass, class_, !oldClassESet));
	}
	...
	public void unsetClass() {
		...
		classESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.B__CLASS, oldClass, CLASS_EDEFAULT, oldClassESet));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.B__LANG, oldLang, lang));
	}
	...
	public void setStyle(StyleSheet newStyle) {
		...
		styleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.B__STYLE, oldStyle, style, !oldStyleESet));
	}
	...
	public void unsetStyle() {
		...
		styleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.B__STYLE, oldStyle, STYLE_EDEFAULT, oldStyleESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XhtmlPackage.B__CLASS:
				return getClass_();
			case XhtmlPackage.B__LANG:
				return getLang();
			case XhtmlPackage.B__STYLE:
				return getStyle();
		}

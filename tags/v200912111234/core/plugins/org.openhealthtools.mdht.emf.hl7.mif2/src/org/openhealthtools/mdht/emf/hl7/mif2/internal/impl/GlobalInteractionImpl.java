...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Global Interaction</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.emf.hl7.mif2.internal.impl.GlobalInteractionImpl#getSchemaVersion <em>Schema Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GlobalInteractionImpl extends InteractionImpl implements GlobalInteraction {
	/**
	 ...
	 * @generated
	 */
	protected GlobalInteractionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Mif2Package.Literals.GLOBAL_INTERACTION;
	}
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.GLOBAL_INTERACTION__SCHEMA_VERSION, oldSchemaVersion, schemaVersion, !oldSchemaVersionESet));
	}
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Mif2Package.GLOBAL_INTERACTION__SCHEMA_VERSION, oldSchemaVersion, SCHEMA_VERSION_EDEFAULT, oldSchemaVersionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Mif2Package.GLOBAL_INTERACTION__SCHEMA_VERSION:

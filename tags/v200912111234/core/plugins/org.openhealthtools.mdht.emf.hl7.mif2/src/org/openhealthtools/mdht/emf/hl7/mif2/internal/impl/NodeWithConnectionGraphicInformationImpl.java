 ...
 * @generated
 */
public class NodeWithConnectionGraphicInformationImpl extends GraphicInformationImpl implements NodeWithConnectionGraphicInformation {
	/**
	 ...
	 * @generated
	 */
	public NotificationChain basicSetGraphElement(GraphNodeWithOptionalConnection newGraphElement, NotificationChain msgs) {
		GraphNodeWithOptionalConnection oldGraphElement = graphElement;
		graphElement = newGraphElement;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.NODE_WITH_CONNECTION_GRAPHIC_INFORMATION__GRAPH_ELEMENT, oldGraphElement, newGraphElement);
	...
	public void setGraphElement(GraphNodeWithOptionalConnection newGraphElement) {
		if (newGraphElement != graphElement) {
			...
			if (graphElement != null)
				msgs = ((InternalEObject)graphElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.NODE_WITH_CONNECTION_GRAPHIC_INFORMATION__GRAPH_ELEMENT, null, msgs);
			if (newGraphElement != null)
				msgs = ((InternalEObject)newGraphElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.NODE_WITH_CONNECTION_GRAPHIC_INFORMATION__GRAPH_ELEMENT, null, msgs);
			msgs = basicSetGraphElement(newGraphElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.NODE_WITH_CONNECTION_GRAPHIC_INFORMATION__GRAPH_ELEMENT, newGraphElement, newGraphElement));
	}

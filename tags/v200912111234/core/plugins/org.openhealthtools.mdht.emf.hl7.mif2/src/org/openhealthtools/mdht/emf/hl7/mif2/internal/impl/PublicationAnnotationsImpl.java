...
public class PublicationAnnotationsImpl extends EObjectImpl implements PublicationAnnotations {
	...
	public NotificationChain basicSetDocumentation(PublicationDocumentation newDocumentation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.PUBLICATION_ANNOTATIONS__DOCUMENTATION, oldDocumentation, newDocumentation);
	...
	public void setDocumentation(PublicationDocumentation newDocumentation) {
		if (newDocumentation != documentation) {
			...
			if (documentation != null)
				msgs = ((InternalEObject)documentation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.PUBLICATION_ANNOTATIONS__DOCUMENTATION, null, msgs);
			if (newDocumentation != null)
				msgs = ((InternalEObject)newDocumentation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.PUBLICATION_ANNOTATIONS__DOCUMENTATION, null, msgs);
			msgs = basicSetDocumentation(newDocumentation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.PUBLICATION_ANNOTATIONS__DOCUMENTATION, newDocumentation, newDocumentation));
	}
	...
	public NotificationChain basicSetAppInfo(PublicationAppInfo newAppInfo, NotificationChain msgs) {
		...
		appInfo = newAppInfo;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.PUBLICATION_ANNOTATIONS__APP_INFO, oldAppInfo, newAppInfo);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAppInfo(PublicationAppInfo newAppInfo) {
		if (newAppInfo != appInfo) {
			NotificationChain msgs = null;
			if (appInfo != null)
				msgs = ((InternalEObject)appInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.PUBLICATION_ANNOTATIONS__APP_INFO, null, msgs);
			if (newAppInfo != null)
				msgs = ((InternalEObject)newAppInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.PUBLICATION_ANNOTATIONS__APP_INFO, null, msgs);
			msgs = basicSetAppInfo(newAppInfo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.PUBLICATION_ANNOTATIONS__APP_INFO, newAppInfo, newAppInfo));
	}

...
public class DomainInstanceExampleImpl extends PackageArtifactImpl implements DomainInstanceExample {
	...
	public NotificationChain basicSetAnnotations(DomainInstanceExampleAnnotations newAnnotations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.DOMAIN_INSTANCE_EXAMPLE__ANNOTATIONS, oldAnnotations, newAnnotations);
	...
	public void setAnnotations(DomainInstanceExampleAnnotations newAnnotations) {
		if (newAnnotations != annotations) {
			...
			if (annotations != null)
				msgs = ((InternalEObject)annotations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.DOMAIN_INSTANCE_EXAMPLE__ANNOTATIONS, null, msgs);
			if (newAnnotations != null)
				msgs = ((InternalEObject)newAnnotations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.DOMAIN_INSTANCE_EXAMPLE__ANNOTATIONS, null, msgs);
			msgs = basicSetAnnotations(newAnnotations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.DOMAIN_INSTANCE_EXAMPLE__ANNOTATIONS, newAnnotations, newAnnotations));
	}
	...
	public NotificationChain basicSetModel(XMIContent newModel, NotificationChain msgs) {
		...
		model = newModel;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Mif2Package.DOMAIN_INSTANCE_EXAMPLE__MODEL, oldModel, newModel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setModel(XMIContent newModel) {
		if (newModel != model) {
			NotificationChain msgs = null;
			if (model != null)
				msgs = ((InternalEObject)model).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Mif2Package.DOMAIN_INSTANCE_EXAMPLE__MODEL, null, msgs);
			if (newModel != null)
				msgs = ((InternalEObject)newModel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Mif2Package.DOMAIN_INSTANCE_EXAMPLE__MODEL, null, msgs);
			msgs = basicSetModel(newModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mif2Package.DOMAIN_INSTANCE_EXAMPLE__MODEL, newModel, newModel));
	}

 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.SubImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.SubImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.emf.w3c.xhtml.internal.impl.SubImpl#getStyle <em>Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubImpl extends InlineImpl implements Sub {
	/**
	...
	protected EClass eStaticClass() {
		return XhtmlPackage.Literals.SUB;
	}
	...
	public void setClass(MifClassType newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.SUB__CLASS, oldClass, class_, !oldClassESet));
	}
	...
	public void unsetClass() {
		...
		classESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.SUB__CLASS, oldClass, CLASS_EDEFAULT, oldClassESet));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.SUB__LANG, oldLang, lang));
	}
	...
	public void setStyle(StyleSheet newStyle) {
		...
		styleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.SUB__STYLE, oldStyle, style, !oldStyleESet));
	}
	...
	public void unsetStyle() {
		...
		styleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.SUB__STYLE, oldStyle, STYLE_EDEFAULT, oldStyleESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XhtmlPackage.SUB__CLASS:
				return getClass_();
			case XhtmlPackage.SUB__LANG:
				return getLang();
			case XhtmlPackage.SUB__STYLE:
				return getStyle();
		}

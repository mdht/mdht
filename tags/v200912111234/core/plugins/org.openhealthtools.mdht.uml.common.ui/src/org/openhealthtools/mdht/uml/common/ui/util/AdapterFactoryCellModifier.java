 ...
 * interfaces implemented by the adapters generated by the AdapterFactory.
 * {@link ICellModifier} is delegated to {@link IItemCellModifier}.
 */
public class AdapterFactoryCellModifier implements ICellModifier {
	...
	public boolean canModify(Object element, String property) {
		...
		ICellModifier cellModifier = (ICellModifier) adapterFactory.adapt(
				element, ICellModifierClass);
	...
	public void modify(Object element, String property, Object value) {
		Object object = (element instanceof Widget) ?
				((Widget)element).getData() : element;
				
		// Get the adapter from the factory.
		ICellModifier cellModifier = (ICellModifier) adapterFactory.adapt(
				object, ICellModifierClass);

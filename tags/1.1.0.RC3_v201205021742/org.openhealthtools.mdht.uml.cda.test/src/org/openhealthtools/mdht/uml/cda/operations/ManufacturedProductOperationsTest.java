...
public class ManufacturedProductOperationsTest extends CDAValidationTest {
	...
	public static final Set<String> EREFERENCE_NAMES = new HashSet<String>(Arrays.asList(
		"manufacturedLabeledDrug", "manufacturedMaterial"));
	...
	new UndefinedXORValidationTestCase("Component2Operations", EREFERENCE_NAMES) {
		...
		protected boolean validate(final EObject objectToTest, final BasicDiagnostic diagnostician,
			...
			return ManufacturedProductOperations.validateManufacturedDrugOrOtherMaterial(
				(ManufacturedProduct) objectToTest, diagnostician, map);
		}
	} };

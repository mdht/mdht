	...
	private static final CDATestCase TEST_CASE_ARRAY[] = {
			...
			new CDAAddTestCase("Act") {
				...
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					SectionOperations.addAct((Section) objectToTest, (Act) eObjectToAdd);
				}
			...
			new CDAAddTestCase("Encounter") {
				...
				@Override
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					SectionOperations.addEncounter((Section) objectToTest, (Encounter) eObjectToAdd);
				}
			...
			new CDAAddTestCase("Observation") {
				...
				@Override
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					SectionOperations.addObservation((Section) objectToTest, (Observation) eObjectToAdd);
			...
			new CDAAddTestCase("ObservationMedia") {
				...
				@Override
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					SectionOperations.addObservationMedia((Section) objectToTest, (ObservationMedia) eObjectToAdd);
			...
			new CDAAddTestCase("Organizer") {
				...
				@Override
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					SectionOperations.addOrganizer((Section) objectToTest, (Organizer) eObjectToAdd);
				}
			...
			new CDAAddTestCase("Procedure") {
				...
				@Override
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					SectionOperations.addProcedure((Section) objectToTest, (Procedure) eObjectToAdd);
				}
			...
			new CDAAddTestCase("RegionOfInterest") {
				...
				@Override
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					SectionOperations.addRegionOfInterest((Section) objectToTest, (RegionOfInterest) eObjectToAdd);
				}
			...
			new CDAAddTestCase("SubstanceAdministration") {
				...
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					SectionOperations.addSubstanceAdministration(
						(Section) objectToTest, (SubstanceAdministration) eObjectToAdd);
				}

				@Override
				protected EStructuralFeature getFeature() {
					return CDAPackage.eINSTANCE.getEntry_SubstanceAdministration();
				}
			},
			...
			new CDAAddTestCase("Supply") {
				...
				@Override
				protected void doAdd(final EObject objectToTest, final EObject eObjectToAdd) {
					SectionOperations.addSupply((Section) objectToTest, (Supply) eObjectToAdd);
				}
			...
			new CDAGetTestCase("Encounter") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return SectionOperations.getEncounters((Section) objectToTest);
				}
			...
			new CDAGetTestCase("Observation") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return SectionOperations.getObservations((Section) objectToTest);
				}
			},
			...
			new CDAGetTestCase("ObservationMedia") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return SectionOperations.getObservationMedia((Section) objectToTest);
				}
			},
			...
			new CDAGetTestCase("Organizer") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return SectionOperations.getOrganizers((Section) objectToTest);
				}
			},
			...
			new CDAGetTestCase("Procedure") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return SectionOperations.getProcedures((Section) objectToTest);
				}
			},
			...
			new CDAGetTestCase("RegionOfInterest") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return SectionOperations.getRegionsOfInterest((Section) objectToTest);
				}
			},
			...
			new CDAGetTestCase("SubstanceAdministration") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return SectionOperations.getSubstanceAdministrations((Section) objectToTest);
				}
			},
			...
			new CDAGetTestCase("Supply") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return SectionOperations.getSupplies((Section) objectToTest);
				}
			},
			...
			new CDAGetTestCase("ClinicalDocument") {
				...
				@Override
				protected Object doGet(final EObject objectToTest) {
					return SectionOperations.getClinicalDocument((Section) objectToTest);
				}
			...
			new CDAHasTestCase("Act") {
				...
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return SectionOperations.hasActTemplate((Section) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("Encounter") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return SectionOperations.hasEncounterTemplate((Section) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("Code") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return SectionOperations.hasCode((Section) objectToTest, CODE, CODE_SYSTEM, CODE_SYSTEM_NAME);
				}
			...
			new CDAHasTestCase("Observation") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return SectionOperations.hasObservationTemplate((Section) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("ObservationMedia") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return SectionOperations.hasObservationMediaTemplate((Section) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("Organizer") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return SectionOperations.hasOrganizerTemplate((Section) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("Procedure") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return SectionOperations.hasProcedureTemplate((Section) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("RegionOfInterest") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return SectionOperations.hasRegionOfInterestTemplate((Section) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("SubstanceAdministration") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return SectionOperations.hasSubstanceAdministrationTemplate((Section) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("Supply") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return SectionOperations.hasSupplyTemplate((Section) objectToTest, templateId);
				}
			...
			new CDAHasTestCase("TemplateID") {
				...
				@Override
				protected boolean doHas(final EObject objectToTest, final String templateId) {
					return SectionOperations.hasTemplateId((Section) objectToTest, templateId);
				}

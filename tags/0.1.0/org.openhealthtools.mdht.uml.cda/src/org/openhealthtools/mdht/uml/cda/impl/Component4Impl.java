...
import org.openhealthtools.mdht.uml.cda.internal.operations.Component4Operations;
...
public class Component4Impl extends EObjectImpl implements Component4 {
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT4__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setTypeCode(ActRelationshipHasComponent newTypeCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT4__TYPE_CODE, oldTypeCode, typeCode));
	}

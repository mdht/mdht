 ...
 * <ul>
 * <li>{@link org.openhealthtools.mdht.cts2.valueset.impl.ValueSetCatalogEntryImpl#getDefinitions <em>Definitions</em>}</li>
 * <li>{@link org.openhealthtools.mdht.cts2.valueset.impl.ValueSetCatalogEntryImpl#getCurrentDefinition <em>Current Definition</em>}</li>
 * <li>{@link org.openhealthtools.mdht.cts2.valueset.impl.ValueSetCatalogEntryImpl#getValueSetName <em>Value Set Name</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class ValueSetCatalogEntryImpl extends AbstractResourceDescriptionImpl implements ValueSetCatalogEntry {
	/**
	 * The default value of the '{@link #getDefinitions() <em>Definitions</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getDefinitions()
	 ...
	 * @ordered
	 */
	protected static final String DEFINITIONS_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getDefinitions() <em>Definitions</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getDefinitions()
	 ...
	 * @ordered
	 */
	protected String definitions = DEFINITIONS_EDEFAULT;
	 ...
	 * @generated
	 */
	protected ValueSetCatalogEntryImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ValueSetPackage.Literals.VALUE_SET_CATALOG_ENTRY;
	}
	 ...
	 * @generated
	 */
	public void setDefinitions(String newDefinitions) {
		String oldDefinitions = definitions;
		definitions = newDefinitions;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, ValueSetPackage.VALUE_SET_CATALOG_ENTRY__DEFINITIONS, oldDefinitions,
				definitions));
		}
	}
	...
	public NotificationChain basicSetCurrentDefinition(ValueSetDefinitionReference newCurrentDefinition,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, ValueSetPackage.VALUE_SET_CATALOG_ENTRY__CURRENT_DEFINITION,
		...
		if (newCurrentDefinition != currentDefinition) {
			...
			if (currentDefinition != null) {
				msgs = ((InternalEObject) currentDefinition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						ValueSetPackage.VALUE_SET_CATALOG_ENTRY__CURRENT_DEFINITION, null, msgs);
			}
	...
	public void setValueSetName(String newValueSetName) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, ValueSetPackage.VALUE_SET_CATALOG_ENTRY__VALUE_SET_NAME, oldValueSetName,
				valueSetName));
		}
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ValueSetPackage.VALUE_SET_CATALOG_ENTRY__DEFINITIONS:
				setDefinitions((String) newValue);
				return;
			case ValueSetPackage.VALUE_SET_CATALOG_ENTRY__CURRENT_DEFINITION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ValueSetPackage.VALUE_SET_CATALOG_ENTRY__DEFINITIONS:
				setDefinitions(DEFINITIONS_EDEFAULT);
				return;
			case ValueSetPackage.VALUE_SET_CATALOG_ENTRY__CURRENT_DEFINITION:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case ValueSetPackage.VALUE_SET_CATALOG_ENTRY__DEFINITIONS:
				return DEFINITIONS_EDEFAULT == null
						? definitions != null
						: !DEFINITIONS_EDEFAULT.equals(definitions);
			case ValueSetPackage.VALUE_SET_CATALOG_ENTRY__CURRENT_DEFINITION:

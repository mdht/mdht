...
/**
 * This is the item provider adapter for a {@link org.openhealthtools.mdht.cts2.association.DocumentRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class DocumentRootItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AssociationPackage.Literals.DOCUMENT_ROOT__ASSOCIATION);
			childrenFeatures.add(AssociationPackage.Literals.DOCUMENT_ROOT__ASSOCIATION_DIRECTORY);
			childrenFeatures.add(AssociationPackage.Literals.DOCUMENT_ROOT__ASSOCIATION_GRAPH);
			childrenFeatures.add(AssociationPackage.Literals.DOCUMENT_ROOT__ASSOCIATION_LIST);
			childrenFeatures.add(AssociationPackage.Literals.DOCUMENT_ROOT__ASSOCIATION_MSG);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(
			AssociationPackage.Literals.DOCUMENT_ROOT__ASSOCIATION, AssociationFactory.eINSTANCE.createAssociation()));

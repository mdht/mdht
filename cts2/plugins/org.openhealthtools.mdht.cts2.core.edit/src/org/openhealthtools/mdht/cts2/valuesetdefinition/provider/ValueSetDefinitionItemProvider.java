...
/**
 * This is the item provider adapter for a {@link org.openhealthtools.mdht.cts2.valuesetdefinition.ValueSetDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class ValueSetDefinitionItemProvider extends ResourceVersionDescriptionItemProvider implements
	 ...
	 * @generated
	 */
	public ValueSetDefinitionItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ValueSetDefinitionPackage.Literals.VALUE_SET_DEFINITION__DEFINED_VALUE_SET);
			childrenFeatures.add(ValueSetDefinitionPackage.Literals.VALUE_SET_DEFINITION__VERSION_TAG);
			childrenFeatures.add(ValueSetDefinitionPackage.Literals.VALUE_SET_DEFINITION__ENTRY);
		}
	...
	/**
	 * This returns ValueSetDefinition.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ValueSetDefinition"));
	}
	...
	public String getText(Object object) {
		String label = ((ValueSetDefinition) object).getFormalName();
		return label == null || label.length() == 0
				? getString("_UI_ValueSetDefinition_type")
				: getString("_UI_ValueSetDefinition_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ValueSetDefinition.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(
			ValueSetDefinitionPackage.Literals.VALUE_SET_DEFINITION__DEFINED_VALUE_SET,
			CoreFactory.eINSTANCE.createValueSetReference()));

		newChildDescriptors.add(createChildParameter(
			ValueSetDefinitionPackage.Literals.VALUE_SET_DEFINITION__VERSION_TAG,
			CoreFactory.eINSTANCE.createVersionTagReference()));

		newChildDescriptors.add(createChildParameter(
			ValueSetDefinitionPackage.Literals.VALUE_SET_DEFINITION__ENTRY,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == CorePackage.Literals.CHANGEABLE__STATUS ||
				...
				childFeature == ValueSetDefinitionPackage.Literals.VALUE_SET_DEFINITION__DEFINED_VALUE_SET ||
				childFeature == ValueSetDefinitionPackage.Literals.VALUE_SET_DEFINITION__VERSION_TAG;

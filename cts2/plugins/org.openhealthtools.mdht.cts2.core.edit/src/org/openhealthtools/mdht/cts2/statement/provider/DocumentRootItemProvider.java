...
/**
 * This is the item provider adapter for a {@link org.openhealthtools.mdht.cts2.statement.DocumentRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class DocumentRootItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatementPackage.Literals.DOCUMENT_ROOT__STATEMENT);
			childrenFeatures.add(StatementPackage.Literals.DOCUMENT_ROOT__STATEMENT_DIRECTORY);
			childrenFeatures.add(StatementPackage.Literals.DOCUMENT_ROOT__STATEMENT_LIST);
			childrenFeatures.add(StatementPackage.Literals.DOCUMENT_ROOT__STATEMENT_MSG);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(
			StatementPackage.Literals.DOCUMENT_ROOT__STATEMENT_LIST, StatementFactory.eINSTANCE.createStatementList()));

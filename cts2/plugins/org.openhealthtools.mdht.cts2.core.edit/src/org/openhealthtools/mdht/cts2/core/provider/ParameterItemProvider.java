...
/**
 * This is the item provider adapter for a {@link org.openhealthtools.mdht.cts2.core.Parameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class ParameterItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addValPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_Parameter_val_feature"),
			getString("_UI_PropertyDescriptor_description", "_UI_Parameter_val_feature", "_UI_Parameter_type"),
			CorePackage.Literals.PARAMETER__VAL, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
			null));
	}
	...
	protected void addArgPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
			((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
			getString("_UI_Parameter_arg_feature"),
			getString("_UI_PropertyDescriptor_description", "_UI_Parameter_arg_feature", "_UI_Parameter_type"),
			CorePackage.Literals.PARAMETER__ARG, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
			null));
	}
	...
	public String getText(Object object) {
		String label = ((Parameter) object).getVal();

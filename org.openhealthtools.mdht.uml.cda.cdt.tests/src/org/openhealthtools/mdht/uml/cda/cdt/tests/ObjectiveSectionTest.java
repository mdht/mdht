 ...
 * related to '<em><b>Objective Section</b></em>' model objects. <!--
 * end-user-doc -->
 *
 * <p>
...
public class ObjectiveSectionTest extends CDAValidationTest {
	 ...
	 */
	@Test
	public void testValidateObjectiveSectionHasClinicalStatements() {
		OperationsTestCase<ObjectiveSection> validateObjectiveSectionHasClinicalStatementsTestCase = new OperationsTestCase<ObjectiveSection>(
			"validateObjectiveSectionHasClinicalStatements",
			operationsForOCL.getOCLValue("VALIDATE_OBJECTIVE_SECTION_HAS_CLINICAL_STATEMENTS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ObjectiveSectionOperations.validateObjectiveSectionHasClinicalStatements(
					(ObjectiveSection) objectToTest, diagnostician, map);
			}

		};

		validateObjectiveSectionHasClinicalStatementsTestCase.doValidationTest();
	}
	...
	private static class ObjectFactory implements TestObjectFactory<ObjectiveSection> {
		...
		public ObjectiveSection create() {
			return CDTFactory.eINSTANCE.createObjectiveSection();
		}
	}

...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Act Class Root</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.openhealthtools.mdht.uml.hl7.vocab.VocabPackage#getActClassRoot()
 * @model
 * @generated
 */
public enum ActClassRoot implements Enumerator {
	 ...
	 * @generated
	 */
	private static final ActClassRoot[] VALUES_ARRAY = new ActClassRoot[] {
			...
			OBSCOR, OBSSER, ORGANIZER, OUTB, PCPR, PROC, REG, REV, ROIBND, ROIOVL, SBADM, SPCOBS, SPCTRT, SPLY, STC,
			SUBST, TOPIC, TRNS, VERIF, XACT, };

	/**
	 * A public read-only list of all the '<em><b>Act Class Root</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Act Class Root</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ActClassRoot get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ActClassRoot result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Act Class Root</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ActClassRoot getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ActClassRoot result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Act Class Root</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ActClassRoot get(int value) {
		switch (value) {
			case ACCM_VALUE:
				return ACCM;
			case ACCT_VALUE:
	 ...
	 * @generated
	 */
	private ActClassRoot(int value, String name, String literal) {
		this.value = value;
		this.name = name;

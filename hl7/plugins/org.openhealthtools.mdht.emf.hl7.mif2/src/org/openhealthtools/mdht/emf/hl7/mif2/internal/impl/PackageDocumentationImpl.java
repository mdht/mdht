...
public class PackageDocumentationImpl extends EObjectImpl implements PackageDocumentation {
	...
	public NotificationChain basicSetDescription(CascadableAnnotation newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, Mif2Package.PACKAGE_DOCUMENTATION__DESCRIPTION, oldDescription, newDescription);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newDescription != description) {
			...
			if (description != null) {
				msgs = ((InternalEObject) description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						Mif2Package.PACKAGE_DOCUMENTATION__DESCRIPTION, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.PACKAGE_DOCUMENTATION__DESCRIPTION, newDescription, newDescription));
		}
	}
	...
	public EList<DesignComment> getDesignComments() {
		if (designComments == null) {
			designComments = new EObjectContainmentEList<DesignComment>(
				DesignComment.class, this, Mif2Package.PACKAGE_DOCUMENTATION__DESIGN_COMMENTS);
		}
	...
	public EList<ContextAnnotation> getStabilityRemarks() {
		if (stabilityRemarks == null) {
			stabilityRemarks = new EObjectContainmentEList<ContextAnnotation>(
				ContextAnnotation.class, this, Mif2Package.PACKAGE_DOCUMENTATION__STABILITY_REMARKS);
		}
	...
	public NotificationChain basicSetWalkthrough(ContextAnnotation newWalkthrough, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, Mif2Package.PACKAGE_DOCUMENTATION__WALKTHROUGH, oldWalkthrough, newWalkthrough);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newWalkthrough != walkthrough) {
			...
			if (walkthrough != null) {
				msgs = ((InternalEObject) walkthrough).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						Mif2Package.PACKAGE_DOCUMENTATION__WALKTHROUGH, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.PACKAGE_DOCUMENTATION__WALKTHROUGH, newWalkthrough, newWalkthrough));
		}
	}
	...
	public EList<OpenIssue> getOpenIssue() {
		if (openIssue == null) {
			openIssue = new EObjectContainmentEList<OpenIssue>(
				OpenIssue.class, this, Mif2Package.PACKAGE_DOCUMENTATION__OPEN_ISSUE);
		}
		return openIssue;
	}
	...
	public EList<Appendix> getAppendix() {
		if (appendix == null) {
			appendix = new EObjectContainmentEList<Appendix>(
				Appendix.class, this, Mif2Package.PACKAGE_DOCUMENTATION__APPENDIX);
		}
		return appendix;
	}
	...
	public EList<OtherAnnotation> getOtherAnnotation() {
		if (otherAnnotation == null) {
			otherAnnotation = new EObjectContainmentEList<OtherAnnotation>(
				OtherAnnotation.class, this, Mif2Package.PACKAGE_DOCUMENTATION__OTHER_ANNOTATION);
		}

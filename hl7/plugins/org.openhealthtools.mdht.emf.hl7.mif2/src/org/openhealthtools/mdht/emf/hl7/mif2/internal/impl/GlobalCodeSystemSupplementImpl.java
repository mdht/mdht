...
public class GlobalCodeSystemSupplementImpl extends CodeSystemSupplementImpl implements GlobalCodeSystemSupplement {
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.GLOBAL_CODE_SYSTEM_SUPPLEMENT__SCHEMA_VERSION, oldSchemaVersion,
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, Mif2Package.GLOBAL_CODE_SYSTEM_SUPPLEMENT__SCHEMA_VERSION, oldSchemaVersion,

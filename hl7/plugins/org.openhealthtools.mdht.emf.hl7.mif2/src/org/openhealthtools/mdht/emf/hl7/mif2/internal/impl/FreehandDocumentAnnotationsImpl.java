...
public abstract class FreehandDocumentAnnotationsImpl extends EObjectImpl implements FreehandDocumentAnnotations {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDocumentation(FreehandDocumentDocumentation newDocumentation,
			NotificationChain msgs) {
		FreehandDocumentDocumentation oldDocumentation = documentation;
		documentation = newDocumentation;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, Mif2Package.FREEHAND_DOCUMENT_ANNOTATIONS__DOCUMENTATION, oldDocumentation,
				newDocumentation);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newDocumentation != documentation) {
			...
			if (documentation != null) {
				msgs = ((InternalEObject) documentation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						Mif2Package.FREEHAND_DOCUMENT_ANNOTATIONS__DOCUMENTATION, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.FREEHAND_DOCUMENT_ANNOTATIONS__DOCUMENTATION, newDocumentation,
				newDocumentation));
		}
	}
	...
	public NotificationChain basicSetAppInfo(FreehandDocumentAppInfo newAppInfo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this, Notification.SET, Mif2Package.FREEHAND_DOCUMENT_ANNOTATIONS__APP_INFO, oldAppInfo, newAppInfo);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newAppInfo != appInfo) {
			...
			if (appInfo != null) {
				msgs = ((InternalEObject) appInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						Mif2Package.FREEHAND_DOCUMENT_ANNOTATIONS__APP_INFO, null, msgs);
			}
			if (newAppInfo != null) {
			...
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.FREEHAND_DOCUMENT_ANNOTATIONS__APP_INFO, newAppInfo, newAppInfo));
		}
	}

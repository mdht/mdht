 ...
 * @generated
 */
public class GlobalStaticModelInterfacePackageImpl extends StaticModelInterfacePackageImpl implements
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.GLOBAL_STATIC_MODEL_INTERFACE_PACKAGE__SCHEMA_VERSION,
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, Mif2Package.GLOBAL_STATIC_MODEL_INTERFACE_PACKAGE__SCHEMA_VERSION,
				oldSchemaVersion, SCHEMA_VERSION_EDEFAULT, oldSchemaVersionESet));
		}
	}

...
public class GlobalFreehandDocumentImpl extends FreehandDocumentImpl implements GlobalFreehandDocument {
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.SET, Mif2Package.GLOBAL_FREEHAND_DOCUMENT__SCHEMA_VERSION, oldSchemaVersion,
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(
				this, Notification.UNSET, Mif2Package.GLOBAL_FREEHAND_DOCUMENT__SCHEMA_VERSION, oldSchemaVersion,

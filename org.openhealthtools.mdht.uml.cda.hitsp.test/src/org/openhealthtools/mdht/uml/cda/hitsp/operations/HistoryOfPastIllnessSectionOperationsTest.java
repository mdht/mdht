...
public class HistoryOfPastIllnessSectionOperationsTest extends
		org.openhealthtools.mdht.uml.cda.ihe.operations.HistoryOfPastIllnessSectionOperationsTest {

	protected static final String TEMPLATE_ID = "2.16.840.1.113883.3.88.11.83.104";
	...
	protected EObject getObjectInitToTest() {
		return HITSPFactory.eINSTANCE.createHistoryOfPastIllnessSection().init();
	}

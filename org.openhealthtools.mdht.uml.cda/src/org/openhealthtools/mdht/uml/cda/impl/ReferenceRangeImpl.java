...
public class ReferenceRangeImpl extends EObjectImpl implements ReferenceRange {
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.REFERENCE_RANGE__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setTypeCode(ActRelationshipType newTypeCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.REFERENCE_RANGE__TYPE_CODE, oldTypeCode, typeCode));
	}

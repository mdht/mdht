 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.MaterialImpl#getRealmCode <em>Realm Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.MaterialImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.MaterialImpl#getTemplateId <em>Template Id</em>}</li>
...
public class MaterialImpl extends EObjectImpl implements Material {
	...
	public EList<CS> getRealmCode() {
		if (realmCode == null) {
			realmCode = new EObjectContainmentEList<CS>(CS.class, this, CDAPackage.MATERIAL__REALM_CODE);
		}
		return realmCode;
	}
	...
	public EList<II> getTemplateId() {
		if (templateId == null) {
			templateId = new EObjectContainmentEList<II>(II.class, this, CDAPackage.MATERIAL__TEMPLATE_ID);
		}
		return templateId;
	}
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.MATERIAL__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setClassCode(EntityClassManufacturedMaterial newClassCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.MATERIAL__CLASS_CODE, oldClassCode, classCode));
	}
	...
	public void setDeterminerCode(EntityDeterminerDetermined newDeterminerCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.MATERIAL__DETERMINER_CODE, oldDeterminerCode, determinerCode));
	}

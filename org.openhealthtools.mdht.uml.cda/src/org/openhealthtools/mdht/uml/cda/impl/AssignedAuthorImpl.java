...
import org.openhealthtools.mdht.uml.cda.internal.operations.AssignedAuthorOperations;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.AssignedAuthorImpl#getRealmCode <em>Realm Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.AssignedAuthorImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.AssignedAuthorImpl#getTemplateId <em>Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.AssignedAuthorImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.AssignedAuthorImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.AssignedAuthorImpl#getAddr <em>Addr</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.AssignedAuthorImpl#getTelecom <em>Telecom</em>}</li>
...
public class AssignedAuthorImpl extends EObjectImpl implements AssignedAuthor {
	...
	public EList<CS> getRealmCode() {
		if (realmCode == null) {
			realmCode = new EObjectContainmentEList<CS>(CS.class, this, CDAPackage.ASSIGNED_AUTHOR__REALM_CODE);
		}
		return realmCode;
	}
	...
	public EList<II> getTemplateId() {
		if (templateId == null) {
			templateId = new EObjectContainmentEList<II>(II.class, this, CDAPackage.ASSIGNED_AUTHOR__TEMPLATE_ID);
		}
		return templateId;
	}
	...
	public EList<II> getId() {
		if (id == null) {
			id = new EObjectContainmentEList<II>(II.class, this, CDAPackage.ASSIGNED_AUTHOR__ID);
		}
		return id;
	}
	...
	public EList<AD> getAddr() {
		if (addr == null) {
			addr = new EObjectContainmentEList<AD>(AD.class, this, CDAPackage.ASSIGNED_AUTHOR__ADDR);
		}
		return addr;
	}
	...
	public EList<TEL> getTelecom() {
		if (telecom == null) {
			telecom = new EObjectContainmentEList<TEL>(TEL.class, this, CDAPackage.ASSIGNED_AUTHOR__TELECOM);
		}
		return telecom;
	}
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.ASSIGNED_AUTHOR__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setClassCode(RoleClassAssignedEntity newClassCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.ASSIGNED_AUTHOR__CLASS_CODE, oldClassCode, classCode));
	}
	 ...
	 * @generated
	 */
	public boolean assignedAuthorChoice(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return AssignedAuthorOperations.assignedAuthorChoice(this, diagnostics, context);
	}

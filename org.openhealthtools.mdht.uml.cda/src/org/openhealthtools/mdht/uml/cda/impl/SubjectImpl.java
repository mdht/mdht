 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.SubjectImpl#getRealmCode <em>Realm Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.SubjectImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.SubjectImpl#getTemplateId <em>Template Id</em>}</li>
...
public class SubjectImpl extends EObjectImpl implements Subject {
	...
	public EList<CS> getRealmCode() {
		if (realmCode == null) {
			realmCode = new EObjectContainmentEList<CS>(CS.class, this, CDAPackage.SUBJECT__REALM_CODE);
		}
		return realmCode;
	}
	...
	public EList<II> getTemplateId() {
		if (templateId == null) {
			templateId = new EObjectContainmentEList<II>(II.class, this, CDAPackage.SUBJECT__TEMPLATE_ID);
		}
		return templateId;
	}
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.SUBJECT__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setContextControlCode(ContextControl newContextControlCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.SUBJECT__CONTEXT_CONTROL_CODE, oldContextControlCode, contextControlCode));
	}

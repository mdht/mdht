 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.InFulfillmentOfImpl#getRealmCode <em>Realm Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.InFulfillmentOfImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.impl.InFulfillmentOfImpl#getTemplateId <em>Template Id</em>}</li>
...
public class InFulfillmentOfImpl extends EObjectImpl implements InFulfillmentOf {
	...
	public EList<CS> getRealmCode() {
		if (realmCode == null) {
			realmCode = new EObjectContainmentEList<CS>(CS.class, this, CDAPackage.IN_FULFILLMENT_OF__REALM_CODE);
		}
		return realmCode;
	}
	...
	public EList<II> getTemplateId() {
		if (templateId == null) {
			templateId = new EObjectContainmentEList<II>(II.class, this, CDAPackage.IN_FULFILLMENT_OF__TEMPLATE_ID);
		}
		return templateId;
	}
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.IN_FULFILLMENT_OF__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setTypeCode(ActRelationshipFulfills newTypeCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.IN_FULFILLMENT_OF__TYPE_CODE, oldTypeCode, typeCode));
	}

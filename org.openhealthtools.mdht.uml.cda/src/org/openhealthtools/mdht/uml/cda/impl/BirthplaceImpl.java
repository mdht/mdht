...
public class BirthplaceImpl extends EObjectImpl implements Birthplace {
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.BIRTHPLACE__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setClassCode(RoleClass newClassCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.BIRTHPLACE__CLASS_CODE, oldClassCode, classCode));
	}

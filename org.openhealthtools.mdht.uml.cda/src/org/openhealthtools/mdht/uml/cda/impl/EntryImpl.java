...
import org.openhealthtools.mdht.uml.cda.internal.operations.EntryOperations;
...
public class EntryImpl extends EObjectImpl implements Entry {
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.ENTRY__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setContextConductionInd(Boolean newContextConductionInd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.ENTRY__CONTEXT_CONDUCTION_IND, oldContextConductionInd, contextConductionInd));
	}

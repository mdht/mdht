...
public class EncompassingEncounterImpl extends EObjectImpl implements EncompassingEncounter {
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.ENCOMPASSING_ENCOUNTER__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setClassCode(ActClass newClassCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.ENCOMPASSING_ENCOUNTER__CLASS_CODE, oldClassCode, classCode));
	}
	...
	public void setMoodCode(ActMood newMoodCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.ENCOMPASSING_ENCOUNTER__MOOD_CODE, oldMoodCode, moodCode));
	}

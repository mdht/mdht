...
public class Informant12Impl extends EObjectImpl implements Informant12 {
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.INFORMANT12__NULL_FLAVOR, oldNullFlavor, nullFlavor));
	}
	...
	public void setTypeCode(ParticipationType newTypeCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.INFORMANT12__TYPE_CODE, oldTypeCode, typeCode));
	}
	...
	public void setContextControlCode(ContextControl newContextControlCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.INFORMANT12__CONTEXT_CONTROL_CODE, oldContextControlCode, contextControlCode));
	}
